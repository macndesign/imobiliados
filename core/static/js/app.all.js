 ...
 * Licensed under MIT (https://github.com/twbs/bootstrap/blob/master/LICENSE)
 */
;if(typeof jQuery==="undefined"){throw new Error("Bootstrap's JavaScript requires jQuery")}+function(b){function a(){var e=document.createElement("bootstrap");var d={WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd otransitionend",transition:"transitionend"};for(var c in d){if(e.style[c]!==undefined){return{end:d[c]}}}return false}b.fn.emulateTransitionEnd=function(c){var f=false,e=this;b(this).one(b.support.transition.end,function(){f=true});var d=function(){if(!f){b(e).trigger(b.support.transition.end)}};setTimeout(d,c);return this};b(function(){b.support.transition=a()})}(jQuery);+function(b){var a='[data-dismiss="alert"]';var d=function(e){b(e).on("click",a,this.close)};d.prototype.close=function(e){var i=b(this);var g=i.attr("data-target");if(!g){g=i.attr("href");g=g&&g.replace(/.*(?=#[^\s]*$)/,"")}var h=b(g);if(e){e.preventDefault()}if(!h.length){h=i.hasClass("alert")?i:i.parent()}h.trigger(e=b.Event("close.bs.alert"));if(e.isDefaultPrevented()){return}h.removeClass("in");function f(){h.trigger("closed.bs.alert").remove()}b.support.transition&&h.hasClass("fade")?h.one(b.support.transition.end,f).emulateTransitionEnd(150):f()};var c=b.fn.alert;b.fn.alert=function(e){return this.each(function(){var f=b(this);var g=f.data("bs.alert");if(!g){f.data("bs.alert",(g=new d(this)))}if(typeof e=="string"){g[e].call(f)}})};b.fn.alert.Constructor=d;b.fn.alert.noConflict=function(){b.fn.alert=c;return this};b(document).on("click.bs.alert.data-api",a,d.prototype.close)}(jQuery);+function(c){var b=function(e,d){this.$element=c(e);this.options=c.extend({},b.DEFAULTS,d);this.isLoading=false};b.DEFAULTS={loadingText:"loading..."};b.prototype.setState=function(g){var d="disabled";var e=this.$element;var h=e.is("input")?"val":"html";var f=e.data();g=g+"Text";if(!f.resetText){e.data("resetText",e[h]())}e[h](f[g]||this.options[g]);setTimeout(c.proxy(function(){if(g=="loadingText"){this.isLoading=true;e.addClass(d).attr(d,d)}else{if(this.isLoading){this.isLoading=false;e.removeClass(d).removeAttr(d)}}},this),0)};b.prototype.toggle=function(){var e=true;var d=this.$element.closest('[data-toggle="buttons"]');if(d.length){var f=this.$element.find("input");if(f.prop("type")=="radio"){if(f.prop("checked")&&this.$element.hasClass("active")){e=false}else{d.find(".active").removeClass("active")}}if(e){f.prop("checked",!this.$element.hasClass("active")).trigger("change")}}if(e){this.$element.toggleClass("active")}};var a=c.fn.button;c.fn.button=function(d){return this.each(function(){var g=c(this);var f=g.data("bs.button");var e=typeof d=="object"&&d;if(!f){g.data("bs.button",(f=new b(this,e)))}if(d=="toggle"){f.toggle()}else{if(d){f.setState(d)}}})};c.fn.button.Constructor=b;c.fn.button.noConflict=function(){c.fn.button=a;return this};c(document).on("click.bs.button.data-api","[data-toggle^=button]",function(e){var d=c(e.target);if(!d.hasClass("btn")){d=d.closest(".btn")}d.button("toggle");e.preventDefault()})}(jQuery);+function(b){var c=function(e,d){this.$element=b(e);this.$indicators=this.$element.find(".carousel-indicators");this.options=d;this.paused=this.sliding=this.interval=this.$active=this.$items=null;this.options.pause=="hover"&&this.$element.on("mouseenter",b.proxy(this.pause,this)).on("mouseleave",b.proxy(this.cycle,this))};c.DEFAULTS={interval:5000,pause:"hover",wrap:true};c.prototype.cycle=function(d){d||(this.paused=false);this.interval&&clearInterval(this.interval);this.options.interval&&!this.paused&&(this.interval=setInterval(b.proxy(this.next,this),this.options.interval));return this};c.prototype.getActiveIndex=function(){this.$active=this.$element.find(".item.active");this.$items=this.$active.parent().children();return this.$items.index(this.$active)};c.prototype.to=function(f){var e=this;var d=this.getActiveIndex();if(f>(this.$items.length-1)||f<0){return}if(this.sliding){return this.$element.one("slid.bs.carousel",function(){e.to(f)})}if(d==f){return this.pause().cycle()}return this.slide(f>d?"next":"prev",b(this.$items[f]))};c.prototype.pause=function(d){d||(this.paused=true);if(this.$element.find(".next, .prev").length&&b.support.transition){this.$element.trigger(b.support.transition.end);this.cycle(true)}this.interval=clearInterval(this.interval);return this};c.prototype.next=function(){if(this.sliding){return}return this.slide("next")};c.prototype.prev=function(){if(this.sliding){return}return this.slide("prev")};c.prototype.slide=function(i,d){var k=this.$element.find(".item.active");var l=d||k[i]();var h=this.interval;var j=i=="next"?"left":"right";var e=i=="next"?"first":"last";var f=this;if(!l.length){if(!this.options.wrap){return}l=this.$element.find(".item")[e]()}if(l.hasClass("active")){return this.sliding=false}var g=b.Event("slide.bs.carousel",{relatedTarget:l[0],direction:j});this.$element.trigger(g);if(g.isDefaultPrevented()){return}this.sliding=true;h&&this.pause();if(this.$indicators.length){this.$indicators.find(".active").removeClass("active");this.$element.one("slid.bs.carousel",function(){var m=b(f.$indicators.children()[f.getActiveIndex()]);m&&m.addClass("active")})}if(b.support.transition&&this.$element.hasClass("slide")){l.addClass(i);l[0].offsetWidth;k.addClass(j);l.addClass(j);k.one(b.support.transition.end,function(){l.removeClass([i,j].join(" ")).addClass("active");k.removeClass(["active",j].join(" "));f.sliding=false;setTimeout(function(){f.$element.trigger("slid.bs.carousel")},0)}).emulateTransitionEnd(k.css("transition-duration").slice(0,-1)*1000)}else{k.removeClass("active");l.addClass("active");this.sliding=false;this.$element.trigger("slid.bs.carousel")}h&&this.cycle();return this};var a=b.fn.carousel;b.fn.carousel=function(d){return this.each(function(){var g=b(this);var f=g.data("bs.carousel");var h=b.extend({},c.DEFAULTS,g.data(),typeof d=="object"&&d);var e=typeof d=="string"?d:h.slide;if(!f){g.data("bs.carousel",(f=new c(this,h)))}if(typeof d=="number"){f.to(d)}else{if(e){f[e]()}else{if(h.interval){f.pause().cycle()}}}})};b.fn.carousel.Constructor=c;b.fn.carousel.noConflict=function(){b.fn.carousel=a;return this};b(document).on("click.bs.carousel.data-api","[data-slide], [data-slide-to]",function(f){var i=b(this),d;var h=b(i.attr("data-target")||(d=i.attr("href"))&&d.replace(/.*(?=#[^\s]+$)/,""));var e=b.extend({},h.data(),i.data());var g=i.attr("data-slide-to");if(g){e.interval=false}h.carousel(e);if(g=i.attr("data-slide-to")){h.data("bs.carousel").to(g)}f.preventDefault()});b(window).on("load",function(){b('[data-ride="carousel"]').each(function(){var d=b(this);d.carousel(d.data())})})}(jQuery);+function(b){var c=function(e,d){this.$element=b(e);this.options=b.extend({},c.DEFAULTS,d);this.transitioning=null;if(this.options.parent){this.$parent=b(this.options.parent)}if(this.options.toggle){this.toggle()}};c.DEFAULTS={toggle:true};c.prototype.dimension=function(){var d=this.$element.hasClass("width");return d?"width":"height"};c.prototype.show=function(){if(this.transitioning||this.$element.hasClass("in")){return}var f=b.Event("show.bs.collapse");this.$element.trigger(f);if(f.isDefaultPrevented()){return}var h=this.$parent&&this.$parent.find("> .panel > .in");if(h&&h.length){var e=h.data("bs.collapse");if(e&&e.transitioning){return}h.collapse("hide");e||h.data("bs.collapse",null)}var d=this.dimension();this.$element.removeClass("collapse").addClass("collapsing")[d](0);this.transitioning=1;var i=function(){this.$element.removeClass("collapsing").addClass("collapse in")[d]("auto");this.transitioning=0;this.$element.trigger("shown.bs.collapse")};if(!b.support.transition){return i.call(this)}var g=b.camelCase(["scroll",d].join("-"));this.$element.one(b.support.transition.end,b.proxy(i,this)).emulateTransitionEnd(350)[d](this.$element[0][g])};c.prototype.hide=function(){if(this.transitioning||!this.$element.hasClass("in")){return}var e=b.Event("hide.bs.collapse");this.$element.trigger(e);if(e.isDefaultPrevented()){return}var f=this.dimension();this.$element[f](this.$element[f]())[0].offsetHeight;this.$element.addClass("collapsing").removeClass("collapse").removeClass("in");this.transitioning=1;var d=function(){this.transitioning=0;this.$element.trigger("hidden.bs.collapse").removeClass("collapsing").addClass("collapse")};if(!b.support.transition){return d.call(this)}this.$element[f](0).one(b.support.transition.end,b.proxy(d,this)).emulateTransitionEnd(350)};c.prototype.toggle=function(){this[this.$element.hasClass("in")?"hide":"show"]()};var a=b.fn.collapse;b.fn.collapse=function(d){return this.each(function(){var g=b(this);var f=g.data("bs.collapse");var e=b.extend({},c.DEFAULTS,g.data(),typeof d=="object"&&d);if(!f&&e.toggle&&d=="show"){d=!d}if(!f){g.data("bs.collapse",(f=new c(this,e)))}if(typeof d=="string"){f[d]()}})};b.fn.collapse.Constructor=c;b.fn.collapse.noConflict=function(){b.fn.collapse=a;return this};b(document).on("click.bs.collapse.data-api","[data-toggle=collapse]",function(h){var j=b(this),l;var i=j.attr("data-target")||h.preventDefault()||(l=j.attr("href"))&&l.replace(/.*(?=#[^\s]+$)/,"");var d=b(i);var f=d.data("bs.collapse");var g=f?"toggle":j.data();var k=j.attr("data-parent");var e=k&&b(k);if(!f||!f.transitioning){if(e){e.find('[data-toggle=collapse][data-parent="'+k+'"]').not(j).addClass("collapsed")}j[d.hasClass("in")?"addClass":"removeClass"]("collapsed")}d.collapse(g)})}(jQuery);+function(e){var c=".dropdown-backdrop";var g="[data-toggle=dropdown]";var f=function(h){e(h).on("click.bs.dropdown",this.toggle)};f.prototype.toggle=function(h){var l=e(this);if(l.is(".disabled, :disabled")){return}var k=d(l);var j=k.hasClass("open");b();if(!j){if("ontouchstart" in document.documentElement&&!k.closest(".navbar-nav").length){e('<div class="dropdown-backdrop"/>').insertAfter(e(this)).on("click",b)}var i={relatedTarget:this};k.trigger(h=e.Event("show.bs.dropdown",i));if(h.isDefaultPrevented()){return}k.toggleClass("open").trigger("shown.bs.dropdown",i);l.focus()}return false};f.prototype.keydown=function(n){if(!/(38|40|27)/.test(n.keyCode)){return}var m=e(this);n.preventDefault();n.stopPropagation();if(m.is(".disabled, :disabled")){return}var l=d(m);var k=l.hasClass("open");if(!k||(k&&n.keyCode==27)){if(n.which==27){l.find(g).focus()}return m.click()}var h=" li:not(.divider):visible a";var i=l.find("[role=menu]"+h+", [role=listbox]"+h);if(!i.length){return}var j=i.index(i.filter(":focus"));if(n.keyCode==38&&j>0){j--}if(n.keyCode==40&&j<i.length-1){j++}if(!~j){j=0}i.eq(j).focus()};function b(h){e(c).remove();e(g).each(function(){var i=d(e(this));var j={relatedTarget:this};if(!i.hasClass("open")){return}i.trigger(h=e.Event("hide.bs.dropdown",j));if(h.isDefaultPrevented()){return}i.removeClass("open").trigger("hidden.bs.dropdown",j)})}function d(j){var h=j.attr("data-target");if(!h){h=j.attr("href");h=h&&/#[A-Za-z]/.test(h)&&h.replace(/.*(?=#[^\s]*$)/,"")}var i=h&&e(h);return i&&i.length?i:j.parent()}var a=e.fn.dropdown;e.fn.dropdown=function(h){return this.each(function(){var i=e(this);var j=i.data("bs.dropdown");if(!j){i.data("bs.dropdown",(j=new f(this)))}if(typeof h=="string"){j[h].call(i)}})};e.fn.dropdown.Constructor=f;e.fn.dropdown.noConflict=function(){e.fn.dropdown=a;return this};e(document).on("click.bs.dropdown.data-api",b).on("click.bs.dropdown.data-api",".dropdown form",function(h){h.stopPropagation()}).on("click.bs.dropdown.data-api",g,f.prototype.toggle).on("keydown.bs.dropdown.data-api",g+", [role=menu], [role=listbox]",f.prototype.keydown)}(jQuery);+function(c){var b=function(e,d){this.options=d;this.$element=c(e);this.$backdrop=this.isShown=null;if(this.options.remote){this.$element.find(".modal-content").load(this.options.remote,c.proxy(function(){this.$element.trigger("loaded.bs.modal")},this))}};b.DEFAULTS={backdrop:true,keyboard:true,show:true};b.prototype.toggle=function(d){return this[!this.isShown?"show":"hide"](d)};b.prototype.show=function(f){var d=this;var e=c.Event("show.bs.modal",{relatedTarget:f});this.$element.trigger(e);if(this.isShown||e.isDefaultPrevented()){return}this.isShown=true;this.escape();this.$element.on("click.dismiss.bs.modal",'[data-dismiss="modal"]',c.proxy(this.hide,this));this.backdrop(function(){var i=c.support.transition&&d.$element.hasClass("fade");if(!d.$element.parent().length){d.$element.appendTo(document.body)}d.$element.show().scrollTop(0);if(i){d.$element[0].offsetWidth}d.$element.addClass("in").attr("aria-hidden",false);d.enforceFocus();var h=c.Event("shown.bs.modal",{relatedTarget:f});i?d.$element.find(".modal-dialog").one(c.support.transition.end,function(){d.$element.focus().trigger(h)}).emulateTransitionEnd(300):d.$element.focus().trigger(h)})};b.prototype.hide=function(d){if(d){d.preventDefault()}d=c.Event("hide.bs.modal");this.$element.trigger(d);if(!this.isShown||d.isDefaultPrevented()){return}this.isShown=false;this.escape();c(document).off("focusin.bs.modal");this.$element.removeClass("in").attr("aria-hidden",true).off("click.dismiss.bs.modal");c.support.transition&&this.$element.hasClass("fade")?this.$element.one(c.support.transition.end,c.proxy(this.hideModal,this)).emulateTransitionEnd(300):this.hideModal()};b.prototype.enforceFocus=function(){c(document).off("focusin.bs.modal").on("focusin.bs.modal",c.proxy(function(d){if(this.$element[0]!==d.target&&!this.$element.has(d.target).length){this.$element.focus()}},this))};b.prototype.escape=function(){if(this.isShown&&this.options.keyboard){this.$element.on("keyup.dismiss.bs.modal",c.proxy(function(d){d.which==27&&this.hide()},this))}else{if(!this.isShown){this.$element.off("keyup.dismiss.bs.modal")}}};b.prototype.hideModal=function(){var d=this;this.$element.hide();this.backdrop(function(){d.removeBackdrop();d.$element.trigger("hidden.bs.modal")})};b.prototype.removeBackdrop=function(){this.$backdrop&&this.$backdrop.remove();this.$backdrop=null};b.prototype.backdrop=function(f){var e=this.$element.hasClass("fade")?"fade":"";if(this.isShown&&this.options.backdrop){var d=c.support.transition&&e;this.$backdrop=c('<div class="modal-backdrop '+e+'" />').appendTo(document.body);this.$element.on("click.dismiss.bs.modal",c.proxy(function(g){if(g.target!==g.currentTarget){return}this.options.backdrop=="static"?this.$element[0].focus.call(this.$element[0]):this.hide.call(this)},this));if(d){this.$backdrop[0].offsetWidth}this.$backdrop.addClass("in");if(!f){return}d?this.$backdrop.one(c.support.transition.end,f).emulateTransitionEnd(150):f()}else{if(!this.isShown&&this.$backdrop){this.$backdrop.removeClass("in");c.support.transition&&this.$element.hasClass("fade")?this.$backdrop.one(c.support.transition.end,f).emulateTransitionEnd(150):f()}else{if(f){f()}}}};var a=c.fn.modal;c.fn.modal=function(d,e){return this.each(function(){var h=c(this);var g=h.data("bs.modal");var f=c.extend({},b.DEFAULTS,h.data(),typeof d=="object"&&d);if(!g){h.data("bs.modal",(g=new b(this,f)))}if(typeof d=="string"){g[d](e)}else{if(f.show){g.show(e)}}})};c.fn.modal.Constructor=b;c.fn.modal.noConflict=function(){c.fn.modal=a;return this};c(document).on("click.bs.modal.data-api",'[data-toggle="modal"]',function(d){var h=c(this);var f=h.attr("href");var e=c(h.attr("data-target")||(f&&f.replace(/.*(?=#[^\s]+$)/,"")));var g=e.data("bs.modal")?"toggle":c.extend({remote:!/#/.test(f)&&f},e.data(),h.data());if(h.is("a")){d.preventDefault()}e.modal(g,this).one("hide",function(){h.is(":visible")&&h.focus()})});c(document).on("show.bs.modal",".modal",function(){c(document.body).addClass("modal-open")}).on("hidden.bs.modal",".modal",function(){c(document.body).removeClass("modal-open")})}(jQuery);+function(c){var b=function(e,d){this.type=this.options=this.enabled=this.timeout=this.hoverState=this.$element=null;this.init("tooltip",e,d)};b.DEFAULTS={animation:true,placement:"top",selector:false,template:'<div class="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',trigger:"hover focus",title:"",delay:0,html:false,container:false};b.prototype.init=function(l,j,k){this.enabled=true;this.type=l;this.$element=c(j);this.options=this.getOptions(k);var h=this.options.trigger.split(" ");for(var g=h.length;g--;){var f=h[g];if(f=="click"){this.$element.on("click."+this.type,this.options.selector,c.proxy(this.toggle,this))}else{if(f!="manual"){var e=f=="hover"?"mouseenter":"focusin";var d=f=="hover"?"mouseleave":"focusout";this.$element.on(e+"."+this.type,this.options.selector,c.proxy(this.enter,this));this.$element.on(d+"."+this.type,this.options.selector,c.proxy(this.leave,this))}}}this.options.selector?(this._options=c.extend({},this.options,{trigger:"manual",selector:""})):this.fixTitle()};b.prototype.getDefaults=function(){return b.DEFAULTS};b.prototype.getOptions=function(d){d=c.extend({},this.getDefaults(),this.$element.data(),d);if(d.delay&&typeof d.delay=="number"){d.delay={show:d.delay,hide:d.delay}}return d};b.prototype.getDelegateOptions=function(){var d={};var e=this.getDefaults();this._options&&c.each(this._options,function(f,g){if(e[f]!=g){d[f]=g}});return d};b.prototype.enter=function(e){var d=e instanceof this.constructor?e:c(e.currentTarget)[this.type](this.getDelegateOptions()).data("bs."+this.type);clearTimeout(d.timeout);d.hoverState="in";if(!d.options.delay||!d.options.delay.show){return d.show()}d.timeout=setTimeout(function(){if(d.hoverState=="in"){d.show()}},d.options.delay.show)};b.prototype.leave=function(e){var d=e instanceof this.constructor?e:c(e.currentTarget)[this.type](this.getDelegateOptions()).data("bs."+this.type);clearTimeout(d.timeout);d.hoverState="out";if(!d.options.delay||!d.options.delay.hide){return d.hide()}d.timeout=setTimeout(function(){if(d.hoverState=="out"){d.hide()}},d.options.delay.hide)};b.prototype.show=function(){var d=c.Event("show.bs."+this.type);if(this.hasContent()&&this.enabled){this.$element.trigger(d);if(d.isDefaultPrevented()){return}var k=this;var e=this.tip();this.setContent();if(this.options.animation){e.addClass("fade")}var t=typeof this.options.placement=="function"?this.options.placement.call(this,e[0],this.$element[0]):this.options.placement;var g=/\s?auto?\s?/i;var n=g.test(t);if(n){t=t.replace(g,"")||"top"}e.detach().css({top:0,left:0,display:"block"}).addClass(t);this.options.container?e.appendTo(this.options.container):e.insertAfter(this.$element);var i=this.getPosition();var h=e[0].offsetWidth;var p=e[0].offsetHeight;if(n){var s=this.$element.parent();var r=t;var m=document.documentElement.scrollTop||document.body.scrollTop;var l=this.options.container=="body"?window.innerWidth:s.outerWidth();var q=this.options.container=="body"?window.innerHeight:s.outerHeight();var f=this.options.container=="body"?0:s.offset().left;t=t=="bottom"&&i.top+i.height+p-m>q?"top":t=="top"&&i.top-m-p<0?"bottom":t=="right"&&i.right+h>l?"left":t=="left"&&i.left-h<f?"right":t;e.removeClass(r).addClass(t)}var o=this.getCalculatedOffset(t,i,h,p);this.applyPlacement(o,t);this.hoverState=null;var j=function(){k.$element.trigger("shown.bs."+k.type)};c.support.transition&&this.$tip.hasClass("fade")?e.one(c.support.transition.end,j).emulateTransitionEnd(150):j()}};b.prototype.applyPlacement=function(h,i){var f;var j=this.tip();var e=j[0].offsetWidth;var m=j[0].offsetHeight;var d=parseInt(j.css("margin-top"),10);var g=parseInt(j.css("margin-left"),10);if(isNaN(d)){d=0}if(isNaN(g)){g=0}h.top=h.top+d;h.left=h.left+g;c.offset.setOffset(j[0],c.extend({using:function(o){j.css({top:Math.round(o.top),left:Math.round(o.left)})}},h),0);j.addClass("in");var n=j[0].offsetWidth;var k=j[0].offsetHeight;if(i=="top"&&k!=m){f=true;h.top=h.top+m-k}if(/bottom|top/.test(i)){var l=0;if(h.left<0){l=h.left*-2;h.left=0;j.offset(h);n=j[0].offsetWidth;k=j[0].offsetHeight}this.replaceArrow(l-e+n,n,"left")}else{this.replaceArrow(k-m,k,"top")}if(f){j.offset(h)}};b.prototype.replaceArrow=function(f,e,d){this.arrow().css(d,f?(50*(1-f/e)+"%"):"")};b.prototype.setContent=function(){var e=this.tip();var d=this.getTitle();e.find(".tooltip-inner")[this.options.html?"html":"text"](d);e.removeClass("fade in top bottom left right")};b.prototype.hide=function(){var g=this;var e=this.tip();var d=c.Event("hide.bs."+this.type);function f(){if(g.hoverState!="in"){e.detach()}g.$element.trigger("hidden.bs."+g.type)}this.$element.trigger(d);if(d.isDefaultPrevented()){return}e.removeClass("in");c.support.transition&&this.$tip.hasClass("fade")?e.one(c.support.transition.end,f).emulateTransitionEnd(150):f();this.hoverState=null;return this};b.prototype.fixTitle=function(){var d=this.$element;if(d.attr("title")||typeof(d.attr("data-original-title"))!="string"){d.attr("data-original-title",d.attr("title")||"").attr("title","")}};b.prototype.hasContent=function(){return this.getTitle()};b.prototype.getPosition=function(){var d=this.$element[0];return c.extend({},(typeof d.getBoundingClientRect=="function")?d.getBoundingClientRect():{width:d.offsetWidth,height:d.offsetHeight},this.$element.offset())};b.prototype.getCalculatedOffset=function(f,e,g,d){return f=="bottom"?{top:e.top+e.height,left:e.left+e.width/2-g/2}:f=="top"?{top:e.top-d,left:e.left+e.width/2-g/2}:f=="left"?{top:e.top+e.height/2-d/2,left:e.left-g}:{top:e.top+e.height/2-d/2,left:e.left+e.width}};b.prototype.getTitle=function(){var f;var d=this.$element;var e=this.options;f=d.attr("data-original-title")||(typeof e.title=="function"?e.title.call(d[0]):e.title);return f};b.prototype.tip=function(){return this.$tip=this.$tip||c(this.options.template)};b.prototype.arrow=function(){return this.$arrow=this.$arrow||this.tip().find(".tooltip-arrow")};b.prototype.validate=function(){if(!this.$element[0].parentNode){this.hide();this.$element=null;this.options=null}};b.prototype.enable=function(){this.enabled=true};b.prototype.disable=function(){this.enabled=false};b.prototype.toggleEnabled=function(){this.enabled=!this.enabled};b.prototype.toggle=function(e){var d=e?c(e.currentTarget)[this.type](this.getDelegateOptions()).data("bs."+this.type):this;d.tip().hasClass("in")?d.leave(d):d.enter(d)};b.prototype.destroy=function(){clearTimeout(this.timeout);this.hide().$element.off("."+this.type).removeData("bs."+this.type)};var a=c.fn.tooltip;c.fn.tooltip=function(d){return this.each(function(){var g=c(this);var f=g.data("bs.tooltip");var e=typeof d=="object"&&d;if(!f&&d=="destroy"){return}if(!f){g.data("bs.tooltip",(f=new b(this,e)))}if(typeof d=="string"){f[d]()}})};c.fn.tooltip.Constructor=b;c.fn.tooltip.noConflict=function(){c.fn.tooltip=a;return this}}(jQuery);+function(c){var b=function(e,d){this.init("popover",e,d)};if(!c.fn.tooltip){throw new Error("Popover requires tooltip.js")}b.DEFAULTS=c.extend({},c.fn.tooltip.Constructor.DEFAULTS,{placement:"right",trigger:"click",content:"",template:'<div class="popover"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>'});b.prototype=c.extend({},c.fn.tooltip.Constructor.prototype);b.prototype.constructor=b;b.prototype.getDefaults=function(){return b.DEFAULTS};b.prototype.setContent=function(){var f=this.tip();var e=this.getTitle();var d=this.getContent();f.find(".popover-title")[this.options.html?"html":"text"](e);f.find(".popover-content")[this.options.html?(typeof d=="string"?"html":"append"):"text"](d);f.removeClass("fade top bottom left right in");if(!f.find(".popover-title").html()){f.find(".popover-title").hide()}};b.prototype.hasContent=function(){return this.getTitle()||this.getContent()};b.prototype.getContent=function(){var d=this.$element;var e=this.options;return d.attr("data-content")||(typeof e.content=="function"?e.content.call(d[0]):e.content)};b.prototype.arrow=function(){return this.$arrow=this.$arrow||this.tip().find(".arrow")};b.prototype.tip=function(){if(!this.$tip){this.$tip=c(this.options.template)}return this.$tip};var a=c.fn.popover;c.fn.popover=function(d){return this.each(function(){var g=c(this);var f=g.data("bs.popover");var e=typeof d=="object"&&d;if(!f&&d=="destroy"){return}if(!f){g.data("bs.popover",(f=new b(this,e)))}if(typeof d=="string"){f[d]()}})};c.fn.popover.Constructor=b;c.fn.popover.noConflict=function(){c.fn.popover=a;return this}}(jQuery);+function(c){function b(d,g){var f;var e=c.proxy(this.process,this);this.$element=c(d).is("body")?c(window):c(d);this.$body=c("body");this.$scrollElement=this.$element.on("scroll.bs.scroll-spy.data-api",e);this.options=c.extend({},b.DEFAULTS,g);this.selector=(this.options.target||((f=c(d).attr("href"))&&f.replace(/.*(?=#[^\s]+$)/,""))||"")+" .nav li > a";this.offsets=c([]);this.targets=c([]);this.activeTarget=null;this.refresh();this.process()}b.DEFAULTS={offset:10};b.prototype.refresh=function(){var d=this.$element[0]==window?"offset":"position";this.offsets=c([]);this.targets=c([]);var e=this;var f=this.$body.find(this.selector).map(function(){var h=c(this);var g=h.data("target")||h.attr("href");var i=/^#./.test(g)&&c(g);return(i&&i.length&&i.is(":visible")&&[[i[d]().top+(!c.isWindow(e.$scrollElement.get(0))&&e.$scrollElement.scrollTop()),g]])||null}).sort(function(h,g){return h[0]-g[0]}).each(function(){e.offsets.push(this[0]);e.targets.push(this[1])})};b.prototype.process=function(){var e=this.$scrollElement.scrollTop()+this.options.offset;var k=this.$scrollElement[0].scrollHeight||this.$body[0].scrollHeight;var h=k-this.$scrollElement.height();var g=this.offsets;var j=this.targets;var f=this.activeTarget;var d;if(e>=h){return f!=(d=j.last()[0])&&this.activate(d)}if(f&&e<=g[0]){return f!=(d=j[0])&&this.activate(d)}for(d=g.length;d--;){f!=j[d]&&e>=g[d]&&(!g[d+1]||e<=g[d+1])&&this.activate(j[d])}};b.prototype.activate=function(f){this.activeTarget=f;c(this.selector).parentsUntil(this.options.target,".active").removeClass("active");var d=this.selector+'[data-target="'+f+'"],'+this.selector+'[href="'+f+'"]';var e=c(d).parents("li").addClass("active");if(e.parent(".dropdown-menu").length){e=e.closest("li.dropdown").addClass("active")}e.trigger("activate.bs.scrollspy")};var a=c.fn.scrollspy;c.fn.scrollspy=function(d){return this.each(function(){var g=c(this);var f=g.data("bs.scrollspy");var e=typeof d=="object"&&d;if(!f){g.data("bs.scrollspy",(f=new b(this,e)))}if(typeof d=="string"){f[d]()}})};c.fn.scrollspy.Constructor=b;c.fn.scrollspy.noConflict=function(){c.fn.scrollspy=a;return this};c(window).on("load",function(){c('[data-spy="scroll"]').each(function(){var d=c(this);d.scrollspy(d.data())})})}(jQuery);+function(c){var b=function(d){this.element=c(d)};b.prototype.show=function(){var f=this.element;var e=f.closest("ul:not(.dropdown-menu)");var d=f.data("target");if(!d){d=f.attr("href");d=d&&d.replace(/.*(?=#[^\s]*$)/,"")}if(f.parent("li").hasClass("active")){return}var h=e.find(".active:last a")[0];var i=c.Event("show.bs.tab",{relatedTarget:h});f.trigger(i);if(i.isDefaultPrevented()){return}var g=c(d);this.activate(f.parent("li"),e);this.activate(g,g.parent(),function(){f.trigger({type:"shown.bs.tab",relatedTarget:h})})};b.prototype.activate=function(f,e,d){var i=e.find("> .active");var h=d&&c.support.transition&&i.hasClass("fade");function g(){i.removeClass("active").find("> .dropdown-menu > .active").removeClass("active");f.addClass("active");if(h){f[0].offsetWidth;f.addClass("in")}else{f.removeClass("fade")}if(f.parent(".dropdown-menu")){f.closest("li.dropdown").addClass("active")}d&&d()}h?i.one(c.support.transition.end,g).emulateTransitionEnd(150):g();i.removeClass("in")};var a=c.fn.tab;c.fn.tab=function(d){return this.each(function(){var e=c(this);var f=e.data("bs.tab");if(!f){e.data("bs.tab",(f=new b(this)))}if(typeof d=="string"){f[d]()}})};c.fn.tab.Constructor=b;c.fn.tab.noConflict=function(){c.fn.tab=a;return this};c(document).on("click.bs.tab.data-api",'[data-toggle="tab"], [data-toggle="pill"]',function(d){d.preventDefault();c(this).tab("show")})}(jQuery);+function(c){var b=function(e,d){this.options=c.extend({},b.DEFAULTS,d);this.$window=c(window).on("scroll.bs.affix.data-api",c.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",c.proxy(this.checkPositionWithEventLoop,this));this.$element=c(e);this.affixed=this.unpin=this.pinnedOffset=null;this.checkPosition()};b.RESET="affix affix-top affix-bottom";b.DEFAULTS={offset:0};b.prototype.getPinnedOffset=function(){if(this.pinnedOffset){return this.pinnedOffset}this.$element.removeClass(b.RESET).addClass("affix");var e=this.$window.scrollTop();var d=this.$element.offset();return(this.pinnedOffset=d.top-e)};b.prototype.checkPositionWithEventLoop=function(){setTimeout(c.proxy(this.checkPosition,this),1)};b.prototype.checkPosition=function(){if(!this.$element.is(":visible")){return}var k=c(document).height();var l=this.$window.scrollTop();var h=this.$element.offset();var f=this.options.offset;var d=f.top;var e=f.bottom;if(this.affixed=="top"){h.top+=l}if(typeof f!="object"){e=d=f}if(typeof d=="function"){d=f.top(this.$element)}if(typeof e=="function"){e=f.bottom(this.$element)}var g=this.unpin!=null&&(l+this.unpin<=h.top)?false:e!=null&&(h.top+this.$element.height()>=k-e)?"bottom":d!=null&&(l<=d)?"top":false;if(this.affixed===g){return}if(this.unpin){this.$element.css("top","")}var j="affix"+(g?"-"+g:"");var i=c.Event(j+".bs.affix");this.$element.trigger(i);if(i.isDefaultPrevented()){return}this.affixed=g;this.unpin=g=="bottom"?this.getPinnedOffset():null;this.$element.removeClass(b.RESET).addClass(j).trigger(c.Event(j.replace("affix","affixed")));if(g=="bottom"){this.$element.offset({top:k-e-this.$element.height()})}};var a=c.fn.affix;c.fn.affix=function(d){return this.each(function(){var g=c(this);var f=g.data("bs.affix");var e=typeof d=="object"&&d;if(!f){g.data("bs.affix",(f=new b(this,e)))}if(typeof d=="string"){f[d]()}})};c.fn.affix.Constructor=b;c.fn.affix.noConflict=function(){c.fn.affix=a;return this};c(window).on("load",function(){c('[data-spy="affix"]').each(function(){var e=c(this);var d=e.data();d.offset=d.offset||{};if(d.offsetBottom){d.offset.bottom=d.offsetBottom}if(d.offsetTop){d.offset.top=d.offsetTop}e.affix(d)})})}(jQuery);(function(a){a.flexslider=function(b,g){var h=a(b);h.vars=a.extend({},a.flexslider.defaults,g);var j=h.vars.namespace,q=window.navigator&&window.navigator.msPointerEnabled&&window.MSGesture,k=(("ontouchstart" in window)||q||window.DocumentTouch&&document instanceof DocumentTouch)&&h.vars.touch,c="click touchend MSPointerUp",i="",p,f=h.vars.direction==="vertical",l=h.vars.reverse,o=(h.vars.itemWidth>0),e=h.vars.animation==="fade",m=h.vars.asNavFor!=="",d={},n=true;a.data(b,"flexslider",h);d={init:function(){h.animating=false;h.currentSlide=parseInt((h.vars.startAt?h.vars.startAt:0),10);if(isNaN(h.currentSlide)){h.currentSlide=0}h.animatingTo=h.currentSlide;h.atEnd=(h.currentSlide===0||h.currentSlide===h.last);h.containerSelector=h.vars.selector.substr(0,h.vars.selector.search(" "));h.slides=a(h.vars.selector,h);h.container=a(h.containerSelector,h);h.count=h.slides.length;h.syncExists=a(h.vars.sync).length>0;if(h.vars.animation==="slide"){h.vars.animation="swing"}h.prop=(f)?"top":"marginLeft";h.args={};h.manualPause=false;h.stopped=false;h.started=false;h.startTimeout=null;h.transitions=!h.vars.video&&!e&&h.vars.useCSS&&(function(){var t=document.createElement("div"),s=["perspectiveProperty","WebkitPerspective","MozPerspective","OPerspective","msPerspective"];for(var r in s){if(t.style[s[r]]!==undefined){h.pfx=s[r].replace("Perspective","").toLowerCase();h.prop="-"+h.pfx+"-transform";return true}}return false}());h.ensureAnimationEnd="";if(h.vars.controlsContainer!==""){h.controlsContainer=a(h.vars.controlsContainer).length>0&&a(h.vars.controlsContainer)}if(h.vars.manualControls!==""){h.manualControls=a(h.vars.manualControls).length>0&&a(h.vars.manualControls)}if(h.vars.randomize){h.slides.sort(function(){return(Math.round(Math.random())-0.5)});h.container.empty().append(h.slides)}h.doMath();h.setup("init");if(h.vars.controlNav){d.controlNav.setup()}if(h.vars.directionNav){d.directionNav.setup()}if(h.vars.keyboard&&(a(h.containerSelector).length===1||h.vars.multipleKeyboard)){a(document).bind("keyup",function(s){var r=s.keyCode;if(!h.animating&&(r===39||r===37)){var t=(r===39)?h.getTarget("next"):(r===37)?h.getTarget("prev"):false;h.flexAnimate(t,h.vars.pauseOnAction)}})}if(h.vars.mousewheel){h.bind("mousewheel",function(t,v,s,r){t.preventDefault();var u=(v<0)?h.getTarget("next"):h.getTarget("prev");h.flexAnimate(u,h.vars.pauseOnAction)})}if(h.vars.pausePlay){d.pausePlay.setup()}if(h.vars.slideshow&&h.vars.pauseInvisible){d.pauseInvisible.init()}if(h.vars.slideshow){if(h.vars.pauseOnHover){h.hover(function(){if(!h.manualPlay&&!h.manualPause){h.pause()}},function(){if(!h.manualPause&&!h.manualPlay&&!h.stopped){h.play()}})}if(!h.vars.pauseInvisible||!d.pauseInvisible.isHidden()){(h.vars.initDelay>0)?h.startTimeout=setTimeout(h.play,h.vars.initDelay):h.play()}}if(m){d.asNav.setup()}if(k&&h.vars.touch){d.touch()}if(!e||(e&&h.vars.smoothHeight)){a(window).bind("resize orientationchange focus",d.resize)}h.find("img").attr("draggable","false");setTimeout(function(){h.vars.start(h)},200)},asNav:{setup:function(){h.asNav=true;h.animatingTo=Math.floor(h.currentSlide/h.move);h.currentItem=h.currentSlide;h.slides.removeClass(j+"active-slide").eq(h.currentItem).addClass(j+"active-slide");if(!q){h.slides.on(c,function(t){t.preventDefault();var s=a(this),r=s.index();var u=s.offset().left-a(h).scrollLeft();if(u<=0&&s.hasClass(j+"active-slide")){h.flexAnimate(h.getTarget("prev"),true)}else{if(!a(h.vars.asNavFor).data("flexslider").animating&&!s.hasClass(j+"active-slide")){h.direction=(h.currentItem<r)?"next":"prev";h.flexAnimate(r,h.vars.pauseOnAction,false,true,true)}}})}else{b._slider=h;h.slides.each(function(){var r=this;r._gesture=new MSGesture();r._gesture.target=r;r.addEventListener("MSPointerDown",function(s){s.preventDefault();if(s.currentTarget._gesture){s.currentTarget._gesture.addPointer(s.pointerId)}},false);r.addEventListener("MSGestureTap",function(u){u.preventDefault();var t=a(this),s=t.index();if(!a(h.vars.asNavFor).data("flexslider").animating&&!t.hasClass("active")){h.direction=(h.currentItem<s)?"next":"prev";h.flexAnimate(s,h.vars.pauseOnAction,false,true,true)}})})}}},controlNav:{setup:function(){if(!h.manualControls){d.controlNav.setupPaging()}else{d.controlNav.setupManual()}},setupPaging:function(){var u=(h.vars.controlNav==="thumbnails")?"control-thumbs":"control-paging",s=1,v,r;h.controlNavScaffold=a('<ol class="'+j+"control-nav "+j+u+'"></ol>');if(h.pagingCount>1){for(var t=0;t<h.pagingCount;t++){r=h.slides.eq(t);v=(h.vars.controlNav==="thumbnails")?'<img src="'+r.attr("data-thumb")+'"/>':"<a>"+s+"</a>";if("thumbnails"===h.vars.controlNav&&true===h.vars.thumbCaptions){var w=r.attr("data-thumbcaption");if(""!=w&&undefined!=w){v+='<span class="'+j+'caption">'+w+"</span>"}}h.controlNavScaffold.append("<li>"+v+"</li>");s++}}(h.controlsContainer)?a(h.controlsContainer).append(h.controlNavScaffold):h.append(h.controlNavScaffold);d.controlNav.set();d.controlNav.active();h.controlNavScaffold.delegate("a, img",c,function(x){x.preventDefault();if(i===""||i===x.type){var z=a(this),y=h.controlNav.index(z);if(!z.hasClass(j+"active")){h.direction=(y>h.currentSlide)?"next":"prev";h.flexAnimate(y,h.vars.pauseOnAction)}}if(i===""){i=x.type}d.setToClearWatchedEvent()})},setupManual:function(){h.controlNav=h.manualControls;d.controlNav.active();h.controlNav.bind(c,function(r){r.preventDefault();if(i===""||i===r.type){var t=a(this),s=h.controlNav.index(t);if(!t.hasClass(j+"active")){(s>h.currentSlide)?h.direction="next":h.direction="prev";h.flexAnimate(s,h.vars.pauseOnAction)}}if(i===""){i=r.type}d.setToClearWatchedEvent()})},set:function(){var r=(h.vars.controlNav==="thumbnails")?"img":"a";h.controlNav=a("."+j+"control-nav li "+r,(h.controlsContainer)?h.controlsContainer:h)},active:function(){h.controlNav.removeClass(j+"active").eq(h.animatingTo).addClass(j+"active")},update:function(r,s){if(h.pagingCount>1&&r==="add"){h.controlNavScaffold.append(a("<li><a>"+h.count+"</a></li>"))}else{if(h.pagingCount===1){h.controlNavScaffold.find("li").remove()}else{h.controlNav.eq(s).closest("li").remove()}}d.controlNav.set();(h.pagingCount>1&&h.pagingCount!==h.controlNav.length)?h.update(s,r):d.controlNav.active()}},directionNav:{setup:function(){var r=a('<ul class="'+j+'direction-nav"><li><a class="'+j+'prev" href="#">'+h.vars.prevText+'</a></li><li><a class="'+j+'next" href="#">'+h.vars.nextText+"</a></li></ul>");if(h.controlsContainer){a(h.controlsContainer).append(r);h.directionNav=a("."+j+"direction-nav li a",h.controlsContainer)}else{h.append(r);h.directionNav=a("."+j+"direction-nav li a",h)}d.directionNav.update();h.directionNav.bind(c,function(s){s.preventDefault();var t;if(i===""||i===s.type){t=(a(this).hasClass(j+"next"))?h.getTarget("next"):h.getTarget("prev");h.flexAnimate(t,h.vars.pauseOnAction)}if(i===""){i=s.type}d.setToClearWatchedEvent()})},update:function(){var r=j+"disabled";if(h.pagingCount===1){h.directionNav.addClass(r).attr("tabindex","-1")}else{if(!h.vars.animationLoop){if(h.animatingTo===0){h.directionNav.removeClass(r).filter("."+j+"prev").addClass(r).attr("tabindex","-1")}else{if(h.animatingTo===h.last){h.directionNav.removeClass(r).filter("."+j+"next").addClass(r).attr("tabindex","-1")}else{h.directionNav.removeClass(r).removeAttr("tabindex")}}}else{h.directionNav.removeClass(r).removeAttr("tabindex")}}}},pausePlay:{setup:function(){var r=a('<div class="'+j+'pauseplay"><a></a></div>');if(h.controlsContainer){h.controlsContainer.append(r);h.pausePlay=a("."+j+"pauseplay a",h.controlsContainer)}else{h.append(r);h.pausePlay=a("."+j+"pauseplay a",h)}d.pausePlay.update((h.vars.slideshow)?j+"pause":j+"play");h.pausePlay.bind(c,function(s){s.preventDefault();if(i===""||i===s.type){if(a(this).hasClass(j+"pause")){h.manualPause=true;h.manualPlay=false;h.pause()}else{h.manualPause=false;h.manualPlay=true;h.play()}}if(i===""){i=s.type}d.setToClearWatchedEvent()})},update:function(r){(r==="play")?h.pausePlay.removeClass(j+"pause").addClass(j+"play").html(h.vars.playText):h.pausePlay.removeClass(j+"play").addClass(j+"pause").html(h.vars.pauseText)}},touch:function(){var G,C,A,v,x,w,E=false,u=0,F=0,z=0;if(!q){b.addEventListener("touchstart",B,false);function B(H){if(h.animating){H.preventDefault()}else{if((window.navigator.msPointerEnabled)||H.touches.length===1){h.pause();v=(f)?h.h:h.w;w=Number(new Date());u=H.touches[0].pageX;F=H.touches[0].pageY;A=(o&&l&&h.animatingTo===h.last)?0:(o&&l)?h.limit-(((h.itemW+h.vars.itemMargin)*h.move)*h.animatingTo):(o&&h.currentSlide===h.last)?h.limit:(o)?((h.itemW+h.vars.itemMargin)*h.move)*h.currentSlide:(l)?(h.last-h.currentSlide+h.cloneOffset)*v:(h.currentSlide+h.cloneOffset)*v;G=(f)?F:u;C=(f)?u:F;b.addEventListener("touchmove",s,false);b.addEventListener("touchend",r,false)}}}function s(H){u=H.touches[0].pageX;F=H.touches[0].pageY;x=(f)?G-F:G-u;E=(f)?(Math.abs(x)<Math.abs(u-C)):(Math.abs(x)<Math.abs(F-C));var I=500;if(!E||Number(new Date())-w>I){H.preventDefault();if(!e&&h.transitions){if(!h.vars.animationLoop){x=x/((h.currentSlide===0&&x<0||h.currentSlide===h.last&&x>0)?(Math.abs(x)/v+2):1)}h.setProps(A+x,"setTouch")}}}function r(J){b.removeEventListener("touchmove",s,false);if(h.animatingTo===h.currentSlide&&!E&&!(x===null)){var I=(l)?-x:x,H=(I>0)?h.getTarget("next"):h.getTarget("prev");if(h.canAdvance(H)&&(Number(new Date())-w<550&&Math.abs(I)>50||Math.abs(I)>v/2)){h.flexAnimate(H,h.vars.pauseOnAction)}else{if(!e){h.flexAnimate(h.currentSlide,h.vars.pauseOnAction,true)}}}b.removeEventListener("touchend",r,false);G=null;C=null;x=null;A=null}}else{b.style.msTouchAction="none";b._gesture=new MSGesture();b._gesture.target=b;b.addEventListener("MSPointerDown",t,false);b._slider=h;b.addEventListener("MSGestureChange",D,false);b.addEventListener("MSGestureEnd",y,false);function t(H){H.stopPropagation();if(h.animating){H.preventDefault()}else{h.pause();b._gesture.addPointer(H.pointerId);z=0;v=(f)?h.h:h.w;w=Number(new Date());A=(o&&l&&h.animatingTo===h.last)?0:(o&&l)?h.limit-(((h.itemW+h.vars.itemMargin)*h.move)*h.animatingTo):(o&&h.currentSlide===h.last)?h.limit:(o)?((h.itemW+h.vars.itemMargin)*h.move)*h.currentSlide:(l)?(h.last-h.currentSlide+h.cloneOffset)*v:(h.currentSlide+h.cloneOffset)*v}}function D(I){I.stopPropagation();var H=I.target._slider;if(!H){return}var K=-I.translationX,J=-I.translationY;z=z+((f)?J:K);x=z;E=(f)?(Math.abs(z)<Math.abs(-K)):(Math.abs(z)<Math.abs(-J));if(I.detail===I.MSGESTURE_FLAG_INERTIA){setImmediate(function(){b._gesture.stop()});return}if(!E||Number(new Date())-w>500){I.preventDefault();if(!e&&H.transitions){if(!H.vars.animationLoop){x=z/((H.currentSlide===0&&z<0||H.currentSlide===H.last&&z>0)?(Math.abs(z)/v+2):1)}H.setProps(A+x,"setTouch")}}}function y(I){I.stopPropagation();var J=I.target._slider;if(!J){return}if(J.animatingTo===J.currentSlide&&!E&&!(x===null)){var H=(l)?-x:x,K=(H>0)?J.getTarget("next"):J.getTarget("prev");if(J.canAdvance(K)&&(Number(new Date())-w<550&&Math.abs(H)>50||Math.abs(H)>v/2)){J.flexAnimate(K,J.vars.pauseOnAction)}else{if(!e){J.flexAnimate(J.currentSlide,J.vars.pauseOnAction,true)}}}G=null;C=null;x=null;A=null;z=0}}},resize:function(){if(!h.animating&&h.is(":visible")){if(!o){h.doMath()}if(e){d.smoothHeight()}else{if(o){h.slides.width(h.computedW);h.update(h.pagingCount);h.setProps()}else{if(f){h.viewport.height(h.h);h.setProps(h.h,"setTotal")}else{if(h.vars.smoothHeight){d.smoothHeight()}h.newSlides.width(h.computedW);h.setProps(h.computedW,"setTotal")}}}}},smoothHeight:function(r){if(!f||e){var s=(e)?h:h.viewport;(r)?s.animate({height:h.slides.eq(h.animatingTo).height()},r):s.height(h.slides.eq(h.animatingTo).height())}},sync:function(r){var t=a(h.vars.sync).data("flexslider"),s=h.animatingTo;switch(r){case"animate":t.flexAnimate(s,h.vars.pauseOnAction,false,true);break;case"play":if(!t.playing&&!t.asNav){t.play()}break;case"pause":t.pause();break}},uniqueID:function(r){r.find("[id]").each(function(){var s=a(this);s.attr("id",s.attr("id")+"_clone")});return r},pauseInvisible:{visProp:null,init:function(){var t=["webkit","moz","ms","o"];if("hidden" in document){return"hidden"}for(var s=0;s<t.length;s++){if((t[s]+"Hidden") in document){d.pauseInvisible.visProp=t[s]+"Hidden"}}if(d.pauseInvisible.visProp){var r=d.pauseInvisible.visProp.replace(/[H|h]idden/,"")+"visibilitychange";document.addEventListener(r,function(){if(d.pauseInvisible.isHidden()){if(h.startTimeout){clearTimeout(h.startTimeout)}else{h.pause()}}else{if(h.started){h.play()}else{(h.vars.initDelay>0)?setTimeout(h.play,h.vars.initDelay):h.play()}}})}},isHidden:function(){return document[d.pauseInvisible.visProp]||false}},setToClearWatchedEvent:function(){clearTimeout(p);p=setTimeout(function(){i=""},3000)}};h.flexAnimate=function(w,x,A,s,t){if(!h.vars.animationLoop&&w!==h.currentSlide){h.direction=(w>h.currentSlide)?"next":"prev"}if(m&&h.pagingCount===1){h.direction=(h.currentItem<w)?"next":"prev"}if(!h.animating&&(h.canAdvance(w,t)||A)&&h.is(":visible")){if(m&&s){var z=a(h.vars.asNavFor).data("flexslider");h.atEnd=w===0||w===h.count-1;z.flexAnimate(w,true,false,true,t);h.direction=(h.currentItem<w)?"next":"prev";z.direction=h.direction;if(Math.ceil((w+1)/h.visible)-1!==h.currentSlide&&w!==0){h.currentItem=w;h.slides.removeClass(j+"active-slide").eq(w).addClass(j+"active-slide");w=Math.floor(w/h.visible)}else{h.currentItem=w;h.slides.removeClass(j+"active-slide").eq(w).addClass(j+"active-slide");return false}}h.animating=true;h.animatingTo=w;if(x){h.pause()}h.vars.before(h);if(h.syncExists&&!t){d.sync("animate")}if(h.vars.controlNav){d.controlNav.active()}if(!o){h.slides.removeClass(j+"active-slide").eq(w).addClass(j+"active-slide")}h.atEnd=w===0||w===h.last;if(h.vars.directionNav){d.directionNav.update()}if(w===h.last){h.vars.end(h);if(!h.vars.animationLoop){h.pause()}}if(!e){var v=(f)?h.slides.filter(":first").height():h.computedW,u,r,y;if(o){u=h.vars.itemMargin;y=((h.itemW+u)*h.move)*h.animatingTo;r=(y>h.limit&&h.visible!==1)?h.limit:y}else{if(h.currentSlide===0&&w===h.count-1&&h.vars.animationLoop&&h.direction!=="next"){r=(l)?(h.count+h.cloneOffset)*v:0}else{if(h.currentSlide===h.last&&w===0&&h.vars.animationLoop&&h.direction!=="prev"){r=(l)?0:(h.count+1)*v}else{r=(l)?((h.count-1)-w+h.cloneOffset)*v:(w+h.cloneOffset)*v}}}h.setProps(r,"",h.vars.animationSpeed);if(h.transitions){if(!h.vars.animationLoop||!h.atEnd){h.animating=false;h.currentSlide=h.animatingTo}h.container.unbind("webkitTransitionEnd transitionend");h.container.bind("webkitTransitionEnd transitionend",function(){clearTimeout(h.ensureAnimationEnd);h.wrapup(v)});clearTimeout(h.ensureAnimationEnd);h.ensureAnimationEnd=setTimeout(function(){h.wrapup(v)},h.vars.animationSpeed+100)}else{h.container.animate(h.args,h.vars.animationSpeed,h.vars.easing,function(){h.wrapup(v)})}}else{if(!k){h.slides.eq(h.currentSlide).css({zIndex:1}).animate({opacity:0},h.vars.animationSpeed,h.vars.easing);h.slides.eq(w).css({zIndex:2}).animate({opacity:1},h.vars.animationSpeed,h.vars.easing,h.wrapup)}else{h.slides.eq(h.currentSlide).css({opacity:0,zIndex:1});h.slides.eq(w).css({opacity:1,zIndex:2});h.wrapup(v)}}if(h.vars.smoothHeight){d.smoothHeight(h.vars.animationSpeed)}}};h.wrapup=function(r){if(!e&&!o){if(h.currentSlide===0&&h.animatingTo===h.last&&h.vars.animationLoop){h.setProps(r,"jumpEnd")}else{if(h.currentSlide===h.last&&h.animatingTo===0&&h.vars.animationLoop){h.setProps(r,"jumpStart")}}}h.animating=false;h.currentSlide=h.animatingTo;h.vars.after(h)};h.animateSlides=function(){if(!h.animating&&n){h.flexAnimate(h.getTarget("next"))}};h.pause=function(){clearInterval(h.animatedSlides);h.animatedSlides=null;h.playing=false;if(h.vars.pausePlay){d.pausePlay.update("play")}if(h.syncExists){d.sync("pause")}};h.play=function(){if(h.playing){clearInterval(h.animatedSlides)}h.animatedSlides=h.animatedSlides||setInterval(h.animateSlides,h.vars.slideshowSpeed);h.started=h.playing=true;if(h.vars.pausePlay){d.pausePlay.update("pause")}if(h.syncExists){d.sync("play")}};h.stop=function(){h.pause();h.stopped=true};h.canAdvance=function(t,r){var s=(m)?h.pagingCount-1:h.last;return(r)?true:(m&&h.currentItem===h.count-1&&t===0&&h.direction==="prev")?true:(m&&h.currentItem===0&&t===h.pagingCount-1&&h.direction!=="next")?false:(t===h.currentSlide&&!m)?false:(h.vars.animationLoop)?true:(h.atEnd&&h.currentSlide===0&&t===s&&h.direction!=="next")?false:(h.atEnd&&h.currentSlide===s&&t===0&&h.direction==="next")?false:true};h.getTarget=function(r){h.direction=r;if(r==="next"){return(h.currentSlide===h.last)?0:h.currentSlide+1}else{return(h.currentSlide===0)?h.last:h.currentSlide-1}};h.setProps=function(u,r,s){var t=(function(){var v=(u)?u:((h.itemW+h.vars.itemMargin)*h.move)*h.animatingTo,w=(function(){if(o){return(r==="setTouch")?u:(l&&h.animatingTo===h.last)?0:(l)?h.limit-(((h.itemW+h.vars.itemMargin)*h.move)*h.animatingTo):(h.animatingTo===h.last)?h.limit:v}else{switch(r){case"setTotal":return(l)?((h.count-1)-h.currentSlide+h.cloneOffset)*u:(h.currentSlide+h.cloneOffset)*u;case"setTouch":return(l)?u:u;case"jumpEnd":return(l)?u:h.count*u;case"jumpStart":return(l)?h.count*u:u;default:return u}}}());return(w*-1)+"px"}());if(h.transitions){t=(f)?"translate3d(0,"+t+",0)":"translate3d("+t+",0,0)";s=(s!==undefined)?(s/1000)+"s":"0s";h.container.css("-"+h.pfx+"-transition-duration",s);h.container.css("transition-duration",s)}h.args[h.prop]=t;if(h.transitions||s===undefined){h.container.css(h.args)}h.container.css("transform",t)};h.setup=function(s){if(!e){var t,r;if(s==="init"){h.viewport=a('<div class="'+j+'viewport"></div>').css({overflow:"hidden",position:"relative"}).appendTo(h).append(h.container);h.cloneCount=0;h.cloneOffset=0;if(l){r=a.makeArray(h.slides).reverse();h.slides=a(r);h.container.empty().append(h.slides)}}if(h.vars.animationLoop&&!o){h.cloneCount=2;h.cloneOffset=1;if(s!=="init"){h.container.find(".clone").remove()}d.uniqueID(h.slides.first().clone().addClass("clone").attr("aria-hidden","true")).appendTo(h.container);d.uniqueID(h.slides.last().clone().addClass("clone").attr("aria-hidden","true")).prependTo(h.container)}h.newSlides=a(h.vars.selector,h);t=(l)?h.count-1-h.currentSlide+h.cloneOffset:h.currentSlide+h.cloneOffset;if(f&&!o){h.container.height((h.count+h.cloneCount)*200+"%").css("position","absolute").width("100%");setTimeout(function(){h.newSlides.css({display:"block"});h.doMath();h.viewport.height(h.h);h.setProps(t*h.h,"init")},(s==="init")?100:0)}else{h.container.width((h.count+h.cloneCount)*200+"%");h.setProps(t*h.computedW,"init");setTimeout(function(){h.doMath();h.newSlides.css({width:h.computedW,"float":"left",display:"block"});if(h.vars.smoothHeight){d.smoothHeight()}},(s==="init")?100:0)}}else{h.slides.css({width:"100%","float":"left",marginRight:"-100%",position:"relative"});if(s==="init"){if(!k){h.slides.css({opacity:0,display:"block",zIndex:1}).eq(h.currentSlide).css({zIndex:2}).animate({opacity:1},h.vars.animationSpeed,h.vars.easing)}else{h.slides.css({opacity:0,display:"block",webkitTransition:"opacity "+h.vars.animationSpeed/1000+"s ease",zIndex:1}).eq(h.currentSlide).css({opacity:1,zIndex:2})}}if(h.vars.smoothHeight){d.smoothHeight()}}if(!o){h.slides.removeClass(j+"active-slide").eq(h.currentSlide).addClass(j+"active-slide")}h.vars.init(h)};h.doMath=function(){var r=h.slides.first(),u=h.vars.itemMargin,s=h.vars.minItems,t=h.vars.maxItems;h.w=(h.viewport===undefined)?h.width():h.viewport.width();h.h=r.height();h.boxPadding=r.outerWidth()-r.width();if(o){h.itemT=h.vars.itemWidth+u;h.minW=(s)?s*h.itemT:h.w;h.maxW=(t)?(t*h.itemT)-u:h.w;h.itemW=(h.minW>h.w)?(h.w-(u*(s-1)))/s:(h.maxW<h.w)?(h.w-(u*(t-1)))/t:(h.vars.itemWidth>h.w)?h.w:h.vars.itemWidth;h.visible=Math.floor(h.w/(h.itemW));h.move=(h.vars.move>0&&h.vars.move<h.visible)?h.vars.move:h.visible;h.pagingCount=Math.ceil(((h.count-h.visible)/h.move)+1);h.last=h.pagingCount-1;h.limit=(h.pagingCount===1)?0:(h.vars.itemWidth>h.w)?(h.itemW*(h.count-1))+(u*(h.count-1)):((h.itemW+u)*h.count)-h.w-u}else{h.itemW=h.w;h.pagingCount=h.count;h.last=h.count-1}h.computedW=h.itemW-h.boxPadding};h.update=function(s,r){h.doMath();if(!o){if(s<h.currentSlide){h.currentSlide+=1}else{if(s<=h.currentSlide&&s!==0){h.currentSlide-=1}}h.animatingTo=h.currentSlide}if(h.vars.controlNav&&!h.manualControls){if((r==="add"&&!o)||h.pagingCount>h.controlNav.length){d.controlNav.update("add")}else{if((r==="remove"&&!o)||h.pagingCount<h.controlNav.length){if(o&&h.currentSlide>h.last){h.currentSlide-=1;h.animatingTo-=1}d.controlNav.update("remove",h.last)}}}if(h.vars.directionNav){d.directionNav.update()}};h.addSlide=function(r,t){var s=a(r);h.count+=1;h.last=h.count-1;if(f&&l){(t!==undefined)?h.slides.eq(h.count-t).after(s):h.container.prepend(s)}else{(t!==undefined)?h.slides.eq(t).before(s):h.container.append(s)}h.update(t,"add");h.slides=a(h.vars.selector+":not(.clone)",h);h.setup();h.vars.added(h)};h.removeSlide=function(r){var s=(isNaN(r))?h.slides.index(a(r)):r;h.count-=1;h.last=h.count-1;if(isNaN(r)){a(r,h.slides).remove()}else{(f&&l)?h.slides.eq(h.last).remove():h.slides.eq(r).remove()}h.doMath();h.update(s,"remove");h.slides=a(h.vars.selector+":not(.clone)",h);h.setup();h.vars.removed(h)};d.init()};a(window).blur(function(b){focused=false}).focus(function(b){focused=true});a.flexslider.defaults={namespace:"flex-",selector:".slides > li",animation:"fade",easing:"swing",direction:"horizontal",reverse:false,animationLoop:true,smoothHeight:false,startAt:0,slideshow:true,slideshowSpeed:7000,animationSpeed:600,initDelay:0,randomize:false,thumbCaptions:false,pauseOnAction:true,pauseOnHover:false,pauseInvisible:true,useCSS:true,touch:true,video:false,controlNav:true,directionNav:true,prevText:"Previous",nextText:"Next",keyboard:true,multipleKeyboard:false,mousewheel:false,pausePlay:false,pauseText:"Pause",playText:"Play",controlsContainer:"",manualControls:"",sync:"",asNavFor:"",itemWidth:0,itemMargin:0,minItems:1,maxItems:0,move:0,allowOneSlide:true,start:function(){},before:function(){},after:function(){},end:function(){},added:function(){},removed:function(){},init:function(){}};a.fn.flexslider=function(b){if(b===undefined){b={}}if(typeof b==="object"){return this.each(function(){var f=a(this),d=(b.selector)?b.selector:".slides > li",e=f.find(d);if((e.length===1&&b.allowOneSlide===true)||e.length===0){e.fadeIn(400);if(b.start){b.start(f)}}else{if(f.data("flexslider")===undefined){new a.flexslider(this,b)}}})}else{var c=a(this).data("flexslider");switch(b){case"play":c.play();break;case"pause":c.pause();break;case"stop":c.stop();break;case"next":c.flexAnimate(c.getTarget("next"),true);break;case"prev":case"previous":c.flexAnimate(c.getTarget("prev"),true);break;default:if(typeof b==="number"){c.flexAnimate(b,true)}}}}})(jQuery);
/*!
 * Created by mario on 15/05/14.
 */
;$(window).load(function(){$(".flexslider-principal").flexslider({animation:"slide",slideshowSpeed:5000,startAt:0,slideshow:true});$(".flexslider-destaque").flexslider({animation:"slide",controlNav:"thumbnails",randomize:false,slideshow:false});$("#flexslider-detalhe-thumb").flexslider({animation:"slide",controlNav:false,animationLoop:false,slideshow:false,itemWidth:120,itemMargin:5,asNavFor:"#flexslider-detalhe"});$("#flexslider-detalhe").flexslider({animation:"slide",controlNav:false,animationLoop:false,slideshow:false,sync:"#flexslider-detalhe-thumb"})});
 ...
 * Licensed under MIT (https://github.com/twbs/bootstrap/blob/master/LICENSE)
 */
;if(typeof jQuery==="undefined"){throw new Error("Bootstrap's JavaScript requires jQuery")}+function(c){function d(){var a=document.createElement("bootstrap");var b={WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd otransitionend",transition:"transitionend"};for(var f in b){if(a.style[f]!==undefined){return{end:b[f]}}}return false}c.fn.emulateTransitionEnd=function(h){var a=false,b=this;c(this).one(c.support.transition.end,function(){a=true});var g=function(){if(!a){c(b).trigger(c.support.transition.end)}};setTimeout(g,h);return this};c(function(){c.support.transition=d()})}(jQuery);+function(e){var f='[data-dismiss="alert"]';var g=function(a){e(a).on("click",f,this.close)};g.prototype.close=function(j){var a=e(this);var c=a.attr("data-target");if(!c){c=a.attr("href");c=c&&c.replace(/.*(?=#[^\s]*$)/,"")}var b=e(c);if(j){j.preventDefault()}if(!b.length){b=a.hasClass("alert")?a:a.parent()}b.trigger(j=e.Event("close.bs.alert"));if(j.isDefaultPrevented()){return}b.removeClass("in");function d(){b.trigger("closed.bs.alert").remove()}e.support.transition&&b.hasClass("fade")?b.one(e.support.transition.end,d).emulateTransitionEnd(150):d()};var h=e.fn.alert;e.fn.alert=function(a){return this.each(function(){var c=e(this);var b=c.data("bs.alert");if(!b){c.data("bs.alert",(b=new g(this)))}if(typeof a=="string"){b[a].call(c)}})};e.fn.alert.Constructor=g;e.fn.alert.noConflict=function(){e.fn.alert=h;return this};e(document).on("click.bs.alert.data-api",f,g.prototype.close)}(jQuery);+function(f){var d=function(a,b){this.$element=f(a);this.options=f.extend({},d.DEFAULTS,b);this.isLoading=false};d.DEFAULTS={loadingText:"loading..."};d.prototype.setState=function(b){var j="disabled";var i=this.$element;var a=i.is("input")?"val":"html";var c=i.data();b=b+"Text";if(!c.resetText){i.data("resetText",i[a]())}i[a](c[b]||this.options[b]);setTimeout(f.proxy(function(){if(b=="loadingText"){this.isLoading=true;i.addClass(j).attr(j,j)}else{if(this.isLoading){this.isLoading=false;i.removeClass(j).removeAttr(j)}}},this),0)};d.prototype.toggle=function(){var b=true;var c=this.$element.closest('[data-toggle="buttons"]');if(c.length){var a=this.$element.find("input");if(a.prop("type")=="radio"){if(a.prop("checked")&&this.$element.hasClass("active")){b=false}else{c.find(".active").removeClass("active")}}if(b){a.prop("checked",!this.$element.hasClass("active")).trigger("change")}}if(b){this.$element.toggleClass("active")}};var e=f.fn.button;f.fn.button=function(a){return this.each(function(){var b=f(this);var c=b.data("bs.button");var h=typeof a=="object"&&a;if(!c){b.data("bs.button",(c=new d(this,h)))}if(a=="toggle"){c.toggle()}else{if(a){c.setState(a)}}})};f.fn.button.Constructor=d;f.fn.button.noConflict=function(){f.fn.button=e;return this};f(document).on("click.bs.button.data-api","[data-toggle^=button]",function(a){var b=f(a.target);if(!b.hasClass("btn")){b=b.closest(".btn")}b.button("toggle");a.preventDefault()})}(jQuery);+function(d){var f=function(a,b){this.$element=d(a);this.$indicators=this.$element.find(".carousel-indicators");this.options=b;this.paused=this.sliding=this.interval=this.$active=this.$items=null;this.options.pause=="hover"&&this.$element.on("mouseenter",d.proxy(this.pause,this)).on("mouseleave",d.proxy(this.cycle,this))};f.DEFAULTS={interval:5000,pause:"hover",wrap:true};f.prototype.cycle=function(a){a||(this.paused=false);this.interval&&clearInterval(this.interval);this.options.interval&&!this.paused&&(this.interval=setInterval(d.proxy(this.next,this),this.options.interval));return this};f.prototype.getActiveIndex=function(){this.$active=this.$element.find(".item.active");this.$items=this.$active.parent().children();return this.$items.index(this.$active)};f.prototype.to=function(a){var b=this;var c=this.getActiveIndex();if(a>(this.$items.length-1)||a<0){return}if(this.sliding){return this.$element.one("slid.bs.carousel",function(){b.to(a)})}if(c==a){return this.pause().cycle()}return this.slide(a>c?"next":"prev",d(this.$items[a]))};f.prototype.pause=function(a){a||(this.paused=true);if(this.$element.find(".next, .prev").length&&d.support.transition){this.$element.trigger(d.support.transition.end);this.cycle(true)}this.interval=clearInterval(this.interval);return this};f.prototype.next=function(){if(this.sliding){return}return this.slide("next")};f.prototype.prev=function(){if(this.sliding){return}return this.slide("prev")};f.prototype.slide=function(m,r){var b=this.$element.find(".item.active");var a=r||b[m]();var n=this.interval;var c=m=="next"?"left":"right";var q=m=="next"?"first":"last";var p=this;if(!a.length){if(!this.options.wrap){return}a=this.$element.find(".item")[q]()}if(a.hasClass("active")){return this.sliding=false}var o=d.Event("slide.bs.carousel",{relatedTarget:a[0],direction:c});this.$element.trigger(o);if(o.isDefaultPrevented()){return}this.sliding=true;n&&this.pause();if(this.$indicators.length){this.$indicators.find(".active").removeClass("active");this.$element.one("slid.bs.carousel",function(){var g=d(p.$indicators.children()[p.getActiveIndex()]);g&&g.addClass("active")})}if(d.support.transition&&this.$element.hasClass("slide")){a.addClass(m);a[0].offsetWidth;b.addClass(c);a.addClass(c);b.one(d.support.transition.end,function(){a.removeClass([m,c].join(" ")).addClass("active");b.removeClass(["active",c].join(" "));p.sliding=false;setTimeout(function(){p.$element.trigger("slid.bs.carousel")},0)}).emulateTransitionEnd(b.css("transition-duration").slice(0,-1)*1000)}else{b.removeClass("active");a.addClass("active");this.sliding=false;this.$element.trigger("slid.bs.carousel")}n&&this.cycle();return this};var e=d.fn.carousel;d.fn.carousel=function(a){return this.each(function(){var c=d(this);var i=c.data("bs.carousel");var b=d.extend({},f.DEFAULTS,c.data(),typeof a=="object"&&a);var j=typeof a=="string"?a:b.slide;if(!i){c.data("bs.carousel",(i=new f(this,b)))}if(typeof a=="number"){i.to(a)}else{if(j){i[j]()}else{if(b.interval){i.pause().cycle()}}}})};d.fn.carousel.Constructor=f;d.fn.carousel.noConflict=function(){d.fn.carousel=e;return this};d(document).on("click.bs.carousel.data-api","[data-slide], [data-slide-to]",function(j){var a=d(this),l;var b=d(a.attr("data-target")||(l=a.attr("href"))&&l.replace(/.*(?=#[^\s]+$)/,""));var k=d.extend({},b.data(),a.data());var c=a.attr("data-slide-to");if(c){k.interval=false}b.carousel(k);if(c=a.attr("data-slide-to")){b.data("bs.carousel").to(c)}j.preventDefault()});d(window).on("load",function(){d('[data-ride="carousel"]').each(function(){var a=d(this);a.carousel(a.data())})})}(jQuery);+function(d){var f=function(a,b){this.$element=d(a);this.options=d.extend({},f.DEFAULTS,b);this.transitioning=null;if(this.options.parent){this.$parent=d(this.options.parent)}if(this.options.toggle){this.toggle()}};f.DEFAULTS={toggle:true};f.prototype.dimension=function(){var a=this.$element.hasClass("width");return a?"width":"height"};f.prototype.show=function(){if(this.transitioning||this.$element.hasClass("in")){return}var j=d.Event("show.bs.collapse");this.$element.trigger(j);if(j.isDefaultPrevented()){return}var b=this.$parent&&this.$parent.find("> .panel > .in");if(b&&b.length){var k=b.data("bs.collapse");if(k&&k.transitioning){return}b.collapse("hide");k||b.data("bs.collapse",null)}var l=this.dimension();this.$element.removeClass("collapse").addClass("collapsing")[l](0);this.transitioning=1;var a=function(){this.$element.removeClass("collapsing").addClass("collapse in")[l]("auto");this.transitioning=0;this.$element.trigger("shown.bs.collapse")};if(!d.support.transition){return a.call(this)}var c=d.camelCase(["scroll",l].join("-"));this.$element.one(d.support.transition.end,d.proxy(a,this)).emulateTransitionEnd(350)[l](this.$element[0][c])};f.prototype.hide=function(){if(this.transitioning||!this.$element.hasClass("in")){return}var b=d.Event("hide.bs.collapse");this.$element.trigger(b);if(b.isDefaultPrevented()){return}var a=this.dimension();this.$element[a](this.$element[a]())[0].offsetHeight;this.$element.addClass("collapsing").removeClass("collapse").removeClass("in");this.transitioning=1;var c=function(){this.transitioning=0;this.$element.trigger("hidden.bs.collapse").removeClass("collapsing").addClass("collapse")};if(!d.support.transition){return c.call(this)}this.$element[a](0).one(d.support.transition.end,d.proxy(c,this)).emulateTransitionEnd(350)};f.prototype.toggle=function(){this[this.$element.hasClass("in")?"hide":"show"]()};var e=d.fn.collapse;d.fn.collapse=function(a){return this.each(function(){var b=d(this);var c=b.data("bs.collapse");var h=d.extend({},f.DEFAULTS,b.data(),typeof a=="object"&&a);if(!c&&h.toggle&&a=="show"){a=!a}if(!c){b.data("bs.collapse",(c=new f(this,h)))}if(typeof a=="string"){c[a]()}})};d.fn.collapse.Constructor=f;d.fn.collapse.noConflict=function(){d.fn.collapse=e;return this};d(document).on("click.bs.collapse.data-api","[data-toggle=collapse]",function(n){var c=d(this),a;var m=c.attr("data-target")||n.preventDefault()||(a=c.attr("href"))&&a.replace(/.*(?=#[^\s]+$)/,"");var r=d(m);var p=r.data("bs.collapse");var o=p?"toggle":c.data();var b=c.attr("data-parent");var q=b&&d(b);if(!p||!p.transitioning){if(q){q.find('[data-toggle=collapse][data-parent="'+b+'"]').not(c).addClass("collapsed")}c[r.hasClass("in")?"addClass":"removeClass"]("collapsed")}r.collapse(o)})}(jQuery);+function(l){var n=".dropdown-backdrop";var j="[data-toggle=dropdown]";var k=function(a){l(a).on("click.bs.dropdown",this.toggle)};k.prototype.toggle=function(e){var a=l(this);if(a.is(".disabled, :disabled")){return}var b=m(a);var c=b.hasClass("open");h();if(!c){if("ontouchstart" in document.documentElement&&!b.closest(".navbar-nav").length){l('<div class="dropdown-backdrop"/>').insertAfter(l(this)).on("click",h)}var d={relatedTarget:this};b.trigger(e=l.Event("show.bs.dropdown",d));if(e.isDefaultPrevented()){return}b.toggleClass("open").trigger("shown.bs.dropdown",d);a.focus()}return false};k.prototype.keydown=function(g){if(!/(38|40|27)/.test(g.keyCode)){return}var a=l(this);g.preventDefault();g.stopPropagation();if(a.is(".disabled, :disabled")){return}var b=m(a);var c=b.hasClass("open");if(!c||(c&&g.keyCode==27)){if(g.which==27){b.find(j).focus()}return a.click()}var f=" li:not(.divider):visible a";var e=b.find("[role=menu]"+f+", [role=listbox]"+f);if(!e.length){return}var d=e.index(e.filter(":focus"));if(g.keyCode==38&&d>0){d--}if(g.keyCode==40&&d<e.length-1){d++}if(!~d){d=0}e.eq(d).focus()};function h(a){l(n).remove();l(j).each(function(){var c=m(l(this));var b={relatedTarget:this};if(!c.hasClass("open")){return}c.trigger(a=l.Event("hide.bs.dropdown",b));if(a.isDefaultPrevented()){return}c.removeClass("open").trigger("hidden.bs.dropdown",b)})}function m(a){var c=a.attr("data-target");if(!c){c=a.attr("href");c=c&&/#[A-Za-z]/.test(c)&&c.replace(/.*(?=#[^\s]*$)/,"")}var b=c&&l(c);return b&&b.length?b:a.parent()}var i=l.fn.dropdown;l.fn.dropdown=function(a){return this.each(function(){var c=l(this);var b=c.data("bs.dropdown");if(!b){c.data("bs.dropdown",(b=new k(this)))}if(typeof a=="string"){b[a].call(c)}})};l.fn.dropdown.Constructor=k;l.fn.dropdown.noConflict=function(){l.fn.dropdown=i;return this};l(document).on("click.bs.dropdown.data-api",h).on("click.bs.dropdown.data-api",".dropdown form",function(a){a.stopPropagation()}).on("click.bs.dropdown.data-api",j,k.prototype.toggle).on("keydown.bs.dropdown.data-api",j+", [role=menu], [role=listbox]",k.prototype.keydown)}(jQuery);+function(f){var d=function(a,b){this.options=b;this.$element=f(a);this.$backdrop=this.isShown=null;if(this.options.remote){this.$element.find(".modal-content").load(this.options.remote,f.proxy(function(){this.$element.trigger("loaded.bs.modal")},this))}};d.DEFAULTS={backdrop:true,keyboard:true,show:true};d.prototype.toggle=function(a){return this[!this.isShown?"show":"hide"](a)};d.prototype.show=function(a){var c=this;var b=f.Event("show.bs.modal",{relatedTarget:a});this.$element.trigger(b);if(this.isShown||b.isDefaultPrevented()){return}this.isShown=true;this.escape();this.$element.on("click.dismiss.bs.modal",'[data-dismiss="modal"]',f.proxy(this.hide,this));this.backdrop(function(){var g=f.support.transition&&c.$element.hasClass("fade");if(!c.$element.parent().length){c.$element.appendTo(document.body)}c.$element.show().scrollTop(0);if(g){c.$element[0].offsetWidth}c.$element.addClass("in").attr("aria-hidden",false);c.enforceFocus();var j=f.Event("shown.bs.modal",{relatedTarget:a});g?c.$element.find(".modal-dialog").one(f.support.transition.end,function(){c.$element.focus().trigger(j)}).emulateTransitionEnd(300):c.$element.focus().trigger(j)})};d.prototype.hide=function(a){if(a){a.preventDefault()}a=f.Event("hide.bs.modal");this.$element.trigger(a);if(!this.isShown||a.isDefaultPrevented()){return}this.isShown=false;this.escape();f(document).off("focusin.bs.modal");this.$element.removeClass("in").attr("aria-hidden",true).off("click.dismiss.bs.modal");f.support.transition&&this.$element.hasClass("fade")?this.$element.one(f.support.transition.end,f.proxy(this.hideModal,this)).emulateTransitionEnd(300):this.hideModal()};d.prototype.enforceFocus=function(){f(document).off("focusin.bs.modal").on("focusin.bs.modal",f.proxy(function(a){if(this.$element[0]!==a.target&&!this.$element.has(a.target).length){this.$element.focus()}},this))};d.prototype.escape=function(){if(this.isShown&&this.options.keyboard){this.$element.on("keyup.dismiss.bs.modal",f.proxy(function(a){a.which==27&&this.hide()},this))}else{if(!this.isShown){this.$element.off("keyup.dismiss.bs.modal")}}};d.prototype.hideModal=function(){var a=this;this.$element.hide();this.backdrop(function(){a.removeBackdrop();a.$element.trigger("hidden.bs.modal")})};d.prototype.removeBackdrop=function(){this.$backdrop&&this.$backdrop.remove();this.$backdrop=null};d.prototype.backdrop=function(a){var b=this.$element.hasClass("fade")?"fade":"";if(this.isShown&&this.options.backdrop){var c=f.support.transition&&b;this.$backdrop=f('<div class="modal-backdrop '+b+'" />').appendTo(document.body);this.$element.on("click.dismiss.bs.modal",f.proxy(function(h){if(h.target!==h.currentTarget){return}this.options.backdrop=="static"?this.$element[0].focus.call(this.$element[0]):this.hide.call(this)},this));if(c){this.$backdrop[0].offsetWidth}this.$backdrop.addClass("in");if(!a){return}c?this.$backdrop.one(f.support.transition.end,a).emulateTransitionEnd(150):a()}else{if(!this.isShown&&this.$backdrop){this.$backdrop.removeClass("in");f.support.transition&&this.$element.hasClass("fade")?this.$backdrop.one(f.support.transition.end,a).emulateTransitionEnd(150):a()}else{if(a){a()}}}};var e=f.fn.modal;f.fn.modal=function(b,a){return this.each(function(){var c=f(this);var i=c.data("bs.modal");var j=f.extend({},d.DEFAULTS,c.data(),typeof b=="object"&&b);if(!i){c.data("bs.modal",(i=new d(this,j)))}if(typeof b=="string"){i[b](a)}else{if(j.show){i.show(a)}}})};f.fn.modal.Constructor=d;f.fn.modal.noConflict=function(){f.fn.modal=e;return this};f(document).on("click.bs.modal.data-api",'[data-toggle="modal"]',function(j){var a=f(this);var c=a.attr("href");var i=f(a.attr("data-target")||(c&&c.replace(/.*(?=#[^\s]+$)/,"")));var b=i.data("bs.modal")?"toggle":f.extend({remote:!/#/.test(c)&&c},i.data(),a.data());if(a.is("a")){j.preventDefault()}i.modal(b,this).one("hide",function(){a.is(":visible")&&a.focus()})});f(document).on("show.bs.modal",".modal",function(){f(document.body).addClass("modal-open")}).on("hidden.bs.modal",".modal",function(){f(document.body).removeClass("modal-open")})}(jQuery);+function(f){var d=function(a,b){this.type=this.options=this.enabled=this.timeout=this.hoverState=this.$element=null;this.init("tooltip",a,b)};d.DEFAULTS={animation:true,placement:"top",selector:false,template:'<div class="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',trigger:"hover focus",title:"",delay:0,html:false,container:false};d.prototype.init=function(a,c,b){this.enabled=true;this.type=a;this.$element=f(c);this.options=this.getOptions(b);var i=this.options.trigger.split(" ");for(var m=i.length;m--;){var n=i[m];if(n=="click"){this.$element.on("click."+this.type,this.options.selector,f.proxy(this.toggle,this))}else{if(n!="manual"){var o=n=="hover"?"mouseenter":"focusin";var p=n=="hover"?"mouseleave":"focusout";this.$element.on(o+"."+this.type,this.options.selector,f.proxy(this.enter,this));this.$element.on(p+"."+this.type,this.options.selector,f.proxy(this.leave,this))}}}this.options.selector?(this._options=f.extend({},this.options,{trigger:"manual",selector:""})):this.fixTitle()};d.prototype.getDefaults=function(){return d.DEFAULTS};d.prototype.getOptions=function(a){a=f.extend({},this.getDefaults(),this.$element.data(),a);if(a.delay&&typeof a.delay=="number"){a.delay={show:a.delay,hide:a.delay}}return a};d.prototype.getDelegateOptions=function(){var b={};var a=this.getDefaults();this._options&&f.each(this._options,function(h,c){if(a[h]!=c){b[h]=c}});return b};d.prototype.enter=function(a){var b=a instanceof this.constructor?a:f(a.currentTarget)[this.type](this.getDelegateOptions()).data("bs."+this.type);clearTimeout(b.timeout);b.hoverState="in";if(!b.options.delay||!b.options.delay.show){return b.show()}b.timeout=setTimeout(function(){if(b.hoverState=="in"){b.show()}},b.options.delay.show)};d.prototype.leave=function(a){var b=a instanceof this.constructor?a:f(a.currentTarget)[this.type](this.getDelegateOptions()).data("bs."+this.type);clearTimeout(b.timeout);b.hoverState="out";if(!b.options.delay||!b.options.delay.hide){return b.hide()}b.timeout=setTimeout(function(){if(b.hoverState=="out"){b.hide()}},b.options.delay.hide)};d.prototype.show=function(){var F=f.Event("show.bs."+this.type);if(this.hasContent()&&this.enabled){this.$element.trigger(F);if(F.isDefaultPrevented()){return}var y=this;var E=this.tip();this.setContent();if(this.options.animation){E.addClass("fade")}var G=typeof this.options.placement=="function"?this.options.placement.call(this,E[0],this.$element[0]):this.options.placement;var C=/\s?auto?\s?/i;var v=C.test(G);if(v){G=G.replace(C,"")||"top"}E.detach().css({top:0,left:0,display:"block"}).addClass(G);this.options.container?E.appendTo(this.options.container):E.insertAfter(this.$element);var A=this.getPosition();var B=E[0].offsetWidth;var c=E[0].offsetHeight;if(v){var H=this.$element.parent();var a=G;var w=document.documentElement.scrollTop||document.body.scrollTop;var x=this.options.container=="body"?window.innerWidth:H.outerWidth();var b=this.options.container=="body"?window.innerHeight:H.outerHeight();var D=this.options.container=="body"?0:H.offset().left;G=G=="bottom"&&A.top+A.height+c-w>b?"top":G=="top"&&A.top-w-c<0?"bottom":G=="right"&&A.right+B>x?"left":G=="left"&&A.left-B<D?"right":G;E.removeClass(a).addClass(G)}var u=this.getCalculatedOffset(G,A,B,c);this.applyPlacement(u,G);this.hoverState=null;var z=function(){y.$element.trigger("shown.bs."+y.type)};f.support.transition&&this.$tip.hasClass("fade")?E.one(f.support.transition.end,z).emulateTransitionEnd(150):z()}};d.prototype.applyPlacement=function(r,q){var t;var p=this.tip();var u=p[0].offsetWidth;var b=p[0].offsetHeight;var v=parseInt(p.css("margin-top"),10);var s=parseInt(p.css("margin-left"),10);if(isNaN(v)){v=0}if(isNaN(s)){s=0}r.top=r.top+v;r.left=r.left+s;f.offset.setOffset(p[0],f.extend({using:function(g){p.css({top:Math.round(g.top),left:Math.round(g.left)})}},r),0);p.addClass("in");var a=p[0].offsetWidth;var o=p[0].offsetHeight;if(q=="top"&&o!=b){t=true;r.top=r.top+b-o}if(/bottom|top/.test(q)){var c=0;if(r.left<0){c=r.left*-2;r.left=0;p.offset(r);a=p[0].offsetWidth;o=p[0].offsetHeight}this.replaceArrow(c-u+a,a,"left")}else{this.replaceArrow(o-b,o,"top")}if(t){p.offset(r)}};d.prototype.replaceArrow=function(a,b,c){this.arrow().css(c,a?(50*(1-a/b)+"%"):"")};d.prototype.setContent=function(){var a=this.tip();var b=this.getTitle();a.find(".tooltip-inner")[this.options.html?"html":"text"](b);a.removeClass("fade in top bottom left right")};d.prototype.hide=function(){var a=this;var c=this.tip();var h=f.Event("hide.bs."+this.type);function b(){if(a.hoverState!="in"){c.detach()}a.$element.trigger("hidden.bs."+a.type)}this.$element.trigger(h);if(h.isDefaultPrevented()){return}c.removeClass("in");f.support.transition&&this.$tip.hasClass("fade")?c.one(f.support.transition.end,b).emulateTransitionEnd(150):b();this.hoverState=null;return this};d.prototype.fixTitle=function(){var a=this.$element;if(a.attr("title")||typeof(a.attr("data-original-title"))!="string"){a.attr("data-original-title",a.attr("title")||"").attr("title","")}};d.prototype.hasContent=function(){return this.getTitle()};d.prototype.getPosition=function(){var a=this.$element[0];return f.extend({},(typeof a.getBoundingClientRect=="function")?a.getBoundingClientRect():{width:a.offsetWidth,height:a.offsetHeight},this.$element.offset())};d.prototype.getCalculatedOffset=function(b,c,a,h){return b=="bottom"?{top:c.top+c.height,left:c.left+c.width/2-a/2}:b=="top"?{top:c.top-h,left:c.left+c.width/2-a/2}:b=="left"?{top:c.top+c.height/2-h/2,left:c.left-a}:{top:c.top+c.height/2-h/2,left:c.left+c.width}};d.prototype.getTitle=function(){var a;var c=this.$element;var b=this.options;a=c.attr("data-original-title")||(typeof b.title=="function"?b.title.call(c[0]):b.title);return a};d.prototype.tip=function(){return this.$tip=this.$tip||f(this.options.template)};d.prototype.arrow=function(){return this.$arrow=this.$arrow||this.tip().find(".tooltip-arrow")};d.prototype.validate=function(){if(!this.$element[0].parentNode){this.hide();this.$element=null;this.options=null}};d.prototype.enable=function(){this.enabled=true};d.prototype.disable=function(){this.enabled=false};d.prototype.toggleEnabled=function(){this.enabled=!this.enabled};d.prototype.toggle=function(a){var b=a?f(a.currentTarget)[this.type](this.getDelegateOptions()).data("bs."+this.type):this;b.tip().hasClass("in")?b.leave(b):b.enter(b)};d.prototype.destroy=function(){clearTimeout(this.timeout);this.hide().$element.off("."+this.type).removeData("bs."+this.type)};var e=f.fn.tooltip;f.fn.tooltip=function(a){return this.each(function(){var b=f(this);var c=b.data("bs.tooltip");var h=typeof a=="object"&&a;if(!c&&a=="destroy"){return}if(!c){b.data("bs.tooltip",(c=new d(this,h)))}if(typeof a=="string"){c[a]()}})};f.fn.tooltip.Constructor=d;f.fn.tooltip.noConflict=function(){f.fn.tooltip=e;return this}}(jQuery);+function(f){var d=function(a,b){this.init("popover",a,b)};if(!f.fn.tooltip){throw new Error("Popover requires tooltip.js")}d.DEFAULTS=f.extend({},f.fn.tooltip.Constructor.DEFAULTS,{placement:"right",trigger:"click",content:"",template:'<div class="popover"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>'});d.prototype=f.extend({},f.fn.tooltip.Constructor.prototype);d.prototype.constructor=d;d.prototype.getDefaults=function(){return d.DEFAULTS};d.prototype.setContent=function(){var a=this.tip();var b=this.getTitle();var c=this.getContent();a.find(".popover-title")[this.options.html?"html":"text"](b);a.find(".popover-content")[this.options.html?(typeof c=="string"?"html":"append"):"text"](c);a.removeClass("fade top bottom left right in");if(!a.find(".popover-title").html()){a.find(".popover-title").hide()}};d.prototype.hasContent=function(){return this.getTitle()||this.getContent()};d.prototype.getContent=function(){var b=this.$element;var a=this.options;return b.attr("data-content")||(typeof a.content=="function"?a.content.call(b[0]):a.content)};d.prototype.arrow=function(){return this.$arrow=this.$arrow||this.tip().find(".arrow")};d.prototype.tip=function(){if(!this.$tip){this.$tip=f(this.options.template)}return this.$tip};var e=f.fn.popover;f.fn.popover=function(a){return this.each(function(){var b=f(this);var c=b.data("bs.popover");var h=typeof a=="object"&&a;if(!c&&a=="destroy"){return}if(!c){b.data("bs.popover",(c=new d(this,h)))}if(typeof a=="string"){c[a]()}})};f.fn.popover.Constructor=d;f.fn.popover.noConflict=function(){f.fn.popover=e;return this}}(jQuery);+function(f){function d(h,a){var b;var c=f.proxy(this.process,this);this.$element=f(h).is("body")?f(window):f(h);this.$body=f("body");this.$scrollElement=this.$element.on("scroll.bs.scroll-spy.data-api",c);this.options=f.extend({},d.DEFAULTS,a);this.selector=(this.options.target||((b=f(h).attr("href"))&&b.replace(/.*(?=#[^\s]+$)/,""))||"")+" .nav li > a";this.offsets=f([]);this.targets=f([]);this.activeTarget=null;this.refresh();this.process()}d.DEFAULTS={offset:10};d.prototype.refresh=function(){var c=this.$element[0]==window?"offset":"position";this.offsets=f([]);this.targets=f([]);var b=this;var a=this.$body.find(this.selector).map(function(){var k=f(this);var l=k.data("target")||k.attr("href");var j=/^#./.test(l)&&f(l);return(j&&j.length&&j.is(":visible")&&[[j[c]().top+(!f.isWindow(b.$scrollElement.get(0))&&b.$scrollElement.scrollTop()),l]])||null}).sort(function(i,j){return i[0]-j[0]}).each(function(){b.offsets.push(this[0]);b.targets.push(this[1])})};d.prototype.process=function(){var m=this.$scrollElement.scrollTop()+this.options.offset;var a=this.$scrollElement[0].scrollHeight||this.$body[0].scrollHeight;var c=a-this.$scrollElement.height();var i=this.offsets;var b=this.targets;var l=this.activeTarget;var n;if(m>=c){return l!=(n=b.last()[0])&&this.activate(n)}if(l&&m<=i[0]){return l!=(n=b[0])&&this.activate(n)}for(n=i.length;n--;){l!=b[n]&&m>=i[n]&&(!i[n+1]||m<=i[n+1])&&this.activate(b[n])}};d.prototype.activate=function(a){this.activeTarget=a;f(this.selector).parentsUntil(this.options.target,".active").removeClass("active");var c=this.selector+'[data-target="'+a+'"],'+this.selector+'[href="'+a+'"]';var b=f(c).parents("li").addClass("active");if(b.parent(".dropdown-menu").length){b=b.closest("li.dropdown").addClass("active")}b.trigger("activate.bs.scrollspy")};var e=f.fn.scrollspy;f.fn.scrollspy=function(a){return this.each(function(){var b=f(this);var c=b.data("bs.scrollspy");var h=typeof a=="object"&&a;if(!c){b.data("bs.scrollspy",(c=new d(this,h)))}if(typeof a=="string"){c[a]()}})};f.fn.scrollspy.Constructor=d;f.fn.scrollspy.noConflict=function(){f.fn.scrollspy=e;return this};f(window).on("load",function(){f('[data-spy="scroll"]').each(function(){var a=f(this);a.scrollspy(a.data())})})}(jQuery);+function(f){var d=function(a){this.element=f(a)};d.prototype.show=function(){var j=this.element;var k=j.closest("ul:not(.dropdown-menu)");var l=j.data("target");if(!l){l=j.attr("href");l=l&&l.replace(/.*(?=#[^\s]*$)/,"")}if(j.parent("li").hasClass("active")){return}var b=k.find(".active:last a")[0];var a=f.Event("show.bs.tab",{relatedTarget:b});j.trigger(a);if(a.isDefaultPrevented()){return}var c=f(l);this.activate(j.parent("li"),k);this.activate(c,c.parent(),function(){j.trigger({type:"shown.bs.tab",relatedTarget:b})})};d.prototype.activate=function(j,k,l){var a=k.find("> .active");var b=l&&f.support.transition&&a.hasClass("fade");function c(){a.removeClass("active").find("> .dropdown-menu > .active").removeClass("active");j.addClass("active");if(b){j[0].offsetWidth;j.addClass("in")}else{j.removeClass("fade")}if(j.parent(".dropdown-menu")){j.closest("li.dropdown").addClass("active")}l&&l()}b?a.one(f.support.transition.end,c).emulateTransitionEnd(150):c();a.removeClass("in")};var e=f.fn.tab;f.fn.tab=function(a){return this.each(function(){var c=f(this);var b=c.data("bs.tab");if(!b){c.data("bs.tab",(b=new d(this)))}if(typeof a=="string"){b[a]()}})};f.fn.tab.Constructor=d;f.fn.tab.noConflict=function(){f.fn.tab=e;return this};f(document).on("click.bs.tab.data-api",'[data-toggle="tab"], [data-toggle="pill"]',function(a){a.preventDefault();f(this).tab("show")})}(jQuery);+function(f){var d=function(a,b){this.options=f.extend({},d.DEFAULTS,b);this.$window=f(window).on("scroll.bs.affix.data-api",f.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",f.proxy(this.checkPositionWithEventLoop,this));this.$element=f(a);this.affixed=this.unpin=this.pinnedOffset=null;this.checkPosition()};d.RESET="affix affix-top affix-bottom";d.DEFAULTS={offset:0};d.prototype.getPinnedOffset=function(){if(this.pinnedOffset){return this.pinnedOffset}this.$element.removeClass(d.RESET).addClass("affix");var a=this.$window.scrollTop();var b=this.$element.offset();return(this.pinnedOffset=b.top-a)};d.prototype.checkPositionWithEventLoop=function(){setTimeout(f.proxy(this.checkPosition,this),1)};d.prototype.checkPosition=function(){if(!this.$element.is(":visible")){return}var b=f(document).height();var a=this.$window.scrollTop();var n=this.$element.offset();var p=this.options.offset;var r=p.top;var q=p.bottom;if(this.affixed=="top"){n.top+=a}if(typeof p!="object"){q=r=p}if(typeof r=="function"){r=p.top(this.$element)}if(typeof q=="function"){q=p.bottom(this.$element)}var o=this.unpin!=null&&(a+this.unpin<=n.top)?false:q!=null&&(n.top+this.$element.height()>=b-q)?"bottom":r!=null&&(a<=r)?"top":false;if(this.affixed===o){return}if(this.unpin){this.$element.css("top","")}var c="affix"+(o?"-"+o:"");var m=f.Event(c+".bs.affix");this.$element.trigger(m);if(m.isDefaultPrevented()){return}this.affixed=o;this.unpin=o=="bottom"?this.getPinnedOffset():null;this.$element.removeClass(d.RESET).addClass(c).trigger(f.Event(c.replace("affix","affixed")));if(o=="bottom"){this.$element.offset({top:b-q-this.$element.height()})}};var e=f.fn.affix;f.fn.affix=function(a){return this.each(function(){var b=f(this);var c=b.data("bs.affix");var h=typeof a=="object"&&a;if(!c){b.data("bs.affix",(c=new d(this,h)))}if(typeof a=="string"){c[a]()}})};f.fn.affix.Constructor=d;f.fn.affix.noConflict=function(){f.fn.affix=e;return this};f(window).on("load",function(){f('[data-spy="affix"]').each(function(){var a=f(this);var b=a.data();b.offset=b.offset||{};if(b.offsetBottom){b.offset.bottom=b.offsetBottom}if(b.offsetTop){b.offset.top=b.offsetTop}a.affix(b)})})}(jQuery);(function(b){b.flexslider=function(F,A){var z=b(F);z.vars=b.extend({},b.flexslider.defaults,A);var x=z.vars.namespace,a=window.navigator&&window.navigator.msPointerEnabled&&window.MSGesture,w=(("ontouchstart" in window)||a||window.DocumentTouch&&document instanceof DocumentTouch)&&z.vars.touch,E="click touchend MSPointerUp",y="",r,B=z.vars.direction==="vertical",v=z.vars.reverse,s=(z.vars.itemWidth>0),C=z.vars.animation==="fade",u=z.vars.asNavFor!=="",D={},t=true;b.data(F,"flexslider",z);D={init:function(){z.animating=false;z.currentSlide=parseInt((z.vars.startAt?z.vars.startAt:0),10);if(isNaN(z.currentSlide)){z.currentSlide=0}z.animatingTo=z.currentSlide;z.atEnd=(z.currentSlide===0||z.currentSlide===z.last);z.containerSelector=z.vars.selector.substr(0,z.vars.selector.search(" "));z.slides=b(z.vars.selector,z);z.container=b(z.containerSelector,z);z.count=z.slides.length;z.syncExists=b(z.vars.sync).length>0;if(z.vars.animation==="slide"){z.vars.animation="swing"}z.prop=(B)?"top":"marginLeft";z.args={};z.manualPause=false;z.stopped=false;z.started=false;z.startTimeout=null;z.transitions=!z.vars.video&&!C&&z.vars.useCSS&&(function(){var c=document.createElement("div"),d=["perspectiveProperty","WebkitPerspective","MozPerspective","OPerspective","msPerspective"];for(var e in d){if(c.style[d[e]]!==undefined){z.pfx=d[e].replace("Perspective","").toLowerCase();z.prop="-"+z.pfx+"-transform";return true}}return false}());z.ensureAnimationEnd="";if(z.vars.controlsContainer!==""){z.controlsContainer=b(z.vars.controlsContainer).length>0&&b(z.vars.controlsContainer)}if(z.vars.manualControls!==""){z.manualControls=b(z.vars.manualControls).length>0&&b(z.vars.manualControls)}if(z.vars.randomize){z.slides.sort(function(){return(Math.round(Math.random())-0.5)});z.container.empty().append(z.slides)}z.doMath();z.setup("init");if(z.vars.controlNav){D.controlNav.setup()}if(z.vars.directionNav){D.directionNav.setup()}if(z.vars.keyboard&&(b(z.containerSelector).length===1||z.vars.multipleKeyboard)){b(document).bind("keyup",function(d){var e=d.keyCode;if(!z.animating&&(e===39||e===37)){var c=(e===39)?z.getTarget("next"):(e===37)?z.getTarget("prev"):false;z.flexAnimate(c,z.vars.pauseOnAction)}})}if(z.vars.mousewheel){z.bind("mousewheel",function(e,c,f,g){e.preventDefault();var d=(c<0)?z.getTarget("next"):z.getTarget("prev");z.flexAnimate(d,z.vars.pauseOnAction)})}if(z.vars.pausePlay){D.pausePlay.setup()}if(z.vars.slideshow&&z.vars.pauseInvisible){D.pauseInvisible.init()}if(z.vars.slideshow){if(z.vars.pauseOnHover){z.hover(function(){if(!z.manualPlay&&!z.manualPause){z.pause()}},function(){if(!z.manualPause&&!z.manualPlay&&!z.stopped){z.play()}})}if(!z.vars.pauseInvisible||!D.pauseInvisible.isHidden()){(z.vars.initDelay>0)?z.startTimeout=setTimeout(z.play,z.vars.initDelay):z.play()}}if(u){D.asNav.setup()}if(w&&z.vars.touch){D.touch()}if(!C||(C&&z.vars.smoothHeight)){b(window).bind("resize orientationchange focus",D.resize)}z.find("img").attr("draggable","false");setTimeout(function(){z.vars.start(z)},200)},asNav:{setup:function(){z.asNav=true;z.animatingTo=Math.floor(z.currentSlide/z.move);z.currentItem=z.currentSlide;z.slides.removeClass(x+"active-slide").eq(z.currentItem).addClass(x+"active-slide");if(!a){z.slides.on(E,function(d){d.preventDefault();var e=b(this),f=e.index();var c=e.offset().left-b(z).scrollLeft();if(c<=0&&e.hasClass(x+"active-slide")){z.flexAnimate(z.getTarget("prev"),true)}else{if(!b(z.vars.asNavFor).data("flexslider").animating&&!e.hasClass(x+"active-slide")){z.direction=(z.currentItem<f)?"next":"prev";z.flexAnimate(f,z.vars.pauseOnAction,false,true,true)}}})}else{F._slider=z;z.slides.each(function(){var c=this;c._gesture=new MSGesture();c._gesture.target=c;c.addEventListener("MSPointerDown",function(d){d.preventDefault();if(d.currentTarget._gesture){d.currentTarget._gesture.addPointer(d.pointerId)}},false);c.addEventListener("MSGestureTap",function(d){d.preventDefault();var e=b(this),f=e.index();if(!b(z.vars.asNavFor).data("flexslider").animating&&!e.hasClass("active")){z.direction=(z.currentItem<f)?"next":"prev";z.flexAnimate(f,z.vars.pauseOnAction,false,true,true)}})})}}},controlNav:{setup:function(){if(!z.manualControls){D.controlNav.setupPaging()}else{D.controlNav.setupManual()}},setupPaging:function(){var e=(z.vars.controlNav==="thumbnails")?"control-thumbs":"control-paging",g=1,d,h;z.controlNavScaffold=b('<ol class="'+x+"control-nav "+x+e+'"></ol>');if(z.pagingCount>1){for(var f=0;f<z.pagingCount;f++){h=z.slides.eq(f);d=(z.vars.controlNav==="thumbnails")?'<img src="'+h.attr("data-thumb")+'"/>':"<a>"+g+"</a>";if("thumbnails"===z.vars.controlNav&&true===z.vars.thumbCaptions){var c=h.attr("data-thumbcaption");if(""!=c&&undefined!=c){d+='<span class="'+x+'caption">'+c+"</span>"}}z.controlNavScaffold.append("<li>"+d+"</li>");g++}}(z.controlsContainer)?b(z.controlsContainer).append(z.controlNavScaffold):z.append(z.controlNavScaffold);D.controlNav.set();D.controlNav.active();z.controlNavScaffold.delegate("a, img",E,function(i){i.preventDefault();if(y===""||y===i.type){var j=b(this),k=z.controlNav.index(j);if(!j.hasClass(x+"active")){z.direction=(k>z.currentSlide)?"next":"prev";z.flexAnimate(k,z.vars.pauseOnAction)}}if(y===""){y=i.type}D.setToClearWatchedEvent()})},setupManual:function(){z.controlNav=z.manualControls;D.controlNav.active();z.controlNav.bind(E,function(e){e.preventDefault();if(y===""||y===e.type){var c=b(this),d=z.controlNav.index(c);if(!c.hasClass(x+"active")){(d>z.currentSlide)?z.direction="next":z.direction="prev";z.flexAnimate(d,z.vars.pauseOnAction)}}if(y===""){y=e.type}D.setToClearWatchedEvent()})},set:function(){var c=(z.vars.controlNav==="thumbnails")?"img":"a";z.controlNav=b("."+x+"control-nav li "+c,(z.controlsContainer)?z.controlsContainer:z)},active:function(){z.controlNav.removeClass(x+"active").eq(z.animatingTo).addClass(x+"active")},update:function(d,c){if(z.pagingCount>1&&d==="add"){z.controlNavScaffold.append(b("<li><a>"+z.count+"</a></li>"))}else{if(z.pagingCount===1){z.controlNavScaffold.find("li").remove()}else{z.controlNav.eq(c).closest("li").remove()}}D.controlNav.set();(z.pagingCount>1&&z.pagingCount!==z.controlNav.length)?z.update(c,d):D.controlNav.active()}},directionNav:{setup:function(){var c=b('<ul class="'+x+'direction-nav"><li><a class="'+x+'prev" href="#">'+z.vars.prevText+'</a></li><li><a class="'+x+'next" href="#">'+z.vars.nextText+"</a></li></ul>");if(z.controlsContainer){b(z.controlsContainer).append(c);z.directionNav=b("."+x+"direction-nav li a",z.controlsContainer)}else{z.append(c);z.directionNav=b("."+x+"direction-nav li a",z)}D.directionNav.update();z.directionNav.bind(E,function(e){e.preventDefault();var d;if(y===""||y===e.type){d=(b(this).hasClass(x+"next"))?z.getTarget("next"):z.getTarget("prev");z.flexAnimate(d,z.vars.pauseOnAction)}if(y===""){y=e.type}D.setToClearWatchedEvent()})},update:function(){var c=x+"disabled";if(z.pagingCount===1){z.directionNav.addClass(c).attr("tabindex","-1")}else{if(!z.vars.animationLoop){if(z.animatingTo===0){z.directionNav.removeClass(c).filter("."+x+"prev").addClass(c).attr("tabindex","-1")}else{if(z.animatingTo===z.last){z.directionNav.removeClass(c).filter("."+x+"next").addClass(c).attr("tabindex","-1")}else{z.directionNav.removeClass(c).removeAttr("tabindex")}}}else{z.directionNav.removeClass(c).removeAttr("tabindex")}}}},pausePlay:{setup:function(){var c=b('<div class="'+x+'pauseplay"><a></a></div>');if(z.controlsContainer){z.controlsContainer.append(c);z.pausePlay=b("."+x+"pauseplay a",z.controlsContainer)}else{z.append(c);z.pausePlay=b("."+x+"pauseplay a",z)}D.pausePlay.update((z.vars.slideshow)?x+"pause":x+"play");z.pausePlay.bind(E,function(d){d.preventDefault();if(y===""||y===d.type){if(b(this).hasClass(x+"pause")){z.manualPause=true;z.manualPlay=false;z.pause()}else{z.manualPause=false;z.manualPlay=true;z.play()}}if(y===""){y=d.type}D.setToClearWatchedEvent()})},update:function(c){(c==="play")?z.pausePlay.removeClass(x+"pause").addClass(x+"play").html(z.vars.playText):z.pausePlay.removeClass(x+"play").addClass(x+"pause").html(z.vars.pauseText)}},touch:function(){var m,e,g,l,j,k,H=false,n=0,p=0,h=0;if(!a){F.addEventListener("touchstart",f,false);function f(G){if(z.animating){G.preventDefault()}else{if((window.navigator.msPointerEnabled)||G.touches.length===1){z.pause();l=(B)?z.h:z.w;k=Number(new Date());n=G.touches[0].pageX;p=G.touches[0].pageY;g=(s&&v&&z.animatingTo===z.last)?0:(s&&v)?z.limit-(((z.itemW+z.vars.itemMargin)*z.move)*z.animatingTo):(s&&z.currentSlide===z.last)?z.limit:(s)?((z.itemW+z.vars.itemMargin)*z.move)*z.currentSlide:(v)?(z.last-z.currentSlide+z.cloneOffset)*l:(z.currentSlide+z.cloneOffset)*l;m=(B)?p:n;e=(B)?n:p;F.addEventListener("touchmove",q,false);F.addEventListener("touchend",d,false)}}}function q(J){n=J.touches[0].pageX;p=J.touches[0].pageY;j=(B)?m-p:m-n;H=(B)?(Math.abs(j)<Math.abs(n-e)):(Math.abs(j)<Math.abs(p-e));var G=500;if(!H||Number(new Date())-k>G){J.preventDefault();if(!C&&z.transitions){if(!z.vars.animationLoop){j=j/((z.currentSlide===0&&j<0||z.currentSlide===z.last&&j>0)?(Math.abs(j)/l+2):1)}z.setProps(g+j,"setTouch")}}}function d(G){F.removeEventListener("touchmove",q,false);if(z.animatingTo===z.currentSlide&&!H&&!(j===null)){var K=(v)?-j:j,L=(K>0)?z.getTarget("next"):z.getTarget("prev");if(z.canAdvance(L)&&(Number(new Date())-k<550&&Math.abs(K)>50||Math.abs(K)>l/2)){z.flexAnimate(L,z.vars.pauseOnAction)}else{if(!C){z.flexAnimate(z.currentSlide,z.vars.pauseOnAction,true)}}}F.removeEventListener("touchend",d,false);m=null;e=null;j=null;g=null}}else{F.style.msTouchAction="none";F._gesture=new MSGesture();F._gesture.target=F;F.addEventListener("MSPointerDown",o,false);F._slider=z;F.addEventListener("MSGestureChange",c,false);F.addEventListener("MSGestureEnd",i,false);function o(G){G.stopPropagation();if(z.animating){G.preventDefault()}else{z.pause();F._gesture.addPointer(G.pointerId);h=0;l=(B)?z.h:z.w;k=Number(new Date());g=(s&&v&&z.animatingTo===z.last)?0:(s&&v)?z.limit-(((z.itemW+z.vars.itemMargin)*z.move)*z.animatingTo):(s&&z.currentSlide===z.last)?z.limit:(s)?((z.itemW+z.vars.itemMargin)*z.move)*z.currentSlide:(v)?(z.last-z.currentSlide+z.cloneOffset)*l:(z.currentSlide+z.cloneOffset)*l}}function c(M){M.stopPropagation();var N=M.target._slider;if(!N){return}var G=-M.translationX,L=-M.translationY;h=h+((B)?L:G);j=h;H=(B)?(Math.abs(h)<Math.abs(-G)):(Math.abs(h)<Math.abs(-L));if(M.detail===M.MSGESTURE_FLAG_INERTIA){setImmediate(function(){F._gesture.stop()});return}if(!H||Number(new Date())-k>500){M.preventDefault();if(!C&&N.transitions){if(!N.vars.animationLoop){j=h/((N.currentSlide===0&&h<0||N.currentSlide===N.last&&h>0)?(Math.abs(h)/l+2):1)}N.setProps(g+j,"setTouch")}}}function i(M){M.stopPropagation();var L=M.target._slider;if(!L){return}if(L.animatingTo===L.currentSlide&&!H&&!(j===null)){var N=(v)?-j:j,G=(N>0)?L.getTarget("next"):L.getTarget("prev");if(L.canAdvance(G)&&(Number(new Date())-k<550&&Math.abs(N)>50||Math.abs(N)>l/2)){L.flexAnimate(G,L.vars.pauseOnAction)}else{if(!C){L.flexAnimate(L.currentSlide,L.vars.pauseOnAction,true)}}}m=null;e=null;j=null;g=null;h=0}}},resize:function(){if(!z.animating&&z.is(":visible")){if(!s){z.doMath()}if(C){D.smoothHeight()}else{if(s){z.slides.width(z.computedW);z.update(z.pagingCount);z.setProps()}else{if(B){z.viewport.height(z.h);z.setProps(z.h,"setTotal")}else{if(z.vars.smoothHeight){D.smoothHeight()}z.newSlides.width(z.computedW);z.setProps(z.computedW,"setTotal")}}}}},smoothHeight:function(d){if(!B||C){var c=(C)?z:z.viewport;(d)?c.animate({height:z.slides.eq(z.animatingTo).height()},d):c.height(z.slides.eq(z.animatingTo).height())}},sync:function(e){var c=b(z.vars.sync).data("flexslider"),d=z.animatingTo;switch(e){case"animate":c.flexAnimate(d,z.vars.pauseOnAction,false,true);break;case"play":if(!c.playing&&!c.asNav){c.play()}break;case"pause":c.pause();break}},uniqueID:function(c){c.find("[id]").each(function(){var d=b(this);d.attr("id",d.attr("id")+"_clone")});return c},pauseInvisible:{visProp:null,init:function(){var c=["webkit","moz","ms","o"];if("hidden" in document){return"hidden"}for(var d=0;d<c.length;d++){if((c[d]+"Hidden") in document){D.pauseInvisible.visProp=c[d]+"Hidden"}}if(D.pauseInvisible.visProp){var e=D.pauseInvisible.visProp.replace(/[H|h]idden/,"")+"visibilitychange";document.addEventListener(e,function(){if(D.pauseInvisible.isHidden()){if(z.startTimeout){clearTimeout(z.startTimeout)}else{z.pause()}}else{if(z.started){z.play()}else{(z.vars.initDelay>0)?setTimeout(z.play,z.vars.initDelay):z.play()}}})}},isHidden:function(){return document[D.pauseInvisible.visProp]||false}},setToClearWatchedEvent:function(){clearTimeout(r);r=setTimeout(function(){y=""},3000)}};z.flexAnimate=function(h,g,d,l,k){if(!z.vars.animationLoop&&h!==z.currentSlide){z.direction=(h>z.currentSlide)?"next":"prev"}if(u&&z.pagingCount===1){z.direction=(z.currentItem<h)?"next":"prev"}if(!z.animating&&(z.canAdvance(h,k)||d)&&z.is(":visible")){if(u&&l){var e=b(z.vars.asNavFor).data("flexslider");z.atEnd=h===0||h===z.count-1;e.flexAnimate(h,true,false,true,k);z.direction=(z.currentItem<h)?"next":"prev";e.direction=z.direction;if(Math.ceil((h+1)/z.visible)-1!==z.currentSlide&&h!==0){z.currentItem=h;z.slides.removeClass(x+"active-slide").eq(h).addClass(x+"active-slide");h=Math.floor(h/z.visible)}else{z.currentItem=h;z.slides.removeClass(x+"active-slide").eq(h).addClass(x+"active-slide");return false}}z.animating=true;z.animatingTo=h;if(g){z.pause()}z.vars.before(z);if(z.syncExists&&!k){D.sync("animate")}if(z.vars.controlNav){D.controlNav.active()}if(!s){z.slides.removeClass(x+"active-slide").eq(h).addClass(x+"active-slide")}z.atEnd=h===0||h===z.last;if(z.vars.directionNav){D.directionNav.update()}if(h===z.last){z.vars.end(z);if(!z.vars.animationLoop){z.pause()}}if(!C){var i=(B)?z.slides.filter(":first").height():z.computedW,j,c,f;if(s){j=z.vars.itemMargin;f=((z.itemW+j)*z.move)*z.animatingTo;c=(f>z.limit&&z.visible!==1)?z.limit:f}else{if(z.currentSlide===0&&h===z.count-1&&z.vars.animationLoop&&z.direction!=="next"){c=(v)?(z.count+z.cloneOffset)*i:0}else{if(z.currentSlide===z.last&&h===0&&z.vars.animationLoop&&z.direction!=="prev"){c=(v)?0:(z.count+1)*i}else{c=(v)?((z.count-1)-h+z.cloneOffset)*i:(h+z.cloneOffset)*i}}}z.setProps(c,"",z.vars.animationSpeed);if(z.transitions){if(!z.vars.animationLoop||!z.atEnd){z.animating=false;z.currentSlide=z.animatingTo}z.container.unbind("webkitTransitionEnd transitionend");z.container.bind("webkitTransitionEnd transitionend",function(){clearTimeout(z.ensureAnimationEnd);z.wrapup(i)});clearTimeout(z.ensureAnimationEnd);z.ensureAnimationEnd=setTimeout(function(){z.wrapup(i)},z.vars.animationSpeed+100)}else{z.container.animate(z.args,z.vars.animationSpeed,z.vars.easing,function(){z.wrapup(i)})}}else{if(!w){z.slides.eq(z.currentSlide).css({zIndex:1}).animate({opacity:0},z.vars.animationSpeed,z.vars.easing);z.slides.eq(h).css({zIndex:2}).animate({opacity:1},z.vars.animationSpeed,z.vars.easing,z.wrapup)}else{z.slides.eq(z.currentSlide).css({opacity:0,zIndex:1});z.slides.eq(h).css({opacity:1,zIndex:2});z.wrapup(i)}}if(z.vars.smoothHeight){D.smoothHeight(z.vars.animationSpeed)}}};z.wrapup=function(c){if(!C&&!s){if(z.currentSlide===0&&z.animatingTo===z.last&&z.vars.animationLoop){z.setProps(c,"jumpEnd")}else{if(z.currentSlide===z.last&&z.animatingTo===0&&z.vars.animationLoop){z.setProps(c,"jumpStart")}}}z.animating=false;z.currentSlide=z.animatingTo;z.vars.after(z)};z.animateSlides=function(){if(!z.animating&&t){z.flexAnimate(z.getTarget("next"))}};z.pause=function(){clearInterval(z.animatedSlides);z.animatedSlides=null;z.playing=false;if(z.vars.pausePlay){D.pausePlay.update("play")}if(z.syncExists){D.sync("pause")}};z.play=function(){if(z.playing){clearInterval(z.animatedSlides)}z.animatedSlides=z.animatedSlides||setInterval(z.animateSlides,z.vars.slideshowSpeed);z.started=z.playing=true;if(z.vars.pausePlay){D.pausePlay.update("pause")}if(z.syncExists){D.sync("play")}};z.stop=function(){z.pause();z.stopped=true};z.canAdvance=function(c,e){var d=(u)?z.pagingCount-1:z.last;return(e)?true:(u&&z.currentItem===z.count-1&&c===0&&z.direction==="prev")?true:(u&&z.currentItem===0&&c===z.pagingCount-1&&z.direction!=="next")?false:(c===z.currentSlide&&!u)?false:(z.vars.animationLoop)?true:(z.atEnd&&z.currentSlide===0&&c===d&&z.direction!=="next")?false:(z.atEnd&&z.currentSlide===d&&c===0&&z.direction==="next")?false:true};z.getTarget=function(c){z.direction=c;if(c==="next"){return(z.currentSlide===z.last)?0:z.currentSlide+1}else{return(z.currentSlide===0)?z.last:z.currentSlide-1}};z.setProps=function(c,f,e){var d=(function(){var h=(c)?c:((z.itemW+z.vars.itemMargin)*z.move)*z.animatingTo,g=(function(){if(s){return(f==="setTouch")?c:(v&&z.animatingTo===z.last)?0:(v)?z.limit-(((z.itemW+z.vars.itemMargin)*z.move)*z.animatingTo):(z.animatingTo===z.last)?z.limit:h}else{switch(f){case"setTotal":return(v)?((z.count-1)-z.currentSlide+z.cloneOffset)*c:(z.currentSlide+z.cloneOffset)*c;case"setTouch":return(v)?c:c;case"jumpEnd":return(v)?c:z.count*c;case"jumpStart":return(v)?z.count*c:c;default:return c}}}());return(g*-1)+"px"}());if(z.transitions){d=(B)?"translate3d(0,"+d+",0)":"translate3d("+d+",0,0)";e=(e!==undefined)?(e/1000)+"s":"0s";z.container.css("-"+z.pfx+"-transition-duration",e);z.container.css("transition-duration",e)}z.args[z.prop]=d;if(z.transitions||e===undefined){z.container.css(z.args)}z.container.css("transform",d)};z.setup=function(d){if(!C){var c,e;if(d==="init"){z.viewport=b('<div class="'+x+'viewport"></div>').css({overflow:"hidden",position:"relative"}).appendTo(z).append(z.container);z.cloneCount=0;z.cloneOffset=0;if(v){e=b.makeArray(z.slides).reverse();z.slides=b(e);z.container.empty().append(z.slides)}}if(z.vars.animationLoop&&!s){z.cloneCount=2;z.cloneOffset=1;if(d!=="init"){z.container.find(".clone").remove()}D.uniqueID(z.slides.first().clone().addClass("clone").attr("aria-hidden","true")).appendTo(z.container);D.uniqueID(z.slides.last().clone().addClass("clone").attr("aria-hidden","true")).prependTo(z.container)}z.newSlides=b(z.vars.selector,z);c=(v)?z.count-1-z.currentSlide+z.cloneOffset:z.currentSlide+z.cloneOffset;if(B&&!s){z.container.height((z.count+z.cloneCount)*200+"%").css("position","absolute").width("100%");setTimeout(function(){z.newSlides.css({display:"block"});z.doMath();z.viewport.height(z.h);z.setProps(c*z.h,"init")},(d==="init")?100:0)}else{z.container.width((z.count+z.cloneCount)*200+"%");z.setProps(c*z.computedW,"init");setTimeout(function(){z.doMath();z.newSlides.css({width:z.computedW,"float":"left",display:"block"});if(z.vars.smoothHeight){D.smoothHeight()}},(d==="init")?100:0)}}else{z.slides.css({width:"100%","float":"left",marginRight:"-100%",position:"relative"});if(d==="init"){if(!w){z.slides.css({opacity:0,display:"block",zIndex:1}).eq(z.currentSlide).css({zIndex:2}).animate({opacity:1},z.vars.animationSpeed,z.vars.easing)}else{z.slides.css({opacity:0,display:"block",webkitTransition:"opacity "+z.vars.animationSpeed/1000+"s ease",zIndex:1}).eq(z.currentSlide).css({opacity:1,zIndex:2})}}if(z.vars.smoothHeight){D.smoothHeight()}}if(!s){z.slides.removeClass(x+"active-slide").eq(z.currentSlide).addClass(x+"active-slide")}z.vars.init(z)};z.doMath=function(){var f=z.slides.first(),c=z.vars.itemMargin,e=z.vars.minItems,d=z.vars.maxItems;z.w=(z.viewport===undefined)?z.width():z.viewport.width();z.h=f.height();z.boxPadding=f.outerWidth()-f.width();if(s){z.itemT=z.vars.itemWidth+c;z.minW=(e)?e*z.itemT:z.w;z.maxW=(d)?(d*z.itemT)-c:z.w;z.itemW=(z.minW>z.w)?(z.w-(c*(e-1)))/e:(z.maxW<z.w)?(z.w-(c*(d-1)))/d:(z.vars.itemWidth>z.w)?z.w:z.vars.itemWidth;z.visible=Math.floor(z.w/(z.itemW));z.move=(z.vars.move>0&&z.vars.move<z.visible)?z.vars.move:z.visible;z.pagingCount=Math.ceil(((z.count-z.visible)/z.move)+1);z.last=z.pagingCount-1;z.limit=(z.pagingCount===1)?0:(z.vars.itemWidth>z.w)?(z.itemW*(z.count-1))+(c*(z.count-1)):((z.itemW+c)*z.count)-z.w-c}else{z.itemW=z.w;z.pagingCount=z.count;z.last=z.count-1}z.computedW=z.itemW-z.boxPadding};z.update=function(c,d){z.doMath();if(!s){if(c<z.currentSlide){z.currentSlide+=1}else{if(c<=z.currentSlide&&c!==0){z.currentSlide-=1}}z.animatingTo=z.currentSlide}if(z.vars.controlNav&&!z.manualControls){if((d==="add"&&!s)||z.pagingCount>z.controlNav.length){D.controlNav.update("add")}else{if((d==="remove"&&!s)||z.pagingCount<z.controlNav.length){if(s&&z.currentSlide>z.last){z.currentSlide-=1;z.animatingTo-=1}D.controlNav.update("remove",z.last)}}}if(z.vars.directionNav){D.directionNav.update()}};z.addSlide=function(e,c){var d=b(e);z.count+=1;z.last=z.count-1;if(B&&v){(c!==undefined)?z.slides.eq(z.count-c).after(d):z.container.prepend(d)}else{(c!==undefined)?z.slides.eq(c).before(d):z.container.append(d)}z.update(c,"add");z.slides=b(z.vars.selector+":not(.clone)",z);z.setup();z.vars.added(z)};z.removeSlide=function(d){var c=(isNaN(d))?z.slides.index(b(d)):d;z.count-=1;z.last=z.count-1;if(isNaN(d)){b(d,z.slides).remove()}else{(B&&v)?z.slides.eq(z.last).remove():z.slides.eq(d).remove()}z.doMath();z.update(c,"remove");z.slides=b(z.vars.selector+":not(.clone)",z);z.setup();z.vars.removed(z)};D.init()};b(window).blur(function(a){focused=false}).focus(function(a){focused=true});b.flexslider.defaults={namespace:"flex-",selector:".slides > li",animation:"fade",easing:"swing",direction:"horizontal",reverse:false,animationLoop:true,smoothHeight:false,startAt:0,slideshow:true,slideshowSpeed:7000,animationSpeed:600,initDelay:0,randomize:false,thumbCaptions:false,pauseOnAction:true,pauseOnHover:false,pauseInvisible:true,useCSS:true,touch:true,video:false,controlNav:true,directionNav:true,prevText:"Previous",nextText:"Next",keyboard:true,multipleKeyboard:false,mousewheel:false,pausePlay:false,pauseText:"Pause",playText:"Play",controlsContainer:"",manualControls:"",sync:"",asNavFor:"",itemWidth:0,itemMargin:0,minItems:1,maxItems:0,move:0,allowOneSlide:true,start:function(){},before:function(){},after:function(){},end:function(){},added:function(){},removed:function(){},init:function(){}};b.fn.flexslider=function(a){if(a===undefined){a={}}if(typeof a==="object"){return this.each(function(){var c=b(this),h=(a.selector)?a.selector:".slides > li",g=c.find(h);if((g.length===1&&a.allowOneSlide===true)||g.length===0){g.fadeIn(400);if(a.start){a.start(c)}}else{if(c.data("flexslider")===undefined){new b.flexslider(this,a)}}})}else{var d=b(this).data("flexslider");switch(a){case"play":d.play();break;case"pause":d.pause();break;case"stop":d.stop();break;case"next":d.flexAnimate(d.getTarget("next"),true);break;case"prev":case"previous":d.flexAnimate(d.getTarget("prev"),true);break;default:if(typeof a==="number"){d.flexAnimate(a,true)}}}}})(jQuery);
/*!
 * Created by mario on 15/05/14.
 */
;$(window).load(function(){$(".flexslider-principal").flexslider({animation:"slide",slideshowSpeed:5000,startAt:0,slideshow:true});$(".flexslider-destaque").flexslider({animation:"slide",controlNav:"thumbnails",randomize:false,slideshow:false});$("#flexslider-detalhe-thumb").flexslider({animation:"slide",controlNav:false,animationLoop:false,slideshow:false,itemWidth:120,itemMargin:5,asNavFor:"#flexslider-detalhe"});$("#flexslider-detalhe").flexslider({animation:"slide",controlNav:false,animationLoop:false,slideshow:false,sync:"#flexslider-detalhe-thumb"})});
 ...
 * Licensed under MIT (https://github.com/twbs/bootstrap/blob/master/LICENSE)
 */
;if(typeof jQuery==="undefined"){throw new Error("Bootstrap's JavaScript requires jQuery")}+function(b){function a(){var d=document.createElement("bootstrap");var c={WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd otransitionend",transition:"transitionend"};for(var e in c){if(d.style[e]!==undefined){return{end:c[e]}}}return false}b.fn.emulateTransitionEnd=function(e){var d=false,c=this;b(this).one(b.support.transition.end,function(){d=true});var f=function(){if(!d){b(c).trigger(b.support.transition.end)}};setTimeout(f,e);return this};b(function(){b.support.transition=a()})}(jQuery);+function(d){var c='[data-dismiss="alert"]';var b=function(e){d(e).on("click",c,this.close)};b.prototype.close=function(g){var f=d(this);var i=f.attr("data-target");if(!i){i=f.attr("href");i=i&&i.replace(/.*(?=#[^\s]*$)/,"")}var e=d(i);if(g){g.preventDefault()}if(!e.length){e=f.hasClass("alert")?f:f.parent()}e.trigger(g=d.Event("close.bs.alert"));if(g.isDefaultPrevented()){return}e.removeClass("in");function h(){e.trigger("closed.bs.alert").remove()}d.support.transition&&e.hasClass("fade")?e.one(d.support.transition.end,h).emulateTransitionEnd(150):h()};var a=d.fn.alert;d.fn.alert=function(e){return this.each(function(){var g=d(this);var f=g.data("bs.alert");if(!f){g.data("bs.alert",(f=new b(this)))}if(typeof e=="string"){f[e].call(g)}})};d.fn.alert.Constructor=b;d.fn.alert.noConflict=function(){d.fn.alert=a;return this};d(document).on("click.bs.alert.data-api",c,b.prototype.close)}(jQuery);+function(a){var c=function(e,d){this.$element=a(e);this.options=a.extend({},c.DEFAULTS,d);this.isLoading=false};c.DEFAULTS={loadingText:"loading..."};c.prototype.setState=function(d){var f="disabled";var g=this.$element;var e=g.is("input")?"val":"html";var h=g.data();d=d+"Text";if(!h.resetText){g.data("resetText",g[e]())}g[e](h[d]||this.options[d]);setTimeout(a.proxy(function(){if(d=="loadingText"){this.isLoading=true;g.addClass(f).attr(f,f)}else{if(this.isLoading){this.isLoading=false;g.removeClass(f).removeAttr(f)}}},this),0)};c.prototype.toggle=function(){var d=true;var f=this.$element.closest('[data-toggle="buttons"]');if(f.length){var e=this.$element.find("input");if(e.prop("type")=="radio"){if(e.prop("checked")&&this.$element.hasClass("active")){d=false}else{f.find(".active").removeClass("active")}}if(d){e.prop("checked",!this.$element.hasClass("active")).trigger("change")}}if(d){this.$element.toggleClass("active")}};var b=a.fn.button;a.fn.button=function(d){return this.each(function(){var e=a(this);var g=e.data("bs.button");var f=typeof d=="object"&&d;if(!g){e.data("bs.button",(g=new c(this,f)))}if(d=="toggle"){g.toggle()}else{if(d){g.setState(d)}}})};a.fn.button.Constructor=c;a.fn.button.noConflict=function(){a.fn.button=b;return this};a(document).on("click.bs.button.data-api","[data-toggle^=button]",function(e){var d=a(e.target);if(!d.hasClass("btn")){d=d.closest(".btn")}d.button("toggle");e.preventDefault()})}(jQuery);+function(c){var a=function(e,d){this.$element=c(e);this.$indicators=this.$element.find(".carousel-indicators");this.options=d;this.paused=this.sliding=this.interval=this.$active=this.$items=null;this.options.pause=="hover"&&this.$element.on("mouseenter",c.proxy(this.pause,this)).on("mouseleave",c.proxy(this.cycle,this))};a.DEFAULTS={interval:5000,pause:"hover",wrap:true};a.prototype.cycle=function(d){d||(this.paused=false);this.interval&&clearInterval(this.interval);this.options.interval&&!this.paused&&(this.interval=setInterval(c.proxy(this.next,this),this.options.interval));return this};a.prototype.getActiveIndex=function(){this.$active=this.$element.find(".item.active");this.$items=this.$active.parent().children();return this.$items.index(this.$active)};a.prototype.to=function(e){var d=this;var f=this.getActiveIndex();if(e>(this.$items.length-1)||e<0){return}if(this.sliding){return this.$element.one("slid.bs.carousel",function(){d.to(e)})}if(f==e){return this.pause().cycle()}return this.slide(e>f?"next":"prev",c(this.$items[e]))};a.prototype.pause=function(d){d||(this.paused=true);if(this.$element.find(".next, .prev").length&&c.support.transition){this.$element.trigger(c.support.transition.end);this.cycle(true)}this.interval=clearInterval(this.interval);return this};a.prototype.next=function(){if(this.sliding){return}return this.slide("next")};a.prototype.prev=function(){if(this.sliding){return}return this.slide("prev")};a.prototype.slide=function(i,d){var k=this.$element.find(".item.active");var l=d||k[i]();var h=this.interval;var j=i=="next"?"left":"right";var e=i=="next"?"first":"last";var f=this;if(!l.length){if(!this.options.wrap){return}l=this.$element.find(".item")[e]()}if(l.hasClass("active")){return this.sliding=false}var g=c.Event("slide.bs.carousel",{relatedTarget:l[0],direction:j});this.$element.trigger(g);if(g.isDefaultPrevented()){return}this.sliding=true;h&&this.pause();if(this.$indicators.length){this.$indicators.find(".active").removeClass("active");this.$element.one("slid.bs.carousel",function(){var m=c(f.$indicators.children()[f.getActiveIndex()]);m&&m.addClass("active")})}if(c.support.transition&&this.$element.hasClass("slide")){l.addClass(i);l[0].offsetWidth;k.addClass(j);l.addClass(j);k.one(c.support.transition.end,function(){l.removeClass([i,j].join(" ")).addClass("active");k.removeClass(["active",j].join(" "));f.sliding=false;setTimeout(function(){f.$element.trigger("slid.bs.carousel")},0)}).emulateTransitionEnd(k.css("transition-duration").slice(0,-1)*1000)}else{k.removeClass("active");l.addClass("active");this.sliding=false;this.$element.trigger("slid.bs.carousel")}h&&this.cycle();return this};var b=c.fn.carousel;c.fn.carousel=function(d){return this.each(function(){var h=c(this);var g=h.data("bs.carousel");var e=c.extend({},a.DEFAULTS,h.data(),typeof d=="object"&&d);var f=typeof d=="string"?d:e.slide;if(!g){h.data("bs.carousel",(g=new a(this,e)))}if(typeof d=="number"){g.to(d)}else{if(f){g[f]()}else{if(e.interval){g.pause().cycle()}}}})};c.fn.carousel.Constructor=a;c.fn.carousel.noConflict=function(){c.fn.carousel=b;return this};c(document).on("click.bs.carousel.data-api","[data-slide], [data-slide-to]",function(h){var f=c(this),e;var d=c(f.attr("data-target")||(e=f.attr("href"))&&e.replace(/.*(?=#[^\s]+$)/,""));var g=c.extend({},d.data(),f.data());var i=f.attr("data-slide-to");if(i){g.interval=false}d.carousel(g);if(i=f.attr("data-slide-to")){d.data("bs.carousel").to(i)}h.preventDefault()});c(window).on("load",function(){c('[data-ride="carousel"]').each(function(){var d=c(this);d.carousel(d.data())})})}(jQuery);+function(c){var a=function(e,d){this.$element=c(e);this.options=c.extend({},a.DEFAULTS,d);this.transitioning=null;if(this.options.parent){this.$parent=c(this.options.parent)}if(this.options.toggle){this.toggle()}};a.DEFAULTS={toggle:true};a.prototype.dimension=function(){var d=this.$element.hasClass("width");return d?"width":"height"};a.prototype.show=function(){if(this.transitioning||this.$element.hasClass("in")){return}var h=c.Event("show.bs.collapse");this.$element.trigger(h);if(h.isDefaultPrevented()){return}var d=this.$parent&&this.$parent.find("> .panel > .in");if(d&&d.length){var g=d.data("bs.collapse");if(g&&g.transitioning){return}d.collapse("hide");g||d.data("bs.collapse",null)}var f=this.dimension();this.$element.removeClass("collapse").addClass("collapsing")[f](0);this.transitioning=1;var e=function(){this.$element.removeClass("collapsing").addClass("collapse in")[f]("auto");this.transitioning=0;this.$element.trigger("shown.bs.collapse")};if(!c.support.transition){return e.call(this)}var i=c.camelCase(["scroll",f].join("-"));this.$element.one(c.support.transition.end,c.proxy(e,this)).emulateTransitionEnd(350)[f](this.$element[0][i])};a.prototype.hide=function(){if(this.transitioning||!this.$element.hasClass("in")){return}var d=c.Event("hide.bs.collapse");this.$element.trigger(d);if(d.isDefaultPrevented()){return}var e=this.dimension();this.$element[e](this.$element[e]())[0].offsetHeight;this.$element.addClass("collapsing").removeClass("collapse").removeClass("in");this.transitioning=1;var f=function(){this.transitioning=0;this.$element.trigger("hidden.bs.collapse").removeClass("collapsing").addClass("collapse")};if(!c.support.transition){return f.call(this)}this.$element[e](0).one(c.support.transition.end,c.proxy(f,this)).emulateTransitionEnd(350)};a.prototype.toggle=function(){this[this.$element.hasClass("in")?"hide":"show"]()};var b=c.fn.collapse;c.fn.collapse=function(d){return this.each(function(){var e=c(this);var g=e.data("bs.collapse");var f=c.extend({},a.DEFAULTS,e.data(),typeof d=="object"&&d);if(!g&&f.toggle&&d=="show"){d=!d}if(!g){e.data("bs.collapse",(g=new a(this,f)))}if(typeof d=="string"){g[d]()}})};c.fn.collapse.Constructor=a;c.fn.collapse.noConflict=function(){c.fn.collapse=b;return this};c(document).on("click.bs.collapse.data-api","[data-toggle=collapse]",function(h){var j=c(this),l;var i=j.attr("data-target")||h.preventDefault()||(l=j.attr("href"))&&l.replace(/.*(?=#[^\s]+$)/,"");var d=c(i);var f=d.data("bs.collapse");var g=f?"toggle":j.data();var k=j.attr("data-parent");var e=k&&c(k);if(!f||!f.transitioning){if(e){e.find('[data-toggle=collapse][data-parent="'+k+'"]').not(j).addClass("collapsed")}j[d.hasClass("in")?"addClass":"removeClass"]("collapsed")}d.collapse(g)})}(jQuery);+function(b){var g=".dropdown-backdrop";var d="[data-toggle=dropdown]";var c=function(h){b(h).on("click.bs.dropdown",this.toggle)};c.prototype.toggle=function(j){var i=b(this);if(i.is(".disabled, :disabled")){return}var h=a(i);var l=h.hasClass("open");f();if(!l){if("ontouchstart" in document.documentElement&&!h.closest(".navbar-nav").length){b('<div class="dropdown-backdrop"/>').insertAfter(b(this)).on("click",f)}var k={relatedTarget:this};h.trigger(j=b.Event("show.bs.dropdown",k));if(j.isDefaultPrevented()){return}h.toggleClass("open").trigger("shown.bs.dropdown",k);i.focus()}return false};c.prototype.keydown=function(j){if(!/(38|40|27)/.test(j.keyCode)){return}var i=b(this);j.preventDefault();j.stopPropagation();if(i.is(".disabled, :disabled")){return}var h=a(i);var n=h.hasClass("open");if(!n||(n&&j.keyCode==27)){if(j.which==27){h.find(d).focus()}return i.click()}var k=" li:not(.divider):visible a";var l=h.find("[role=menu]"+k+", [role=listbox]"+k);if(!l.length){return}var m=l.index(l.filter(":focus"));if(j.keyCode==38&&m>0){m--}if(j.keyCode==40&&m<l.length-1){m++}if(!~m){m=0}l.eq(m).focus()};function f(h){b(g).remove();b(d).each(function(){var j=a(b(this));var i={relatedTarget:this};if(!j.hasClass("open")){return}j.trigger(h=b.Event("hide.bs.dropdown",i));if(h.isDefaultPrevented()){return}j.removeClass("open").trigger("hidden.bs.dropdown",i)})}function a(i){var j=i.attr("data-target");if(!j){j=i.attr("href");j=j&&/#[A-Za-z]/.test(j)&&j.replace(/.*(?=#[^\s]*$)/,"")}var h=j&&b(j);return h&&h.length?h:i.parent()}var e=b.fn.dropdown;b.fn.dropdown=function(h){return this.each(function(){var j=b(this);var i=j.data("bs.dropdown");if(!i){j.data("bs.dropdown",(i=new c(this)))}if(typeof h=="string"){i[h].call(j)}})};b.fn.dropdown.Constructor=c;b.fn.dropdown.noConflict=function(){b.fn.dropdown=e;return this};b(document).on("click.bs.dropdown.data-api",f).on("click.bs.dropdown.data-api",".dropdown form",function(h){h.stopPropagation()}).on("click.bs.dropdown.data-api",d,c.prototype.toggle).on("keydown.bs.dropdown.data-api",d+", [role=menu], [role=listbox]",c.prototype.keydown)}(jQuery);+function(a){var c=function(e,d){this.options=d;this.$element=a(e);this.$backdrop=this.isShown=null;if(this.options.remote){this.$element.find(".modal-content").load(this.options.remote,a.proxy(function(){this.$element.trigger("loaded.bs.modal")},this))}};c.DEFAULTS={backdrop:true,keyboard:true,show:true};c.prototype.toggle=function(d){return this[!this.isShown?"show":"hide"](d)};c.prototype.show=function(e){var f=this;var d=a.Event("show.bs.modal",{relatedTarget:e});this.$element.trigger(d);if(this.isShown||d.isDefaultPrevented()){return}this.isShown=true;this.escape();this.$element.on("click.dismiss.bs.modal",'[data-dismiss="modal"]',a.proxy(this.hide,this));this.backdrop(function(){var i=a.support.transition&&f.$element.hasClass("fade");if(!f.$element.parent().length){f.$element.appendTo(document.body)}f.$element.show().scrollTop(0);if(i){f.$element[0].offsetWidth}f.$element.addClass("in").attr("aria-hidden",false);f.enforceFocus();var h=a.Event("shown.bs.modal",{relatedTarget:e});i?f.$element.find(".modal-dialog").one(a.support.transition.end,function(){f.$element.focus().trigger(h)}).emulateTransitionEnd(300):f.$element.focus().trigger(h)})};c.prototype.hide=function(d){if(d){d.preventDefault()}d=a.Event("hide.bs.modal");this.$element.trigger(d);if(!this.isShown||d.isDefaultPrevented()){return}this.isShown=false;this.escape();a(document).off("focusin.bs.modal");this.$element.removeClass("in").attr("aria-hidden",true).off("click.dismiss.bs.modal");a.support.transition&&this.$element.hasClass("fade")?this.$element.one(a.support.transition.end,a.proxy(this.hideModal,this)).emulateTransitionEnd(300):this.hideModal()};c.prototype.enforceFocus=function(){a(document).off("focusin.bs.modal").on("focusin.bs.modal",a.proxy(function(d){if(this.$element[0]!==d.target&&!this.$element.has(d.target).length){this.$element.focus()}},this))};c.prototype.escape=function(){if(this.isShown&&this.options.keyboard){this.$element.on("keyup.dismiss.bs.modal",a.proxy(function(d){d.which==27&&this.hide()},this))}else{if(!this.isShown){this.$element.off("keyup.dismiss.bs.modal")}}};c.prototype.hideModal=function(){var d=this;this.$element.hide();this.backdrop(function(){d.removeBackdrop();d.$element.trigger("hidden.bs.modal")})};c.prototype.removeBackdrop=function(){this.$backdrop&&this.$backdrop.remove();this.$backdrop=null};c.prototype.backdrop=function(e){var d=this.$element.hasClass("fade")?"fade":"";if(this.isShown&&this.options.backdrop){var f=a.support.transition&&d;this.$backdrop=a('<div class="modal-backdrop '+d+'" />').appendTo(document.body);this.$element.on("click.dismiss.bs.modal",a.proxy(function(g){if(g.target!==g.currentTarget){return}this.options.backdrop=="static"?this.$element[0].focus.call(this.$element[0]):this.hide.call(this)},this));if(f){this.$backdrop[0].offsetWidth}this.$backdrop.addClass("in");if(!e){return}f?this.$backdrop.one(a.support.transition.end,e).emulateTransitionEnd(150):e()}else{if(!this.isShown&&this.$backdrop){this.$backdrop.removeClass("in");a.support.transition&&this.$element.hasClass("fade")?this.$backdrop.one(a.support.transition.end,e).emulateTransitionEnd(150):e()}else{if(e){e()}}}};var b=a.fn.modal;a.fn.modal=function(d,e){return this.each(function(){var h=a(this);var g=h.data("bs.modal");var f=a.extend({},c.DEFAULTS,h.data(),typeof d=="object"&&d);if(!g){h.data("bs.modal",(g=new c(this,f)))}if(typeof d=="string"){g[d](e)}else{if(f.show){g.show(e)}}})};a.fn.modal.Constructor=c;a.fn.modal.noConflict=function(){a.fn.modal=b;return this};a(document).on("click.bs.modal.data-api",'[data-toggle="modal"]',function(f){var e=a(this);var h=e.attr("href");var g=a(e.attr("data-target")||(h&&h.replace(/.*(?=#[^\s]+$)/,"")));var d=g.data("bs.modal")?"toggle":a.extend({remote:!/#/.test(h)&&h},g.data(),e.data());if(e.is("a")){f.preventDefault()}g.modal(d,this).one("hide",function(){e.is(":visible")&&e.focus()})});a(document).on("show.bs.modal",".modal",function(){a(document.body).addClass("modal-open")}).on("hidden.bs.modal",".modal",function(){a(document.body).removeClass("modal-open")})}(jQuery);+function(a){var c=function(e,d){this.type=this.options=this.enabled=this.timeout=this.hoverState=this.$element=null;this.init("tooltip",e,d)};c.DEFAULTS={animation:true,placement:"top",selector:false,template:'<div class="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',trigger:"hover focus",title:"",delay:0,html:false,container:false};c.prototype.init=function(f,l,e){this.enabled=true;this.type=f;this.$element=a(l);this.options=this.getOptions(e);var g=this.options.trigger.split(" ");for(var d=g.length;d--;){var k=g[d];if(k=="click"){this.$element.on("click."+this.type,this.options.selector,a.proxy(this.toggle,this))}else{if(k!="manual"){var j=k=="hover"?"mouseenter":"focusin";var h=k=="hover"?"mouseleave":"focusout";this.$element.on(j+"."+this.type,this.options.selector,a.proxy(this.enter,this));this.$element.on(h+"."+this.type,this.options.selector,a.proxy(this.leave,this))}}}this.options.selector?(this._options=a.extend({},this.options,{trigger:"manual",selector:""})):this.fixTitle()};c.prototype.getDefaults=function(){return c.DEFAULTS};c.prototype.getOptions=function(d){d=a.extend({},this.getDefaults(),this.$element.data(),d);if(d.delay&&typeof d.delay=="number"){d.delay={show:d.delay,hide:d.delay}}return d};c.prototype.getDelegateOptions=function(){var d={};var e=this.getDefaults();this._options&&a.each(this._options,function(f,g){if(e[f]!=g){d[f]=g}});return d};c.prototype.enter=function(e){var d=e instanceof this.constructor?e:a(e.currentTarget)[this.type](this.getDelegateOptions()).data("bs."+this.type);clearTimeout(d.timeout);d.hoverState="in";if(!d.options.delay||!d.options.delay.show){return d.show()}d.timeout=setTimeout(function(){if(d.hoverState=="in"){d.show()}},d.options.delay.show)};c.prototype.leave=function(e){var d=e instanceof this.constructor?e:a(e.currentTarget)[this.type](this.getDelegateOptions()).data("bs."+this.type);clearTimeout(d.timeout);d.hoverState="out";if(!d.options.delay||!d.options.delay.hide){return d.hide()}d.timeout=setTimeout(function(){if(d.hoverState=="out"){d.hide()}},d.options.delay.hide)};c.prototype.show=function(){var s=a.Event("show.bs."+this.type);if(this.hasContent()&&this.enabled){this.$element.trigger(s);if(s.isDefaultPrevented()){return}var k=this;var t=this.tip();this.setContent();if(this.options.animation){t.addClass("fade")}var r=typeof this.options.placement=="function"?this.options.placement.call(this,t[0],this.$element[0]):this.options.placement;var e=/\s?auto?\s?/i;var p=e.test(r);if(p){r=r.replace(e,"")||"top"}t.detach().css({top:0,left:0,display:"block"}).addClass(r);this.options.container?t.appendTo(this.options.container):t.insertAfter(this.$element);var g=this.getPosition();var f=t[0].offsetWidth;var i=t[0].offsetHeight;if(p){var o=this.$element.parent();var m=r;var n=document.documentElement.scrollTop||document.body.scrollTop;var l=this.options.container=="body"?window.innerWidth:o.outerWidth();var j=this.options.container=="body"?window.innerHeight:o.outerHeight();var d=this.options.container=="body"?0:o.offset().left;r=r=="bottom"&&g.top+g.height+i-n>j?"top":r=="top"&&g.top-n-i<0?"bottom":r=="right"&&g.right+f>l?"left":r=="left"&&g.left-f<d?"right":r;t.removeClass(m).addClass(r)}var q=this.getCalculatedOffset(r,g,f,i);this.applyPlacement(q,r);this.hoverState=null;var h=function(){k.$element.trigger("shown.bs."+k.type)};a.support.transition&&this.$tip.hasClass("fade")?t.one(a.support.transition.end,h).emulateTransitionEnd(150):h()}};c.prototype.applyPlacement=function(d,e){var m;var f=this.tip();var l=f[0].offsetWidth;var i=f[0].offsetHeight;var k=parseInt(f.css("margin-top"),10);var n=parseInt(f.css("margin-left"),10);if(isNaN(k)){k=0}if(isNaN(n)){n=0}d.top=d.top+k;d.left=d.left+n;a.offset.setOffset(f[0],a.extend({using:function(o){f.css({top:Math.round(o.top),left:Math.round(o.left)})}},d),0);f.addClass("in");var j=f[0].offsetWidth;var g=f[0].offsetHeight;if(e=="top"&&g!=i){m=true;d.top=d.top+i-g}if(/bottom|top/.test(e)){var h=0;if(d.left<0){h=d.left*-2;d.left=0;f.offset(d);j=f[0].offsetWidth;g=f[0].offsetHeight}this.replaceArrow(h-l+j,j,"left")}else{this.replaceArrow(g-i,g,"top")}if(m){f.offset(d)}};c.prototype.replaceArrow=function(e,d,f){this.arrow().css(f,e?(50*(1-e/d)+"%"):"")};c.prototype.setContent=function(){var e=this.tip();var d=this.getTitle();e.find(".tooltip-inner")[this.options.html?"html":"text"](d);e.removeClass("fade in top bottom left right")};c.prototype.hide=function(){var e=this;var g=this.tip();var f=a.Event("hide.bs."+this.type);function d(){if(e.hoverState!="in"){g.detach()}e.$element.trigger("hidden.bs."+e.type)}this.$element.trigger(f);if(f.isDefaultPrevented()){return}g.removeClass("in");a.support.transition&&this.$tip.hasClass("fade")?g.one(a.support.transition.end,d).emulateTransitionEnd(150):d();this.hoverState=null;return this};c.prototype.fixTitle=function(){var d=this.$element;if(d.attr("title")||typeof(d.attr("data-original-title"))!="string"){d.attr("data-original-title",d.attr("title")||"").attr("title","")}};c.prototype.hasContent=function(){return this.getTitle()};c.prototype.getPosition=function(){var d=this.$element[0];return a.extend({},(typeof d.getBoundingClientRect=="function")?d.getBoundingClientRect():{width:d.offsetWidth,height:d.offsetHeight},this.$element.offset())};c.prototype.getCalculatedOffset=function(d,g,e,f){return d=="bottom"?{top:g.top+g.height,left:g.left+g.width/2-e/2}:d=="top"?{top:g.top-f,left:g.left+g.width/2-e/2}:d=="left"?{top:g.top+g.height/2-f/2,left:g.left-e}:{top:g.top+g.height/2-f/2,left:g.left+g.width}};c.prototype.getTitle=function(){var e;var f=this.$element;var d=this.options;e=f.attr("data-original-title")||(typeof d.title=="function"?d.title.call(f[0]):d.title);return e};c.prototype.tip=function(){return this.$tip=this.$tip||a(this.options.template)};c.prototype.arrow=function(){return this.$arrow=this.$arrow||this.tip().find(".tooltip-arrow")};c.prototype.validate=function(){if(!this.$element[0].parentNode){this.hide();this.$element=null;this.options=null}};c.prototype.enable=function(){this.enabled=true};c.prototype.disable=function(){this.enabled=false};c.prototype.toggleEnabled=function(){this.enabled=!this.enabled};c.prototype.toggle=function(e){var d=e?a(e.currentTarget)[this.type](this.getDelegateOptions()).data("bs."+this.type):this;d.tip().hasClass("in")?d.leave(d):d.enter(d)};c.prototype.destroy=function(){clearTimeout(this.timeout);this.hide().$element.off("."+this.type).removeData("bs."+this.type)};var b=a.fn.tooltip;a.fn.tooltip=function(d){return this.each(function(){var e=a(this);var g=e.data("bs.tooltip");var f=typeof d=="object"&&d;if(!g&&d=="destroy"){return}if(!g){e.data("bs.tooltip",(g=new c(this,f)))}if(typeof d=="string"){g[d]()}})};a.fn.tooltip.Constructor=c;a.fn.tooltip.noConflict=function(){a.fn.tooltip=b;return this}}(jQuery);+function(a){var c=function(e,d){this.init("popover",e,d)};if(!a.fn.tooltip){throw new Error("Popover requires tooltip.js")}c.DEFAULTS=a.extend({},a.fn.tooltip.Constructor.DEFAULTS,{placement:"right",trigger:"click",content:"",template:'<div class="popover"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>'});c.prototype=a.extend({},a.fn.tooltip.Constructor.prototype);c.prototype.constructor=c;c.prototype.getDefaults=function(){return c.DEFAULTS};c.prototype.setContent=function(){var e=this.tip();var d=this.getTitle();var f=this.getContent();e.find(".popover-title")[this.options.html?"html":"text"](d);e.find(".popover-content")[this.options.html?(typeof f=="string"?"html":"append"):"text"](f);e.removeClass("fade top bottom left right in");if(!e.find(".popover-title").html()){e.find(".popover-title").hide()}};c.prototype.hasContent=function(){return this.getTitle()||this.getContent()};c.prototype.getContent=function(){var d=this.$element;var e=this.options;return d.attr("data-content")||(typeof e.content=="function"?e.content.call(d[0]):e.content)};c.prototype.arrow=function(){return this.$arrow=this.$arrow||this.tip().find(".arrow")};c.prototype.tip=function(){if(!this.$tip){this.$tip=a(this.options.template)}return this.$tip};var b=a.fn.popover;a.fn.popover=function(d){return this.each(function(){var e=a(this);var g=e.data("bs.popover");var f=typeof d=="object"&&d;if(!g&&d=="destroy"){return}if(!g){e.data("bs.popover",(g=new c(this,f)))}if(typeof d=="string"){g[d]()}})};a.fn.popover.Constructor=c;a.fn.popover.noConflict=function(){a.fn.popover=b;return this}}(jQuery);+function(a){function c(f,e){var d;var g=a.proxy(this.process,this);this.$element=a(f).is("body")?a(window):a(f);this.$body=a("body");this.$scrollElement=this.$element.on("scroll.bs.scroll-spy.data-api",g);this.options=a.extend({},c.DEFAULTS,e);this.selector=(this.options.target||((d=a(f).attr("href"))&&d.replace(/.*(?=#[^\s]+$)/,""))||"")+" .nav li > a";this.offsets=a([]);this.targets=a([]);this.activeTarget=null;this.refresh();this.process()}c.DEFAULTS={offset:10};c.prototype.refresh=function(){var f=this.$element[0]==window?"offset":"position";this.offsets=a([]);this.targets=a([]);var d=this;var e=this.$body.find(this.selector).map(function(){var h=a(this);var g=h.data("target")||h.attr("href");var i=/^#./.test(g)&&a(g);return(i&&i.length&&i.is(":visible")&&[[i[f]().top+(!a.isWindow(d.$scrollElement.get(0))&&d.$scrollElement.scrollTop()),g]])||null}).sort(function(h,g){return h[0]-g[0]}).each(function(){d.offsets.push(this[0]);d.targets.push(this[1])})};c.prototype.process=function(){var e=this.$scrollElement.scrollTop()+this.options.offset;var g=this.$scrollElement[0].scrollHeight||this.$body[0].scrollHeight;var k=g-this.$scrollElement.height();var h=this.offsets;var d=this.targets;var f=this.activeTarget;var j;if(e>=k){return f!=(j=d.last()[0])&&this.activate(j)}if(f&&e<=h[0]){return f!=(j=d[0])&&this.activate(j)}for(j=h.length;j--;){f!=d[j]&&e>=h[j]&&(!h[j+1]||e<=h[j+1])&&this.activate(d[j])}};c.prototype.activate=function(e){this.activeTarget=e;a(this.selector).parentsUntil(this.options.target,".active").removeClass("active");var f=this.selector+'[data-target="'+e+'"],'+this.selector+'[href="'+e+'"]';var d=a(f).parents("li").addClass("active");if(d.parent(".dropdown-menu").length){d=d.closest("li.dropdown").addClass("active")}d.trigger("activate.bs.scrollspy")};var b=a.fn.scrollspy;a.fn.scrollspy=function(d){return this.each(function(){var e=a(this);var g=e.data("bs.scrollspy");var f=typeof d=="object"&&d;if(!g){e.data("bs.scrollspy",(g=new c(this,f)))}if(typeof d=="string"){g[d]()}})};a.fn.scrollspy.Constructor=c;a.fn.scrollspy.noConflict=function(){a.fn.scrollspy=b;return this};a(window).on("load",function(){a('[data-spy="scroll"]').each(function(){var d=a(this);d.scrollspy(d.data())})})}(jQuery);+function(a){var c=function(d){this.element=a(d)};c.prototype.show=function(){var h=this.element;var g=h.closest("ul:not(.dropdown-menu)");var f=h.data("target");if(!f){f=h.attr("href");f=f&&f.replace(/.*(?=#[^\s]*$)/,"")}if(h.parent("li").hasClass("active")){return}var d=g.find(".active:last a")[0];var e=a.Event("show.bs.tab",{relatedTarget:d});h.trigger(e);if(e.isDefaultPrevented()){return}var i=a(f);this.activate(h.parent("li"),g);this.activate(i,i.parent(),function(){h.trigger({type:"shown.bs.tab",relatedTarget:d})})};c.prototype.activate=function(h,g,f){var e=g.find("> .active");var d=f&&a.support.transition&&e.hasClass("fade");function i(){e.removeClass("active").find("> .dropdown-menu > .active").removeClass("active");h.addClass("active");if(d){h[0].offsetWidth;h.addClass("in")}else{h.removeClass("fade")}if(h.parent(".dropdown-menu")){h.closest("li.dropdown").addClass("active")}f&&f()}d?e.one(a.support.transition.end,i).emulateTransitionEnd(150):i();e.removeClass("in")};var b=a.fn.tab;a.fn.tab=function(d){return this.each(function(){var f=a(this);var e=f.data("bs.tab");if(!e){f.data("bs.tab",(e=new c(this)))}if(typeof d=="string"){e[d]()}})};a.fn.tab.Constructor=c;a.fn.tab.noConflict=function(){a.fn.tab=b;return this};a(document).on("click.bs.tab.data-api",'[data-toggle="tab"], [data-toggle="pill"]',function(d){d.preventDefault();a(this).tab("show")})}(jQuery);+function(a){var c=function(e,d){this.options=a.extend({},c.DEFAULTS,d);this.$window=a(window).on("scroll.bs.affix.data-api",a.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",a.proxy(this.checkPositionWithEventLoop,this));this.$element=a(e);this.affixed=this.unpin=this.pinnedOffset=null;this.checkPosition()};c.RESET="affix affix-top affix-bottom";c.DEFAULTS={offset:0};c.prototype.getPinnedOffset=function(){if(this.pinnedOffset){return this.pinnedOffset}this.$element.removeClass(c.RESET).addClass("affix");var e=this.$window.scrollTop();var d=this.$element.offset();return(this.pinnedOffset=d.top-e)};c.prototype.checkPositionWithEventLoop=function(){setTimeout(a.proxy(this.checkPosition,this),1)};c.prototype.checkPosition=function(){if(!this.$element.is(":visible")){return}var k=a(document).height();var l=this.$window.scrollTop();var h=this.$element.offset();var f=this.options.offset;var d=f.top;var e=f.bottom;if(this.affixed=="top"){h.top+=l}if(typeof f!="object"){e=d=f}if(typeof d=="function"){d=f.top(this.$element)}if(typeof e=="function"){e=f.bottom(this.$element)}var g=this.unpin!=null&&(l+this.unpin<=h.top)?false:e!=null&&(h.top+this.$element.height()>=k-e)?"bottom":d!=null&&(l<=d)?"top":false;if(this.affixed===g){return}if(this.unpin){this.$element.css("top","")}var j="affix"+(g?"-"+g:"");var i=a.Event(j+".bs.affix");this.$element.trigger(i);if(i.isDefaultPrevented()){return}this.affixed=g;this.unpin=g=="bottom"?this.getPinnedOffset():null;this.$element.removeClass(c.RESET).addClass(j).trigger(a.Event(j.replace("affix","affixed")));if(g=="bottom"){this.$element.offset({top:k-e-this.$element.height()})}};var b=a.fn.affix;a.fn.affix=function(d){return this.each(function(){var e=a(this);var g=e.data("bs.affix");var f=typeof d=="object"&&d;if(!g){e.data("bs.affix",(g=new c(this,f)))}if(typeof d=="string"){g[d]()}})};a.fn.affix.Constructor=c;a.fn.affix.noConflict=function(){a.fn.affix=b;return this};a(window).on("load",function(){a('[data-spy="affix"]').each(function(){var e=a(this);var d=e.data();d.offset=d.offset||{};if(d.offsetBottom){d.offset.bottom=d.offsetBottom}if(d.offsetTop){d.offset.top=d.offsetTop}e.affix(d)})})}(jQuery);(function(a){a.flexslider=function(o,f){var g=a(o);g.vars=a.extend({},a.flexslider.defaults,f);var j=g.vars.namespace,i=window.navigator&&window.navigator.msPointerEnabled&&window.MSGesture,k=(("ontouchstart" in window)||i||window.DocumentTouch&&document instanceof DocumentTouch)&&g.vars.touch,q="click touchend MSPointerUp",h="",c,e=g.vars.direction==="vertical",l=g.vars.reverse,p=(g.vars.itemWidth>0),d=g.vars.animation==="fade",m=g.vars.asNavFor!=="",b={},n=true;a.data(o,"flexslider",g);b={init:function(){g.animating=false;g.currentSlide=parseInt((g.vars.startAt?g.vars.startAt:0),10);if(isNaN(g.currentSlide)){g.currentSlide=0}g.animatingTo=g.currentSlide;g.atEnd=(g.currentSlide===0||g.currentSlide===g.last);g.containerSelector=g.vars.selector.substr(0,g.vars.selector.search(" "));g.slides=a(g.vars.selector,g);g.container=a(g.containerSelector,g);g.count=g.slides.length;g.syncExists=a(g.vars.sync).length>0;if(g.vars.animation==="slide"){g.vars.animation="swing"}g.prop=(e)?"top":"marginLeft";g.args={};g.manualPause=false;g.stopped=false;g.started=false;g.startTimeout=null;g.transitions=!g.vars.video&&!d&&g.vars.useCSS&&(function(){var t=document.createElement("div"),s=["perspectiveProperty","WebkitPerspective","MozPerspective","OPerspective","msPerspective"];for(var r in s){if(t.style[s[r]]!==undefined){g.pfx=s[r].replace("Perspective","").toLowerCase();g.prop="-"+g.pfx+"-transform";return true}}return false}());g.ensureAnimationEnd="";if(g.vars.controlsContainer!==""){g.controlsContainer=a(g.vars.controlsContainer).length>0&&a(g.vars.controlsContainer)}if(g.vars.manualControls!==""){g.manualControls=a(g.vars.manualControls).length>0&&a(g.vars.manualControls)}if(g.vars.randomize){g.slides.sort(function(){return(Math.round(Math.random())-0.5)});g.container.empty().append(g.slides)}g.doMath();g.setup("init");if(g.vars.controlNav){b.controlNav.setup()}if(g.vars.directionNav){b.directionNav.setup()}if(g.vars.keyboard&&(a(g.containerSelector).length===1||g.vars.multipleKeyboard)){a(document).bind("keyup",function(s){var r=s.keyCode;if(!g.animating&&(r===39||r===37)){var t=(r===39)?g.getTarget("next"):(r===37)?g.getTarget("prev"):false;g.flexAnimate(t,g.vars.pauseOnAction)}})}if(g.vars.mousewheel){g.bind("mousewheel",function(t,v,s,r){t.preventDefault();var u=(v<0)?g.getTarget("next"):g.getTarget("prev");g.flexAnimate(u,g.vars.pauseOnAction)})}if(g.vars.pausePlay){b.pausePlay.setup()}if(g.vars.slideshow&&g.vars.pauseInvisible){b.pauseInvisible.init()}if(g.vars.slideshow){if(g.vars.pauseOnHover){g.hover(function(){if(!g.manualPlay&&!g.manualPause){g.pause()}},function(){if(!g.manualPause&&!g.manualPlay&&!g.stopped){g.play()}})}if(!g.vars.pauseInvisible||!b.pauseInvisible.isHidden()){(g.vars.initDelay>0)?g.startTimeout=setTimeout(g.play,g.vars.initDelay):g.play()}}if(m){b.asNav.setup()}if(k&&g.vars.touch){b.touch()}if(!d||(d&&g.vars.smoothHeight)){a(window).bind("resize orientationchange focus",b.resize)}g.find("img").attr("draggable","false");setTimeout(function(){g.vars.start(g)},200)},asNav:{setup:function(){g.asNav=true;g.animatingTo=Math.floor(g.currentSlide/g.move);g.currentItem=g.currentSlide;g.slides.removeClass(j+"active-slide").eq(g.currentItem).addClass(j+"active-slide");if(!i){g.slides.on(q,function(t){t.preventDefault();var s=a(this),r=s.index();var u=s.offset().left-a(g).scrollLeft();if(u<=0&&s.hasClass(j+"active-slide")){g.flexAnimate(g.getTarget("prev"),true)}else{if(!a(g.vars.asNavFor).data("flexslider").animating&&!s.hasClass(j+"active-slide")){g.direction=(g.currentItem<r)?"next":"prev";g.flexAnimate(r,g.vars.pauseOnAction,false,true,true)}}})}else{o._slider=g;g.slides.each(function(){var r=this;r._gesture=new MSGesture();r._gesture.target=r;r.addEventListener("MSPointerDown",function(s){s.preventDefault();if(s.currentTarget._gesture){s.currentTarget._gesture.addPointer(s.pointerId)}},false);r.addEventListener("MSGestureTap",function(u){u.preventDefault();var t=a(this),s=t.index();if(!a(g.vars.asNavFor).data("flexslider").animating&&!t.hasClass("active")){g.direction=(g.currentItem<s)?"next":"prev";g.flexAnimate(s,g.vars.pauseOnAction,false,true,true)}})})}}},controlNav:{setup:function(){if(!g.manualControls){b.controlNav.setupPaging()}else{b.controlNav.setupManual()}},setupPaging:function(){var u=(g.vars.controlNav==="thumbnails")?"control-thumbs":"control-paging",s=1,v,r;g.controlNavScaffold=a('<ol class="'+j+"control-nav "+j+u+'"></ol>');if(g.pagingCount>1){for(var t=0;t<g.pagingCount;t++){r=g.slides.eq(t);v=(g.vars.controlNav==="thumbnails")?'<img src="'+r.attr("data-thumb")+'"/>':"<a>"+s+"</a>";if("thumbnails"===g.vars.controlNav&&true===g.vars.thumbCaptions){var w=r.attr("data-thumbcaption");if(""!=w&&undefined!=w){v+='<span class="'+j+'caption">'+w+"</span>"}}g.controlNavScaffold.append("<li>"+v+"</li>");s++}}(g.controlsContainer)?a(g.controlsContainer).append(g.controlNavScaffold):g.append(g.controlNavScaffold);b.controlNav.set();b.controlNav.active();g.controlNavScaffold.delegate("a, img",q,function(z){z.preventDefault();if(h===""||h===z.type){var y=a(this),x=g.controlNav.index(y);if(!y.hasClass(j+"active")){g.direction=(x>g.currentSlide)?"next":"prev";g.flexAnimate(x,g.vars.pauseOnAction)}}if(h===""){h=z.type}b.setToClearWatchedEvent()})},setupManual:function(){g.controlNav=g.manualControls;b.controlNav.active();g.controlNav.bind(q,function(r){r.preventDefault();if(h===""||h===r.type){var t=a(this),s=g.controlNav.index(t);if(!t.hasClass(j+"active")){(s>g.currentSlide)?g.direction="next":g.direction="prev";g.flexAnimate(s,g.vars.pauseOnAction)}}if(h===""){h=r.type}b.setToClearWatchedEvent()})},set:function(){var r=(g.vars.controlNav==="thumbnails")?"img":"a";g.controlNav=a("."+j+"control-nav li "+r,(g.controlsContainer)?g.controlsContainer:g)},active:function(){g.controlNav.removeClass(j+"active").eq(g.animatingTo).addClass(j+"active")},update:function(r,s){if(g.pagingCount>1&&r==="add"){g.controlNavScaffold.append(a("<li><a>"+g.count+"</a></li>"))}else{if(g.pagingCount===1){g.controlNavScaffold.find("li").remove()}else{g.controlNav.eq(s).closest("li").remove()}}b.controlNav.set();(g.pagingCount>1&&g.pagingCount!==g.controlNav.length)?g.update(s,r):b.controlNav.active()}},directionNav:{setup:function(){var r=a('<ul class="'+j+'direction-nav"><li><a class="'+j+'prev" href="#">'+g.vars.prevText+'</a></li><li><a class="'+j+'next" href="#">'+g.vars.nextText+"</a></li></ul>");if(g.controlsContainer){a(g.controlsContainer).append(r);g.directionNav=a("."+j+"direction-nav li a",g.controlsContainer)}else{g.append(r);g.directionNav=a("."+j+"direction-nav li a",g)}b.directionNav.update();g.directionNav.bind(q,function(s){s.preventDefault();var t;if(h===""||h===s.type){t=(a(this).hasClass(j+"next"))?g.getTarget("next"):g.getTarget("prev");g.flexAnimate(t,g.vars.pauseOnAction)}if(h===""){h=s.type}b.setToClearWatchedEvent()})},update:function(){var r=j+"disabled";if(g.pagingCount===1){g.directionNav.addClass(r).attr("tabindex","-1")}else{if(!g.vars.animationLoop){if(g.animatingTo===0){g.directionNav.removeClass(r).filter("."+j+"prev").addClass(r).attr("tabindex","-1")}else{if(g.animatingTo===g.last){g.directionNav.removeClass(r).filter("."+j+"next").addClass(r).attr("tabindex","-1")}else{g.directionNav.removeClass(r).removeAttr("tabindex")}}}else{g.directionNav.removeClass(r).removeAttr("tabindex")}}}},pausePlay:{setup:function(){var r=a('<div class="'+j+'pauseplay"><a></a></div>');if(g.controlsContainer){g.controlsContainer.append(r);g.pausePlay=a("."+j+"pauseplay a",g.controlsContainer)}else{g.append(r);g.pausePlay=a("."+j+"pauseplay a",g)}b.pausePlay.update((g.vars.slideshow)?j+"pause":j+"play");g.pausePlay.bind(q,function(s){s.preventDefault();if(h===""||h===s.type){if(a(this).hasClass(j+"pause")){g.manualPause=true;g.manualPlay=false;g.pause()}else{g.manualPause=false;g.manualPlay=true;g.play()}}if(h===""){h=s.type}b.setToClearWatchedEvent()})},update:function(r){(r==="play")?g.pausePlay.removeClass(j+"pause").addClass(j+"play").html(g.vars.playText):g.pausePlay.removeClass(j+"play").addClass(j+"pause").html(g.vars.pauseText)}},touch:function(){var v,D,B,w,y,x,G=false,u=0,s=0,A=0;if(!i){o.addEventListener("touchstart",C,false);function C(H){if(g.animating){H.preventDefault()}else{if((window.navigator.msPointerEnabled)||H.touches.length===1){g.pause();w=(e)?g.h:g.w;x=Number(new Date());u=H.touches[0].pageX;s=H.touches[0].pageY;B=(p&&l&&g.animatingTo===g.last)?0:(p&&l)?g.limit-(((g.itemW+g.vars.itemMargin)*g.move)*g.animatingTo):(p&&g.currentSlide===g.last)?g.limit:(p)?((g.itemW+g.vars.itemMargin)*g.move)*g.currentSlide:(l)?(g.last-g.currentSlide+g.cloneOffset)*w:(g.currentSlide+g.cloneOffset)*w;v=(e)?s:u;D=(e)?u:s;o.addEventListener("touchmove",r,false);o.addEventListener("touchend",E,false)}}}function r(H){u=H.touches[0].pageX;s=H.touches[0].pageY;y=(e)?v-s:v-u;G=(e)?(Math.abs(y)<Math.abs(u-D)):(Math.abs(y)<Math.abs(s-D));var I=500;if(!G||Number(new Date())-x>I){H.preventDefault();if(!d&&g.transitions){if(!g.vars.animationLoop){y=y/((g.currentSlide===0&&y<0||g.currentSlide===g.last&&y>0)?(Math.abs(y)/w+2):1)}g.setProps(B+y,"setTouch")}}}function E(J){o.removeEventListener("touchmove",r,false);if(g.animatingTo===g.currentSlide&&!G&&!(y===null)){var I=(l)?-y:y,H=(I>0)?g.getTarget("next"):g.getTarget("prev");if(g.canAdvance(H)&&(Number(new Date())-x<550&&Math.abs(I)>50||Math.abs(I)>w/2)){g.flexAnimate(H,g.vars.pauseOnAction)}else{if(!d){g.flexAnimate(g.currentSlide,g.vars.pauseOnAction,true)}}}o.removeEventListener("touchend",E,false);v=null;D=null;y=null;B=null}}else{o.style.msTouchAction="none";o._gesture=new MSGesture();o._gesture.target=o;o.addEventListener("MSPointerDown",t,false);o._slider=g;o.addEventListener("MSGestureChange",F,false);o.addEventListener("MSGestureEnd",z,false);function t(H){H.stopPropagation();if(g.animating){H.preventDefault()}else{g.pause();o._gesture.addPointer(H.pointerId);A=0;w=(e)?g.h:g.w;x=Number(new Date());B=(p&&l&&g.animatingTo===g.last)?0:(p&&l)?g.limit-(((g.itemW+g.vars.itemMargin)*g.move)*g.animatingTo):(p&&g.currentSlide===g.last)?g.limit:(p)?((g.itemW+g.vars.itemMargin)*g.move)*g.currentSlide:(l)?(g.last-g.currentSlide+g.cloneOffset)*w:(g.currentSlide+g.cloneOffset)*w}}function F(K){K.stopPropagation();var J=K.target._slider;if(!J){return}var I=-K.translationX,H=-K.translationY;A=A+((e)?H:I);y=A;G=(e)?(Math.abs(A)<Math.abs(-I)):(Math.abs(A)<Math.abs(-H));if(K.detail===K.MSGESTURE_FLAG_INERTIA){setImmediate(function(){o._gesture.stop()});return}if(!G||Number(new Date())-x>500){K.preventDefault();if(!d&&J.transitions){if(!J.vars.animationLoop){y=A/((J.currentSlide===0&&A<0||J.currentSlide===J.last&&A>0)?(Math.abs(A)/w+2):1)}J.setProps(B+y,"setTouch")}}}function z(K){K.stopPropagation();var H=K.target._slider;if(!H){return}if(H.animatingTo===H.currentSlide&&!G&&!(y===null)){var J=(l)?-y:y,I=(J>0)?H.getTarget("next"):H.getTarget("prev");if(H.canAdvance(I)&&(Number(new Date())-x<550&&Math.abs(J)>50||Math.abs(J)>w/2)){H.flexAnimate(I,H.vars.pauseOnAction)}else{if(!d){H.flexAnimate(H.currentSlide,H.vars.pauseOnAction,true)}}}v=null;D=null;y=null;B=null;A=0}}},resize:function(){if(!g.animating&&g.is(":visible")){if(!p){g.doMath()}if(d){b.smoothHeight()}else{if(p){g.slides.width(g.computedW);g.update(g.pagingCount);g.setProps()}else{if(e){g.viewport.height(g.h);g.setProps(g.h,"setTotal")}else{if(g.vars.smoothHeight){b.smoothHeight()}g.newSlides.width(g.computedW);g.setProps(g.computedW,"setTotal")}}}}},smoothHeight:function(r){if(!e||d){var s=(d)?g:g.viewport;(r)?s.animate({height:g.slides.eq(g.animatingTo).height()},r):s.height(g.slides.eq(g.animatingTo).height())}},sync:function(r){var t=a(g.vars.sync).data("flexslider"),s=g.animatingTo;switch(r){case"animate":t.flexAnimate(s,g.vars.pauseOnAction,false,true);break;case"play":if(!t.playing&&!t.asNav){t.play()}break;case"pause":t.pause();break}},uniqueID:function(r){r.find("[id]").each(function(){var s=a(this);s.attr("id",s.attr("id")+"_clone")});return r},pauseInvisible:{visProp:null,init:function(){var t=["webkit","moz","ms","o"];if("hidden" in document){return"hidden"}for(var s=0;s<t.length;s++){if((t[s]+"Hidden") in document){b.pauseInvisible.visProp=t[s]+"Hidden"}}if(b.pauseInvisible.visProp){var r=b.pauseInvisible.visProp.replace(/[H|h]idden/,"")+"visibilitychange";document.addEventListener(r,function(){if(b.pauseInvisible.isHidden()){if(g.startTimeout){clearTimeout(g.startTimeout)}else{g.pause()}}else{if(g.started){g.play()}else{(g.vars.initDelay>0)?setTimeout(g.play,g.vars.initDelay):g.play()}}})}},isHidden:function(){return document[b.pauseInvisible.visProp]||false}},setToClearWatchedEvent:function(){clearTimeout(c);c=setTimeout(function(){h=""},3000)}};g.flexAnimate=function(v,w,z,r,s){if(!g.vars.animationLoop&&v!==g.currentSlide){g.direction=(v>g.currentSlide)?"next":"prev"}if(m&&g.pagingCount===1){g.direction=(g.currentItem<v)?"next":"prev"}if(!g.animating&&(g.canAdvance(v,s)||z)&&g.is(":visible")){if(m&&r){var y=a(g.vars.asNavFor).data("flexslider");g.atEnd=v===0||v===g.count-1;y.flexAnimate(v,true,false,true,s);g.direction=(g.currentItem<v)?"next":"prev";y.direction=g.direction;if(Math.ceil((v+1)/g.visible)-1!==g.currentSlide&&v!==0){g.currentItem=v;g.slides.removeClass(j+"active-slide").eq(v).addClass(j+"active-slide");v=Math.floor(v/g.visible)}else{g.currentItem=v;g.slides.removeClass(j+"active-slide").eq(v).addClass(j+"active-slide");return false}}g.animating=true;g.animatingTo=v;if(w){g.pause()}g.vars.before(g);if(g.syncExists&&!s){b.sync("animate")}if(g.vars.controlNav){b.controlNav.active()}if(!p){g.slides.removeClass(j+"active-slide").eq(v).addClass(j+"active-slide")}g.atEnd=v===0||v===g.last;if(g.vars.directionNav){b.directionNav.update()}if(v===g.last){g.vars.end(g);if(!g.vars.animationLoop){g.pause()}}if(!d){var u=(e)?g.slides.filter(":first").height():g.computedW,t,A,x;if(p){t=g.vars.itemMargin;x=((g.itemW+t)*g.move)*g.animatingTo;A=(x>g.limit&&g.visible!==1)?g.limit:x}else{if(g.currentSlide===0&&v===g.count-1&&g.vars.animationLoop&&g.direction!=="next"){A=(l)?(g.count+g.cloneOffset)*u:0}else{if(g.currentSlide===g.last&&v===0&&g.vars.animationLoop&&g.direction!=="prev"){A=(l)?0:(g.count+1)*u}else{A=(l)?((g.count-1)-v+g.cloneOffset)*u:(v+g.cloneOffset)*u}}}g.setProps(A,"",g.vars.animationSpeed);if(g.transitions){if(!g.vars.animationLoop||!g.atEnd){g.animating=false;g.currentSlide=g.animatingTo}g.container.unbind("webkitTransitionEnd transitionend");g.container.bind("webkitTransitionEnd transitionend",function(){clearTimeout(g.ensureAnimationEnd);g.wrapup(u)});clearTimeout(g.ensureAnimationEnd);g.ensureAnimationEnd=setTimeout(function(){g.wrapup(u)},g.vars.animationSpeed+100)}else{g.container.animate(g.args,g.vars.animationSpeed,g.vars.easing,function(){g.wrapup(u)})}}else{if(!k){g.slides.eq(g.currentSlide).css({zIndex:1}).animate({opacity:0},g.vars.animationSpeed,g.vars.easing);g.slides.eq(v).css({zIndex:2}).animate({opacity:1},g.vars.animationSpeed,g.vars.easing,g.wrapup)}else{g.slides.eq(g.currentSlide).css({opacity:0,zIndex:1});g.slides.eq(v).css({opacity:1,zIndex:2});g.wrapup(u)}}if(g.vars.smoothHeight){b.smoothHeight(g.vars.animationSpeed)}}};g.wrapup=function(r){if(!d&&!p){if(g.currentSlide===0&&g.animatingTo===g.last&&g.vars.animationLoop){g.setProps(r,"jumpEnd")}else{if(g.currentSlide===g.last&&g.animatingTo===0&&g.vars.animationLoop){g.setProps(r,"jumpStart")}}}g.animating=false;g.currentSlide=g.animatingTo;g.vars.after(g)};g.animateSlides=function(){if(!g.animating&&n){g.flexAnimate(g.getTarget("next"))}};g.pause=function(){clearInterval(g.animatedSlides);g.animatedSlides=null;g.playing=false;if(g.vars.pausePlay){b.pausePlay.update("play")}if(g.syncExists){b.sync("pause")}};g.play=function(){if(g.playing){clearInterval(g.animatedSlides)}g.animatedSlides=g.animatedSlides||setInterval(g.animateSlides,g.vars.slideshowSpeed);g.started=g.playing=true;if(g.vars.pausePlay){b.pausePlay.update("pause")}if(g.syncExists){b.sync("play")}};g.stop=function(){g.pause();g.stopped=true};g.canAdvance=function(t,r){var s=(m)?g.pagingCount-1:g.last;return(r)?true:(m&&g.currentItem===g.count-1&&t===0&&g.direction==="prev")?true:(m&&g.currentItem===0&&t===g.pagingCount-1&&g.direction!=="next")?false:(t===g.currentSlide&&!m)?false:(g.vars.animationLoop)?true:(g.atEnd&&g.currentSlide===0&&t===s&&g.direction!=="next")?false:(g.atEnd&&g.currentSlide===s&&t===0&&g.direction==="next")?false:true};g.getTarget=function(r){g.direction=r;if(r==="next"){return(g.currentSlide===g.last)?0:g.currentSlide+1}else{return(g.currentSlide===0)?g.last:g.currentSlide-1}};g.setProps=function(u,r,s){var t=(function(){var v=(u)?u:((g.itemW+g.vars.itemMargin)*g.move)*g.animatingTo,w=(function(){if(p){return(r==="setTouch")?u:(l&&g.animatingTo===g.last)?0:(l)?g.limit-(((g.itemW+g.vars.itemMargin)*g.move)*g.animatingTo):(g.animatingTo===g.last)?g.limit:v}else{switch(r){case"setTotal":return(l)?((g.count-1)-g.currentSlide+g.cloneOffset)*u:(g.currentSlide+g.cloneOffset)*u;case"setTouch":return(l)?u:u;case"jumpEnd":return(l)?u:g.count*u;case"jumpStart":return(l)?g.count*u:u;default:return u}}}());return(w*-1)+"px"}());if(g.transitions){t=(e)?"translate3d(0,"+t+",0)":"translate3d("+t+",0,0)";s=(s!==undefined)?(s/1000)+"s":"0s";g.container.css("-"+g.pfx+"-transition-duration",s);g.container.css("transition-duration",s)}g.args[g.prop]=t;if(g.transitions||s===undefined){g.container.css(g.args)}g.container.css("transform",t)};g.setup=function(s){if(!d){var t,r;if(s==="init"){g.viewport=a('<div class="'+j+'viewport"></div>').css({overflow:"hidden",position:"relative"}).appendTo(g).append(g.container);g.cloneCount=0;g.cloneOffset=0;if(l){r=a.makeArray(g.slides).reverse();g.slides=a(r);g.container.empty().append(g.slides)}}if(g.vars.animationLoop&&!p){g.cloneCount=2;g.cloneOffset=1;if(s!=="init"){g.container.find(".clone").remove()}b.uniqueID(g.slides.first().clone().addClass("clone").attr("aria-hidden","true")).appendTo(g.container);b.uniqueID(g.slides.last().clone().addClass("clone").attr("aria-hidden","true")).prependTo(g.container)}g.newSlides=a(g.vars.selector,g);t=(l)?g.count-1-g.currentSlide+g.cloneOffset:g.currentSlide+g.cloneOffset;if(e&&!p){g.container.height((g.count+g.cloneCount)*200+"%").css("position","absolute").width("100%");setTimeout(function(){g.newSlides.css({display:"block"});g.doMath();g.viewport.height(g.h);g.setProps(t*g.h,"init")},(s==="init")?100:0)}else{g.container.width((g.count+g.cloneCount)*200+"%");g.setProps(t*g.computedW,"init");setTimeout(function(){g.doMath();g.newSlides.css({width:g.computedW,"float":"left",display:"block"});if(g.vars.smoothHeight){b.smoothHeight()}},(s==="init")?100:0)}}else{g.slides.css({width:"100%","float":"left",marginRight:"-100%",position:"relative"});if(s==="init"){if(!k){g.slides.css({opacity:0,display:"block",zIndex:1}).eq(g.currentSlide).css({zIndex:2}).animate({opacity:1},g.vars.animationSpeed,g.vars.easing)}else{g.slides.css({opacity:0,display:"block",webkitTransition:"opacity "+g.vars.animationSpeed/1000+"s ease",zIndex:1}).eq(g.currentSlide).css({opacity:1,zIndex:2})}}if(g.vars.smoothHeight){b.smoothHeight()}}if(!p){g.slides.removeClass(j+"active-slide").eq(g.currentSlide).addClass(j+"active-slide")}g.vars.init(g)};g.doMath=function(){var r=g.slides.first(),u=g.vars.itemMargin,s=g.vars.minItems,t=g.vars.maxItems;g.w=(g.viewport===undefined)?g.width():g.viewport.width();g.h=r.height();g.boxPadding=r.outerWidth()-r.width();if(p){g.itemT=g.vars.itemWidth+u;g.minW=(s)?s*g.itemT:g.w;g.maxW=(t)?(t*g.itemT)-u:g.w;g.itemW=(g.minW>g.w)?(g.w-(u*(s-1)))/s:(g.maxW<g.w)?(g.w-(u*(t-1)))/t:(g.vars.itemWidth>g.w)?g.w:g.vars.itemWidth;g.visible=Math.floor(g.w/(g.itemW));g.move=(g.vars.move>0&&g.vars.move<g.visible)?g.vars.move:g.visible;g.pagingCount=Math.ceil(((g.count-g.visible)/g.move)+1);g.last=g.pagingCount-1;g.limit=(g.pagingCount===1)?0:(g.vars.itemWidth>g.w)?(g.itemW*(g.count-1))+(u*(g.count-1)):((g.itemW+u)*g.count)-g.w-u}else{g.itemW=g.w;g.pagingCount=g.count;g.last=g.count-1}g.computedW=g.itemW-g.boxPadding};g.update=function(s,r){g.doMath();if(!p){if(s<g.currentSlide){g.currentSlide+=1}else{if(s<=g.currentSlide&&s!==0){g.currentSlide-=1}}g.animatingTo=g.currentSlide}if(g.vars.controlNav&&!g.manualControls){if((r==="add"&&!p)||g.pagingCount>g.controlNav.length){b.controlNav.update("add")}else{if((r==="remove"&&!p)||g.pagingCount<g.controlNav.length){if(p&&g.currentSlide>g.last){g.currentSlide-=1;g.animatingTo-=1}b.controlNav.update("remove",g.last)}}}if(g.vars.directionNav){b.directionNav.update()}};g.addSlide=function(r,t){var s=a(r);g.count+=1;g.last=g.count-1;if(e&&l){(t!==undefined)?g.slides.eq(g.count-t).after(s):g.container.prepend(s)}else{(t!==undefined)?g.slides.eq(t).before(s):g.container.append(s)}g.update(t,"add");g.slides=a(g.vars.selector+":not(.clone)",g);g.setup();g.vars.added(g)};g.removeSlide=function(r){var s=(isNaN(r))?g.slides.index(a(r)):r;g.count-=1;g.last=g.count-1;if(isNaN(r)){a(r,g.slides).remove()}else{(e&&l)?g.slides.eq(g.last).remove():g.slides.eq(r).remove()}g.doMath();g.update(s,"remove");g.slides=a(g.vars.selector+":not(.clone)",g);g.setup();g.vars.removed(g)};b.init()};a(window).blur(function(b){focused=false}).focus(function(b){focused=true});a.flexslider.defaults={namespace:"flex-",selector:".slides > li",animation:"fade",easing:"swing",direction:"horizontal",reverse:false,animationLoop:true,smoothHeight:false,startAt:0,slideshow:true,slideshowSpeed:7000,animationSpeed:600,initDelay:0,randomize:false,thumbCaptions:false,pauseOnAction:true,pauseOnHover:false,pauseInvisible:true,useCSS:true,touch:true,video:false,controlNav:true,directionNav:true,prevText:"Previous",nextText:"Next",keyboard:true,multipleKeyboard:false,mousewheel:false,pausePlay:false,pauseText:"Pause",playText:"Play",controlsContainer:"",manualControls:"",sync:"",asNavFor:"",itemWidth:0,itemMargin:0,minItems:1,maxItems:0,move:0,allowOneSlide:true,start:function(){},before:function(){},after:function(){},end:function(){},added:function(){},removed:function(){},init:function(){}};a.fn.flexslider=function(b){if(b===undefined){b={}}if(typeof b==="object"){return this.each(function(){var f=a(this),d=(b.selector)?b.selector:".slides > li",e=f.find(d);if((e.length===1&&b.allowOneSlide===true)||e.length===0){e.fadeIn(400);if(b.start){b.start(f)}}else{if(f.data("flexslider")===undefined){new a.flexslider(this,b)}}})}else{var c=a(this).data("flexslider");switch(b){case"play":c.play();break;case"pause":c.pause();break;case"stop":c.stop();break;case"next":c.flexAnimate(c.getTarget("next"),true);break;case"prev":case"previous":c.flexAnimate(c.getTarget("prev"),true);break;default:if(typeof b==="number"){c.flexAnimate(b,true)}}}}})(jQuery);
/*!
 * Created by mario on 15/05/14.
 */
;$(window).load(function(){$(".flexslider-principal").flexslider({animation:"slide",slideshowSpeed:5000,startAt:0,slideshow:true});$(".flexslider-destaque").flexslider({animation:"slide",controlNav:"thumbnails",randomize:false,slideshow:false});$("#flexslider-detalhe-thumb").flexslider({animation:"slide",controlNav:false,animationLoop:false,slideshow:false,itemWidth:120,itemMargin:5,asNavFor:"#flexslider-detalhe"});$("#flexslider-detalhe").flexslider({animation:"slide",controlNav:false,animationLoop:false,slideshow:false,sync:"#flexslider-detalhe-thumb"})});
 ...
 * Licensed under MIT (https://github.com/twbs/bootstrap/blob/master/LICENSE)
 */
;if(typeof jQuery==="undefined"){throw new Error("Bootstrap's JavaScript requires jQuery")}+function(c){function d(){var b=document.createElement("bootstrap");var f={WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd otransitionend",transition:"transitionend"};for(var a in f){if(b.style[a]!==undefined){return{end:f[a]}}}return false}c.fn.emulateTransitionEnd=function(b){var g=false,h=this;c(this).one(c.support.transition.end,function(){g=true});var a=function(){if(!g){c(h).trigger(c.support.transition.end)}};setTimeout(a,b);return this};c(function(){c.support.transition=d()})}(jQuery);+function(g){var h='[data-dismiss="alert"]';var e=function(a){g(a).on("click",h,this.close)};e.prototype.close=function(c){var d=g(this);var a=d.attr("data-target");if(!a){a=d.attr("href");a=a&&a.replace(/.*(?=#[^\s]*$)/,"")}var j=g(a);if(c){c.preventDefault()}if(!j.length){j=d.hasClass("alert")?d:d.parent()}j.trigger(c=g.Event("close.bs.alert"));if(c.isDefaultPrevented()){return}j.removeClass("in");function b(){j.trigger("closed.bs.alert").remove()}g.support.transition&&j.hasClass("fade")?j.one(g.support.transition.end,b).emulateTransitionEnd(150):b()};var f=g.fn.alert;g.fn.alert=function(a){return this.each(function(){var b=g(this);var c=b.data("bs.alert");if(!c){b.data("bs.alert",(c=new e(this)))}if(typeof a=="string"){c[a].call(b)}})};g.fn.alert.Constructor=e;g.fn.alert.noConflict=function(){g.fn.alert=f;return this};g(document).on("click.bs.alert.data-api",h,e.prototype.close)}(jQuery);+function(e){var f=function(a,b){this.$element=e(a);this.options=e.extend({},f.DEFAULTS,b);this.isLoading=false};f.DEFAULTS={loadingText:"loading..."};f.prototype.setState=function(j){var c="disabled";var b=this.$element;var i=b.is("input")?"val":"html";var a=b.data();j=j+"Text";if(!a.resetText){b.data("resetText",b[i]())}b[i](a[j]||this.options[j]);setTimeout(e.proxy(function(){if(j=="loadingText"){this.isLoading=true;b.addClass(c).attr(c,c)}else{if(this.isLoading){this.isLoading=false;b.removeClass(c).removeAttr(c)}}},this),0)};f.prototype.toggle=function(){var c=true;var a=this.$element.closest('[data-toggle="buttons"]');if(a.length){var b=this.$element.find("input");if(b.prop("type")=="radio"){if(b.prop("checked")&&this.$element.hasClass("active")){c=false}else{a.find(".active").removeClass("active")}}if(c){b.prop("checked",!this.$element.hasClass("active")).trigger("change")}}if(c){this.$element.toggleClass("active")}};var d=e.fn.button;e.fn.button=function(a){return this.each(function(){var h=e(this);var b=h.data("bs.button");var c=typeof a=="object"&&a;if(!b){h.data("bs.button",(b=new f(this,c)))}if(a=="toggle"){b.toggle()}else{if(a){b.setState(a)}}})};e.fn.button.Constructor=f;e.fn.button.noConflict=function(){e.fn.button=d;return this};e(document).on("click.bs.button.data-api","[data-toggle^=button]",function(a){var b=e(a.target);if(!b.hasClass("btn")){b=b.closest(".btn")}b.button("toggle");a.preventDefault()})}(jQuery);+function(f){var e=function(a,b){this.$element=f(a);this.$indicators=this.$element.find(".carousel-indicators");this.options=b;this.paused=this.sliding=this.interval=this.$active=this.$items=null;this.options.pause=="hover"&&this.$element.on("mouseenter",f.proxy(this.pause,this)).on("mouseleave",f.proxy(this.cycle,this))};e.DEFAULTS={interval:5000,pause:"hover",wrap:true};e.prototype.cycle=function(a){a||(this.paused=false);this.interval&&clearInterval(this.interval);this.options.interval&&!this.paused&&(this.interval=setInterval(f.proxy(this.next,this),this.options.interval));return this};e.prototype.getActiveIndex=function(){this.$active=this.$element.find(".item.active");this.$items=this.$active.parent().children();return this.$items.index(this.$active)};e.prototype.to=function(b){var c=this;var a=this.getActiveIndex();if(b>(this.$items.length-1)||b<0){return}if(this.sliding){return this.$element.one("slid.bs.carousel",function(){c.to(b)})}if(a==b){return this.pause().cycle()}return this.slide(b>a?"next":"prev",f(this.$items[b]))};e.prototype.pause=function(a){a||(this.paused=true);if(this.$element.find(".next, .prev").length&&f.support.transition){this.$element.trigger(f.support.transition.end);this.cycle(true)}this.interval=clearInterval(this.interval);return this};e.prototype.next=function(){if(this.sliding){return}return this.slide("next")};e.prototype.prev=function(){if(this.sliding){return}return this.slide("prev")};e.prototype.slide=function(m,r){var b=this.$element.find(".item.active");var a=r||b[m]();var n=this.interval;var c=m=="next"?"left":"right";var q=m=="next"?"first":"last";var p=this;if(!a.length){if(!this.options.wrap){return}a=this.$element.find(".item")[q]()}if(a.hasClass("active")){return this.sliding=false}var o=f.Event("slide.bs.carousel",{relatedTarget:a[0],direction:c});this.$element.trigger(o);if(o.isDefaultPrevented()){return}this.sliding=true;n&&this.pause();if(this.$indicators.length){this.$indicators.find(".active").removeClass("active");this.$element.one("slid.bs.carousel",function(){var g=f(p.$indicators.children()[p.getActiveIndex()]);g&&g.addClass("active")})}if(f.support.transition&&this.$element.hasClass("slide")){a.addClass(m);a[0].offsetWidth;b.addClass(c);a.addClass(c);b.one(f.support.transition.end,function(){a.removeClass([m,c].join(" ")).addClass("active");b.removeClass(["active",c].join(" "));p.sliding=false;setTimeout(function(){p.$element.trigger("slid.bs.carousel")},0)}).emulateTransitionEnd(b.css("transition-duration").slice(0,-1)*1000)}else{b.removeClass("active");a.addClass("active");this.sliding=false;this.$element.trigger("slid.bs.carousel")}n&&this.cycle();return this};var d=f.fn.carousel;f.fn.carousel=function(a){return this.each(function(){var b=f(this);var c=b.data("bs.carousel");var j=f.extend({},e.DEFAULTS,b.data(),typeof a=="object"&&a);var i=typeof a=="string"?a:j.slide;if(!c){b.data("bs.carousel",(c=new e(this,j)))}if(typeof a=="number"){c.to(a)}else{if(i){c[i]()}else{if(j.interval){c.pause().cycle()}}}})};f.fn.carousel.Constructor=e;f.fn.carousel.noConflict=function(){f.fn.carousel=d;return this};f(document).on("click.bs.carousel.data-api","[data-slide], [data-slide-to]",function(b){var j=f(this),k;var l=f(j.attr("data-target")||(k=j.attr("href"))&&k.replace(/.*(?=#[^\s]+$)/,""));var c=f.extend({},l.data(),j.data());var a=j.attr("data-slide-to");if(a){c.interval=false}l.carousel(c);if(a=j.attr("data-slide-to")){l.data("bs.carousel").to(a)}b.preventDefault()});f(window).on("load",function(){f('[data-ride="carousel"]').each(function(){var a=f(this);a.carousel(a.data())})})}(jQuery);+function(f){var e=function(a,b){this.$element=f(a);this.options=f.extend({},e.DEFAULTS,b);this.transitioning=null;if(this.options.parent){this.$parent=f(this.options.parent)}if(this.options.toggle){this.toggle()}};e.DEFAULTS={toggle:true};e.prototype.dimension=function(){var a=this.$element.hasClass("width");return a?"width":"height"};e.prototype.show=function(){if(this.transitioning||this.$element.hasClass("in")){return}var b=f.Event("show.bs.collapse");this.$element.trigger(b);if(b.isDefaultPrevented()){return}var l=this.$parent&&this.$parent.find("> .panel > .in");if(l&&l.length){var c=l.data("bs.collapse");if(c&&c.transitioning){return}l.collapse("hide");c||l.data("bs.collapse",null)}var j=this.dimension();this.$element.removeClass("collapse").addClass("collapsing")[j](0);this.transitioning=1;var k=function(){this.$element.removeClass("collapsing").addClass("collapse in")[j]("auto");this.transitioning=0;this.$element.trigger("shown.bs.collapse")};if(!f.support.transition){return k.call(this)}var a=f.camelCase(["scroll",j].join("-"));this.$element.one(f.support.transition.end,f.proxy(k,this)).emulateTransitionEnd(350)[j](this.$element[0][a])};e.prototype.hide=function(){if(this.transitioning||!this.$element.hasClass("in")){return}var c=f.Event("hide.bs.collapse");this.$element.trigger(c);if(c.isDefaultPrevented()){return}var b=this.dimension();this.$element[b](this.$element[b]())[0].offsetHeight;this.$element.addClass("collapsing").removeClass("collapse").removeClass("in");this.transitioning=1;var a=function(){this.transitioning=0;this.$element.trigger("hidden.bs.collapse").removeClass("collapsing").addClass("collapse")};if(!f.support.transition){return a.call(this)}this.$element[b](0).one(f.support.transition.end,f.proxy(a,this)).emulateTransitionEnd(350)};e.prototype.toggle=function(){this[this.$element.hasClass("in")?"hide":"show"]()};var d=f.fn.collapse;f.fn.collapse=function(a){return this.each(function(){var h=f(this);var b=h.data("bs.collapse");var c=f.extend({},e.DEFAULTS,h.data(),typeof a=="object"&&a);if(!b&&c.toggle&&a=="show"){a=!a}if(!b){h.data("bs.collapse",(b=new e(this,c)))}if(typeof a=="string"){b[a]()}})};f.fn.collapse.Constructor=e;f.fn.collapse.noConflict=function(){f.fn.collapse=d;return this};f(document).on("click.bs.collapse.data-api","[data-toggle=collapse]",function(n){var c=f(this),a;var m=c.attr("data-target")||n.preventDefault()||(a=c.attr("href"))&&a.replace(/.*(?=#[^\s]+$)/,"");var r=f(m);var p=r.data("bs.collapse");var o=p?"toggle":c.data();var b=c.attr("data-parent");var q=b&&f(b);if(!p||!p.transitioning){if(q){q.find('[data-toggle=collapse][data-parent="'+b+'"]').not(c).addClass("collapsed")}c[r.hasClass("in")?"addClass":"removeClass"]("collapsed")}r.collapse(o)})}(jQuery);+function(h){var j=".dropdown-backdrop";var m="[data-toggle=dropdown]";var n=function(a){h(a).on("click.bs.dropdown",this.toggle)};n.prototype.toggle=function(c){var d=h(this);if(d.is(".disabled, :disabled")){return}var e=i(d);var a=e.hasClass("open");k();if(!a){if("ontouchstart" in document.documentElement&&!e.closest(".navbar-nav").length){h('<div class="dropdown-backdrop"/>').insertAfter(h(this)).on("click",k)}var b={relatedTarget:this};e.trigger(c=h.Event("show.bs.dropdown",b));if(c.isDefaultPrevented()){return}e.toggleClass("open").trigger("shown.bs.dropdown",b);d.focus()}return false};n.prototype.keydown=function(d){if(!/(38|40|27)/.test(d.keyCode)){return}var e=h(this);d.preventDefault();d.stopPropagation();if(e.is(".disabled, :disabled")){return}var f=i(e);var g=f.hasClass("open");if(!g||(g&&d.keyCode==27)){if(d.which==27){f.find(m).focus()}return e.click()}var c=" li:not(.divider):visible a";var b=f.find("[role=menu]"+c+", [role=listbox]"+c);if(!b.length){return}var a=b.index(b.filter(":focus"));if(d.keyCode==38&&a>0){a--}if(d.keyCode==40&&a<b.length-1){a++}if(!~a){a=0}b.eq(a).focus()};function k(a){h(j).remove();h(m).each(function(){var b=i(h(this));var c={relatedTarget:this};if(!b.hasClass("open")){return}b.trigger(a=h.Event("hide.bs.dropdown",c));if(a.isDefaultPrevented()){return}b.removeClass("open").trigger("hidden.bs.dropdown",c)})}function i(b){var a=b.attr("data-target");if(!a){a=b.attr("href");a=a&&/#[A-Za-z]/.test(a)&&a.replace(/.*(?=#[^\s]*$)/,"")}var c=a&&h(a);return c&&c.length?c:b.parent()}var l=h.fn.dropdown;h.fn.dropdown=function(a){return this.each(function(){var b=h(this);var c=b.data("bs.dropdown");if(!c){b.data("bs.dropdown",(c=new n(this)))}if(typeof a=="string"){c[a].call(b)}})};h.fn.dropdown.Constructor=n;h.fn.dropdown.noConflict=function(){h.fn.dropdown=l;return this};h(document).on("click.bs.dropdown.data-api",k).on("click.bs.dropdown.data-api",".dropdown form",function(a){a.stopPropagation()}).on("click.bs.dropdown.data-api",m,n.prototype.toggle).on("keydown.bs.dropdown.data-api",m+", [role=menu], [role=listbox]",n.prototype.keydown)}(jQuery);+function(e){var f=function(a,b){this.options=b;this.$element=e(a);this.$backdrop=this.isShown=null;if(this.options.remote){this.$element.find(".modal-content").load(this.options.remote,e.proxy(function(){this.$element.trigger("loaded.bs.modal")},this))}};f.DEFAULTS={backdrop:true,keyboard:true,show:true};f.prototype.toggle=function(a){return this[!this.isShown?"show":"hide"](a)};f.prototype.show=function(b){var a=this;var c=e.Event("show.bs.modal",{relatedTarget:b});this.$element.trigger(c);if(this.isShown||c.isDefaultPrevented()){return}this.isShown=true;this.escape();this.$element.on("click.dismiss.bs.modal",'[data-dismiss="modal"]',e.proxy(this.hide,this));this.backdrop(function(){var g=e.support.transition&&a.$element.hasClass("fade");if(!a.$element.parent().length){a.$element.appendTo(document.body)}a.$element.show().scrollTop(0);if(g){a.$element[0].offsetWidth}a.$element.addClass("in").attr("aria-hidden",false);a.enforceFocus();var j=e.Event("shown.bs.modal",{relatedTarget:b});g?a.$element.find(".modal-dialog").one(e.support.transition.end,function(){a.$element.focus().trigger(j)}).emulateTransitionEnd(300):a.$element.focus().trigger(j)})};f.prototype.hide=function(a){if(a){a.preventDefault()}a=e.Event("hide.bs.modal");this.$element.trigger(a);if(!this.isShown||a.isDefaultPrevented()){return}this.isShown=false;this.escape();e(document).off("focusin.bs.modal");this.$element.removeClass("in").attr("aria-hidden",true).off("click.dismiss.bs.modal");e.support.transition&&this.$element.hasClass("fade")?this.$element.one(e.support.transition.end,e.proxy(this.hideModal,this)).emulateTransitionEnd(300):this.hideModal()};f.prototype.enforceFocus=function(){e(document).off("focusin.bs.modal").on("focusin.bs.modal",e.proxy(function(a){if(this.$element[0]!==a.target&&!this.$element.has(a.target).length){this.$element.focus()}},this))};f.prototype.escape=function(){if(this.isShown&&this.options.keyboard){this.$element.on("keyup.dismiss.bs.modal",e.proxy(function(a){a.which==27&&this.hide()},this))}else{if(!this.isShown){this.$element.off("keyup.dismiss.bs.modal")}}};f.prototype.hideModal=function(){var a=this;this.$element.hide();this.backdrop(function(){a.removeBackdrop();a.$element.trigger("hidden.bs.modal")})};f.prototype.removeBackdrop=function(){this.$backdrop&&this.$backdrop.remove();this.$backdrop=null};f.prototype.backdrop=function(b){var c=this.$element.hasClass("fade")?"fade":"";if(this.isShown&&this.options.backdrop){var a=e.support.transition&&c;this.$backdrop=e('<div class="modal-backdrop '+c+'" />').appendTo(document.body);this.$element.on("click.dismiss.bs.modal",e.proxy(function(h){if(h.target!==h.currentTarget){return}this.options.backdrop=="static"?this.$element[0].focus.call(this.$element[0]):this.hide.call(this)},this));if(a){this.$backdrop[0].offsetWidth}this.$backdrop.addClass("in");if(!b){return}a?this.$backdrop.one(e.support.transition.end,b).emulateTransitionEnd(150):b()}else{if(!this.isShown&&this.$backdrop){this.$backdrop.removeClass("in");e.support.transition&&this.$element.hasClass("fade")?this.$backdrop.one(e.support.transition.end,b).emulateTransitionEnd(150):b()}else{if(b){b()}}}};var d=e.fn.modal;e.fn.modal=function(b,a){return this.each(function(){var c=e(this);var i=c.data("bs.modal");var j=e.extend({},f.DEFAULTS,c.data(),typeof b=="object"&&b);if(!i){c.data("bs.modal",(i=new f(this,j)))}if(typeof b=="string"){i[b](a)}else{if(j.show){i.show(a)}}})};e.fn.modal.Constructor=f;e.fn.modal.noConflict=function(){e.fn.modal=d;return this};e(document).on("click.bs.modal.data-api",'[data-toggle="modal"]',function(c){var i=e(this);var a=i.attr("href");var b=e(i.attr("data-target")||(a&&a.replace(/.*(?=#[^\s]+$)/,"")));var j=b.data("bs.modal")?"toggle":e.extend({remote:!/#/.test(a)&&a},b.data(),i.data());if(i.is("a")){c.preventDefault()}b.modal(j,this).one("hide",function(){i.is(":visible")&&i.focus()})});e(document).on("show.bs.modal",".modal",function(){e(document.body).addClass("modal-open")}).on("hidden.bs.modal",".modal",function(){e(document.body).removeClass("modal-open")})}(jQuery);+function(e){var f=function(a,b){this.type=this.options=this.enabled=this.timeout=this.hoverState=this.$element=null;this.init("tooltip",a,b)};f.DEFAULTS={animation:true,placement:"top",selector:false,template:'<div class="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',trigger:"hover focus",title:"",delay:0,html:false,container:false};f.prototype.init=function(n,a,o){this.enabled=true;this.type=n;this.$element=e(a);this.options=this.getOptions(o);var m=this.options.trigger.split(" ");for(var p=m.length;p--;){var b=m[p];if(b=="click"){this.$element.on("click."+this.type,this.options.selector,e.proxy(this.toggle,this))}else{if(b!="manual"){var c=b=="hover"?"mouseenter":"focusin";var i=b=="hover"?"mouseleave":"focusout";this.$element.on(c+"."+this.type,this.options.selector,e.proxy(this.enter,this));this.$element.on(i+"."+this.type,this.options.selector,e.proxy(this.leave,this))}}}this.options.selector?(this._options=e.extend({},this.options,{trigger:"manual",selector:""})):this.fixTitle()};f.prototype.getDefaults=function(){return f.DEFAULTS};f.prototype.getOptions=function(a){a=e.extend({},this.getDefaults(),this.$element.data(),a);if(a.delay&&typeof a.delay=="number"){a.delay={show:a.delay,hide:a.delay}}return a};f.prototype.getDelegateOptions=function(){var b={};var a=this.getDefaults();this._options&&e.each(this._options,function(h,c){if(a[h]!=c){b[h]=c}});return b};f.prototype.enter=function(a){var b=a instanceof this.constructor?a:e(a.currentTarget)[this.type](this.getDelegateOptions()).data("bs."+this.type);clearTimeout(b.timeout);b.hoverState="in";if(!b.options.delay||!b.options.delay.show){return b.show()}b.timeout=setTimeout(function(){if(b.hoverState=="in"){b.show()}},b.options.delay.show)};f.prototype.leave=function(a){var b=a instanceof this.constructor?a:e(a.currentTarget)[this.type](this.getDelegateOptions()).data("bs."+this.type);clearTimeout(b.timeout);b.hoverState="out";if(!b.options.delay||!b.options.delay.hide){return b.hide()}b.timeout=setTimeout(function(){if(b.hoverState=="out"){b.hide()}},b.options.delay.hide)};f.prototype.show=function(){var H=e.Event("show.bs."+this.type);if(this.hasContent()&&this.enabled){this.$element.trigger(H);if(H.isDefaultPrevented()){return}var y=this;var G=this.tip();this.setContent();if(this.options.animation){G.addClass("fade")}var a=typeof this.options.placement=="function"?this.options.placement.call(this,G[0],this.$element[0]):this.options.placement;var E=/\s?auto?\s?/i;var c=E.test(a);if(c){a=a.replace(E,"")||"top"}G.detach().css({top:0,left:0,display:"block"}).addClass(a);this.options.container?G.appendTo(this.options.container):G.insertAfter(this.$element);var C=this.getPosition();var D=G[0].offsetWidth;var A=G[0].offsetHeight;if(c){var u=this.$element.parent();var w=a;var v=document.documentElement.scrollTop||document.body.scrollTop;var x=this.options.container=="body"?window.innerWidth:u.outerWidth();var z=this.options.container=="body"?window.innerHeight:u.outerHeight();var F=this.options.container=="body"?0:u.offset().left;a=a=="bottom"&&C.top+C.height+A-v>z?"top":a=="top"&&C.top-v-A<0?"bottom":a=="right"&&C.right+D>x?"left":a=="left"&&C.left-D<F?"right":a;G.removeClass(w).addClass(a)}var b=this.getCalculatedOffset(a,C,D,A);this.applyPlacement(b,a);this.hoverState=null;var B=function(){y.$element.trigger("shown.bs."+y.type)};e.support.transition&&this.$tip.hasClass("fade")?G.one(e.support.transition.end,B).emulateTransitionEnd(150):B()}};f.prototype.applyPlacement=function(v,u){var b;var t=this.tip();var c=t[0].offsetWidth;var q=t[0].offsetHeight;var o=parseInt(t.css("margin-top"),10);var a=parseInt(t.css("margin-left"),10);if(isNaN(o)){o=0}if(isNaN(a)){a=0}v.top=v.top+o;v.left=v.left+a;e.offset.setOffset(t[0],e.extend({using:function(g){t.css({top:Math.round(g.top),left:Math.round(g.left)})}},v),0);t.addClass("in");var p=t[0].offsetWidth;var s=t[0].offsetHeight;if(u=="top"&&s!=q){b=true;v.top=v.top+q-s}if(/bottom|top/.test(u)){var r=0;if(v.left<0){r=v.left*-2;v.left=0;t.offset(v);p=t[0].offsetWidth;s=t[0].offsetHeight}this.replaceArrow(r-c+p,p,"left")}else{this.replaceArrow(s-q,s,"top")}if(b){t.offset(v)}};f.prototype.replaceArrow=function(b,c,a){this.arrow().css(a,b?(50*(1-b/c)+"%"):"")};f.prototype.setContent=function(){var a=this.tip();var b=this.getTitle();a.find(".tooltip-inner")[this.options.html?"html":"text"](b);a.removeClass("fade in top bottom left right")};f.prototype.hide=function(){var c=this;var a=this.tip();var b=e.Event("hide.bs."+this.type);function h(){if(c.hoverState!="in"){a.detach()}c.$element.trigger("hidden.bs."+c.type)}this.$element.trigger(b);if(b.isDefaultPrevented()){return}a.removeClass("in");e.support.transition&&this.$tip.hasClass("fade")?a.one(e.support.transition.end,h).emulateTransitionEnd(150):h();this.hoverState=null;return this};f.prototype.fixTitle=function(){var a=this.$element;if(a.attr("title")||typeof(a.attr("data-original-title"))!="string"){a.attr("data-original-title",a.attr("title")||"").attr("title","")}};f.prototype.hasContent=function(){return this.getTitle()};f.prototype.getPosition=function(){var a=this.$element[0];return e.extend({},(typeof a.getBoundingClientRect=="function")?a.getBoundingClientRect():{width:a.offsetWidth,height:a.offsetHeight},this.$element.offset())};f.prototype.getCalculatedOffset=function(h,a,c,b){return h=="bottom"?{top:a.top+a.height,left:a.left+a.width/2-c/2}:h=="top"?{top:a.top-b,left:a.left+a.width/2-c/2}:h=="left"?{top:a.top+a.height/2-b/2,left:a.left-c}:{top:a.top+a.height/2-b/2,left:a.left+a.width}};f.prototype.getTitle=function(){var b;var a=this.$element;var c=this.options;b=a.attr("data-original-title")||(typeof c.title=="function"?c.title.call(a[0]):c.title);return b};f.prototype.tip=function(){return this.$tip=this.$tip||e(this.options.template)};f.prototype.arrow=function(){return this.$arrow=this.$arrow||this.tip().find(".tooltip-arrow")};f.prototype.validate=function(){if(!this.$element[0].parentNode){this.hide();this.$element=null;this.options=null}};f.prototype.enable=function(){this.enabled=true};f.prototype.disable=function(){this.enabled=false};f.prototype.toggleEnabled=function(){this.enabled=!this.enabled};f.prototype.toggle=function(a){var b=a?e(a.currentTarget)[this.type](this.getDelegateOptions()).data("bs."+this.type):this;b.tip().hasClass("in")?b.leave(b):b.enter(b)};f.prototype.destroy=function(){clearTimeout(this.timeout);this.hide().$element.off("."+this.type).removeData("bs."+this.type)};var d=e.fn.tooltip;e.fn.tooltip=function(a){return this.each(function(){var h=e(this);var b=h.data("bs.tooltip");var c=typeof a=="object"&&a;if(!b&&a=="destroy"){return}if(!b){h.data("bs.tooltip",(b=new f(this,c)))}if(typeof a=="string"){b[a]()}})};e.fn.tooltip.Constructor=f;e.fn.tooltip.noConflict=function(){e.fn.tooltip=d;return this}}(jQuery);+function(e){var f=function(a,b){this.init("popover",a,b)};if(!e.fn.tooltip){throw new Error("Popover requires tooltip.js")}f.DEFAULTS=e.extend({},e.fn.tooltip.Constructor.DEFAULTS,{placement:"right",trigger:"click",content:"",template:'<div class="popover"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>'});f.prototype=e.extend({},e.fn.tooltip.Constructor.prototype);f.prototype.constructor=f;f.prototype.getDefaults=function(){return f.DEFAULTS};f.prototype.setContent=function(){var b=this.tip();var c=this.getTitle();var a=this.getContent();b.find(".popover-title")[this.options.html?"html":"text"](c);b.find(".popover-content")[this.options.html?(typeof a=="string"?"html":"append"):"text"](a);b.removeClass("fade top bottom left right in");if(!b.find(".popover-title").html()){b.find(".popover-title").hide()}};f.prototype.hasContent=function(){return this.getTitle()||this.getContent()};f.prototype.getContent=function(){var b=this.$element;var a=this.options;return b.attr("data-content")||(typeof a.content=="function"?a.content.call(b[0]):a.content)};f.prototype.arrow=function(){return this.$arrow=this.$arrow||this.tip().find(".arrow")};f.prototype.tip=function(){if(!this.$tip){this.$tip=e(this.options.template)}return this.$tip};var d=e.fn.popover;e.fn.popover=function(a){return this.each(function(){var h=e(this);var b=h.data("bs.popover");var c=typeof a=="object"&&a;if(!b&&a=="destroy"){return}if(!b){h.data("bs.popover",(b=new f(this,c)))}if(typeof a=="string"){b[a]()}})};e.fn.popover.Constructor=f;e.fn.popover.noConflict=function(){e.fn.popover=d;return this}}(jQuery);+function(e){function f(b,c){var h;var a=e.proxy(this.process,this);this.$element=e(b).is("body")?e(window):e(b);this.$body=e("body");this.$scrollElement=this.$element.on("scroll.bs.scroll-spy.data-api",a);this.options=e.extend({},f.DEFAULTS,c);this.selector=(this.options.target||((h=e(b).attr("href"))&&h.replace(/.*(?=#[^\s]+$)/,""))||"")+" .nav li > a";this.offsets=e([]);this.targets=e([]);this.activeTarget=null;this.refresh();this.process()}f.DEFAULTS={offset:10};f.prototype.refresh=function(){var a=this.$element[0]==window?"offset":"position";this.offsets=e([]);this.targets=e([]);var c=this;var b=this.$body.find(this.selector).map(function(){var k=e(this);var l=k.data("target")||k.attr("href");var j=/^#./.test(l)&&e(l);return(j&&j.length&&j.is(":visible")&&[[j[a]().top+(!e.isWindow(c.$scrollElement.get(0))&&c.$scrollElement.scrollTop()),l]])||null}).sort(function(i,j){return i[0]-j[0]}).each(function(){c.offsets.push(this[0]);c.targets.push(this[1])})};f.prototype.process=function(){var m=this.$scrollElement.scrollTop()+this.options.offset;var i=this.$scrollElement[0].scrollHeight||this.$body[0].scrollHeight;var a=i-this.$scrollElement.height();var c=this.offsets;var n=this.targets;var l=this.activeTarget;var b;if(m>=a){return l!=(b=n.last()[0])&&this.activate(b)}if(l&&m<=c[0]){return l!=(b=n[0])&&this.activate(b)}for(b=c.length;b--;){l!=n[b]&&m>=c[b]&&(!c[b+1]||m<=c[b+1])&&this.activate(n[b])}};f.prototype.activate=function(b){this.activeTarget=b;e(this.selector).parentsUntil(this.options.target,".active").removeClass("active");var a=this.selector+'[data-target="'+b+'"],'+this.selector+'[href="'+b+'"]';var c=e(a).parents("li").addClass("active");if(c.parent(".dropdown-menu").length){c=c.closest("li.dropdown").addClass("active")}c.trigger("activate.bs.scrollspy")};var d=e.fn.scrollspy;e.fn.scrollspy=function(a){return this.each(function(){var h=e(this);var b=h.data("bs.scrollspy");var c=typeof a=="object"&&a;if(!b){h.data("bs.scrollspy",(b=new f(this,c)))}if(typeof a=="string"){b[a]()}})};e.fn.scrollspy.Constructor=f;e.fn.scrollspy.noConflict=function(){e.fn.scrollspy=d;return this};e(window).on("load",function(){e('[data-spy="scroll"]').each(function(){var a=e(this);a.scrollspy(a.data())})})}(jQuery);+function(e){var f=function(a){this.element=e(a)};f.prototype.show=function(){var b=this.element;var c=b.closest("ul:not(.dropdown-menu)");var j=b.data("target");if(!j){j=b.attr("href");j=j&&j.replace(/.*(?=#[^\s]*$)/,"")}if(b.parent("li").hasClass("active")){return}var l=c.find(".active:last a")[0];var k=e.Event("show.bs.tab",{relatedTarget:l});b.trigger(k);if(k.isDefaultPrevented()){return}var a=e(j);this.activate(b.parent("li"),c);this.activate(a,a.parent(),function(){b.trigger({type:"shown.bs.tab",relatedTarget:l})})};f.prototype.activate=function(b,c,j){var k=c.find("> .active");var l=j&&e.support.transition&&k.hasClass("fade");function a(){k.removeClass("active").find("> .dropdown-menu > .active").removeClass("active");b.addClass("active");if(l){b[0].offsetWidth;b.addClass("in")}else{b.removeClass("fade")}if(b.parent(".dropdown-menu")){b.closest("li.dropdown").addClass("active")}j&&j()}l?k.one(e.support.transition.end,a).emulateTransitionEnd(150):a();k.removeClass("in")};var d=e.fn.tab;e.fn.tab=function(a){return this.each(function(){var b=e(this);var c=b.data("bs.tab");if(!c){b.data("bs.tab",(c=new f(this)))}if(typeof a=="string"){c[a]()}})};e.fn.tab.Constructor=f;e.fn.tab.noConflict=function(){e.fn.tab=d;return this};e(document).on("click.bs.tab.data-api",'[data-toggle="tab"], [data-toggle="pill"]',function(a){a.preventDefault();e(this).tab("show")})}(jQuery);+function(e){var f=function(a,b){this.options=e.extend({},f.DEFAULTS,b);this.$window=e(window).on("scroll.bs.affix.data-api",e.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",e.proxy(this.checkPositionWithEventLoop,this));this.$element=e(a);this.affixed=this.unpin=this.pinnedOffset=null;this.checkPosition()};f.RESET="affix affix-top affix-bottom";f.DEFAULTS={offset:0};f.prototype.getPinnedOffset=function(){if(this.pinnedOffset){return this.pinnedOffset}this.$element.removeClass(f.RESET).addClass("affix");var a=this.$window.scrollTop();var b=this.$element.offset();return(this.pinnedOffset=b.top-a)};f.prototype.checkPositionWithEventLoop=function(){setTimeout(e.proxy(this.checkPosition,this),1)};f.prototype.checkPosition=function(){if(!this.$element.is(":visible")){return}var b=e(document).height();var a=this.$window.scrollTop();var n=this.$element.offset();var p=this.options.offset;var r=p.top;var q=p.bottom;if(this.affixed=="top"){n.top+=a}if(typeof p!="object"){q=r=p}if(typeof r=="function"){r=p.top(this.$element)}if(typeof q=="function"){q=p.bottom(this.$element)}var o=this.unpin!=null&&(a+this.unpin<=n.top)?false:q!=null&&(n.top+this.$element.height()>=b-q)?"bottom":r!=null&&(a<=r)?"top":false;if(this.affixed===o){return}if(this.unpin){this.$element.css("top","")}var c="affix"+(o?"-"+o:"");var m=e.Event(c+".bs.affix");this.$element.trigger(m);if(m.isDefaultPrevented()){return}this.affixed=o;this.unpin=o=="bottom"?this.getPinnedOffset():null;this.$element.removeClass(f.RESET).addClass(c).trigger(e.Event(c.replace("affix","affixed")));if(o=="bottom"){this.$element.offset({top:b-q-this.$element.height()})}};var d=e.fn.affix;e.fn.affix=function(a){return this.each(function(){var h=e(this);var b=h.data("bs.affix");var c=typeof a=="object"&&a;if(!b){h.data("bs.affix",(b=new f(this,c)))}if(typeof a=="string"){b[a]()}})};e.fn.affix.Constructor=f;e.fn.affix.noConflict=function(){e.fn.affix=d;return this};e(window).on("load",function(){e('[data-spy="affix"]').each(function(){var a=e(this);var b=a.data();b.offset=b.offset||{};if(b.offsetBottom){b.offset.bottom=b.offsetBottom}if(b.offsetTop){b.offset.top=b.offsetTop}a.affix(b)})})}(jQuery);(function(b){b.flexslider=function(s,B){var A=b(s);A.vars=b.extend({},b.flexslider.defaults,B);var x=A.vars.namespace,y=window.navigator&&window.navigator.msPointerEnabled&&window.MSGesture,w=(("ontouchstart" in window)||y||window.DocumentTouch&&document instanceof DocumentTouch)&&A.vars.touch,a="click touchend MSPointerUp",z="",E,C=A.vars.direction==="vertical",v=A.vars.reverse,r=(A.vars.itemWidth>0),D=A.vars.animation==="fade",u=A.vars.asNavFor!=="",F={},t=true;b.data(s,"flexslider",A);F={init:function(){A.animating=false;A.currentSlide=parseInt((A.vars.startAt?A.vars.startAt:0),10);if(isNaN(A.currentSlide)){A.currentSlide=0}A.animatingTo=A.currentSlide;A.atEnd=(A.currentSlide===0||A.currentSlide===A.last);A.containerSelector=A.vars.selector.substr(0,A.vars.selector.search(" "));A.slides=b(A.vars.selector,A);A.container=b(A.containerSelector,A);A.count=A.slides.length;A.syncExists=b(A.vars.sync).length>0;if(A.vars.animation==="slide"){A.vars.animation="swing"}A.prop=(C)?"top":"marginLeft";A.args={};A.manualPause=false;A.stopped=false;A.started=false;A.startTimeout=null;A.transitions=!A.vars.video&&!D&&A.vars.useCSS&&(function(){var c=document.createElement("div"),d=["perspectiveProperty","WebkitPerspective","MozPerspective","OPerspective","msPerspective"];for(var e in d){if(c.style[d[e]]!==undefined){A.pfx=d[e].replace("Perspective","").toLowerCase();A.prop="-"+A.pfx+"-transform";return true}}return false}());A.ensureAnimationEnd="";if(A.vars.controlsContainer!==""){A.controlsContainer=b(A.vars.controlsContainer).length>0&&b(A.vars.controlsContainer)}if(A.vars.manualControls!==""){A.manualControls=b(A.vars.manualControls).length>0&&b(A.vars.manualControls)}if(A.vars.randomize){A.slides.sort(function(){return(Math.round(Math.random())-0.5)});A.container.empty().append(A.slides)}A.doMath();A.setup("init");if(A.vars.controlNav){F.controlNav.setup()}if(A.vars.directionNav){F.directionNav.setup()}if(A.vars.keyboard&&(b(A.containerSelector).length===1||A.vars.multipleKeyboard)){b(document).bind("keyup",function(d){var e=d.keyCode;if(!A.animating&&(e===39||e===37)){var c=(e===39)?A.getTarget("next"):(e===37)?A.getTarget("prev"):false;A.flexAnimate(c,A.vars.pauseOnAction)}})}if(A.vars.mousewheel){A.bind("mousewheel",function(e,c,f,g){e.preventDefault();var d=(c<0)?A.getTarget("next"):A.getTarget("prev");A.flexAnimate(d,A.vars.pauseOnAction)})}if(A.vars.pausePlay){F.pausePlay.setup()}if(A.vars.slideshow&&A.vars.pauseInvisible){F.pauseInvisible.init()}if(A.vars.slideshow){if(A.vars.pauseOnHover){A.hover(function(){if(!A.manualPlay&&!A.manualPause){A.pause()}},function(){if(!A.manualPause&&!A.manualPlay&&!A.stopped){A.play()}})}if(!A.vars.pauseInvisible||!F.pauseInvisible.isHidden()){(A.vars.initDelay>0)?A.startTimeout=setTimeout(A.play,A.vars.initDelay):A.play()}}if(u){F.asNav.setup()}if(w&&A.vars.touch){F.touch()}if(!D||(D&&A.vars.smoothHeight)){b(window).bind("resize orientationchange focus",F.resize)}A.find("img").attr("draggable","false");setTimeout(function(){A.vars.start(A)},200)},asNav:{setup:function(){A.asNav=true;A.animatingTo=Math.floor(A.currentSlide/A.move);A.currentItem=A.currentSlide;A.slides.removeClass(x+"active-slide").eq(A.currentItem).addClass(x+"active-slide");if(!y){A.slides.on(a,function(d){d.preventDefault();var e=b(this),f=e.index();var c=e.offset().left-b(A).scrollLeft();if(c<=0&&e.hasClass(x+"active-slide")){A.flexAnimate(A.getTarget("prev"),true)}else{if(!b(A.vars.asNavFor).data("flexslider").animating&&!e.hasClass(x+"active-slide")){A.direction=(A.currentItem<f)?"next":"prev";A.flexAnimate(f,A.vars.pauseOnAction,false,true,true)}}})}else{s._slider=A;A.slides.each(function(){var c=this;c._gesture=new MSGesture();c._gesture.target=c;c.addEventListener("MSPointerDown",function(d){d.preventDefault();if(d.currentTarget._gesture){d.currentTarget._gesture.addPointer(d.pointerId)}},false);c.addEventListener("MSGestureTap",function(d){d.preventDefault();var e=b(this),f=e.index();if(!b(A.vars.asNavFor).data("flexslider").animating&&!e.hasClass("active")){A.direction=(A.currentItem<f)?"next":"prev";A.flexAnimate(f,A.vars.pauseOnAction,false,true,true)}})})}}},controlNav:{setup:function(){if(!A.manualControls){F.controlNav.setupPaging()}else{F.controlNav.setupManual()}},setupPaging:function(){var e=(A.vars.controlNav==="thumbnails")?"control-thumbs":"control-paging",g=1,d,h;A.controlNavScaffold=b('<ol class="'+x+"control-nav "+x+e+'"></ol>');if(A.pagingCount>1){for(var f=0;f<A.pagingCount;f++){h=A.slides.eq(f);d=(A.vars.controlNav==="thumbnails")?'<img src="'+h.attr("data-thumb")+'"/>':"<a>"+g+"</a>";if("thumbnails"===A.vars.controlNav&&true===A.vars.thumbCaptions){var c=h.attr("data-thumbcaption");if(""!=c&&undefined!=c){d+='<span class="'+x+'caption">'+c+"</span>"}}A.controlNavScaffold.append("<li>"+d+"</li>");g++}}(A.controlsContainer)?b(A.controlsContainer).append(A.controlNavScaffold):A.append(A.controlNavScaffold);F.controlNav.set();F.controlNav.active();A.controlNavScaffold.delegate("a, img",a,function(j){j.preventDefault();if(z===""||z===j.type){var k=b(this),i=A.controlNav.index(k);if(!k.hasClass(x+"active")){A.direction=(i>A.currentSlide)?"next":"prev";A.flexAnimate(i,A.vars.pauseOnAction)}}if(z===""){z=j.type}F.setToClearWatchedEvent()})},setupManual:function(){A.controlNav=A.manualControls;F.controlNav.active();A.controlNav.bind(a,function(e){e.preventDefault();if(z===""||z===e.type){var c=b(this),d=A.controlNav.index(c);if(!c.hasClass(x+"active")){(d>A.currentSlide)?A.direction="next":A.direction="prev";A.flexAnimate(d,A.vars.pauseOnAction)}}if(z===""){z=e.type}F.setToClearWatchedEvent()})},set:function(){var c=(A.vars.controlNav==="thumbnails")?"img":"a";A.controlNav=b("."+x+"control-nav li "+c,(A.controlsContainer)?A.controlsContainer:A)},active:function(){A.controlNav.removeClass(x+"active").eq(A.animatingTo).addClass(x+"active")},update:function(d,c){if(A.pagingCount>1&&d==="add"){A.controlNavScaffold.append(b("<li><a>"+A.count+"</a></li>"))}else{if(A.pagingCount===1){A.controlNavScaffold.find("li").remove()}else{A.controlNav.eq(c).closest("li").remove()}}F.controlNav.set();(A.pagingCount>1&&A.pagingCount!==A.controlNav.length)?A.update(c,d):F.controlNav.active()}},directionNav:{setup:function(){var c=b('<ul class="'+x+'direction-nav"><li><a class="'+x+'prev" href="#">'+A.vars.prevText+'</a></li><li><a class="'+x+'next" href="#">'+A.vars.nextText+"</a></li></ul>");if(A.controlsContainer){b(A.controlsContainer).append(c);A.directionNav=b("."+x+"direction-nav li a",A.controlsContainer)}else{A.append(c);A.directionNav=b("."+x+"direction-nav li a",A)}F.directionNav.update();A.directionNav.bind(a,function(e){e.preventDefault();var d;if(z===""||z===e.type){d=(b(this).hasClass(x+"next"))?A.getTarget("next"):A.getTarget("prev");A.flexAnimate(d,A.vars.pauseOnAction)}if(z===""){z=e.type}F.setToClearWatchedEvent()})},update:function(){var c=x+"disabled";if(A.pagingCount===1){A.directionNav.addClass(c).attr("tabindex","-1")}else{if(!A.vars.animationLoop){if(A.animatingTo===0){A.directionNav.removeClass(c).filter("."+x+"prev").addClass(c).attr("tabindex","-1")}else{if(A.animatingTo===A.last){A.directionNav.removeClass(c).filter("."+x+"next").addClass(c).attr("tabindex","-1")}else{A.directionNav.removeClass(c).removeAttr("tabindex")}}}else{A.directionNav.removeClass(c).removeAttr("tabindex")}}}},pausePlay:{setup:function(){var c=b('<div class="'+x+'pauseplay"><a></a></div>');if(A.controlsContainer){A.controlsContainer.append(c);A.pausePlay=b("."+x+"pauseplay a",A.controlsContainer)}else{A.append(c);A.pausePlay=b("."+x+"pauseplay a",A)}F.pausePlay.update((A.vars.slideshow)?x+"pause":x+"play");A.pausePlay.bind(a,function(d){d.preventDefault();if(z===""||z===d.type){if(b(this).hasClass(x+"pause")){A.manualPause=true;A.manualPlay=false;A.pause()}else{A.manualPause=false;A.manualPlay=true;A.play()}}if(z===""){z=d.type}F.setToClearWatchedEvent()})},update:function(c){(c==="play")?A.pausePlay.removeClass(x+"pause").addClass(x+"play").html(A.vars.playText):A.pausePlay.removeClass(x+"play").addClass(x+"pause").html(A.vars.pauseText)}},touch:function(){var l,d,f,k,i,j,m=false,n=0,H=0,g=0;if(!y){s.addEventListener("touchstart",e,false);function e(G){if(A.animating){G.preventDefault()}else{if((window.navigator.msPointerEnabled)||G.touches.length===1){A.pause();k=(C)?A.h:A.w;j=Number(new Date());n=G.touches[0].pageX;H=G.touches[0].pageY;f=(r&&v&&A.animatingTo===A.last)?0:(r&&v)?A.limit-(((A.itemW+A.vars.itemMargin)*A.move)*A.animatingTo):(r&&A.currentSlide===A.last)?A.limit:(r)?((A.itemW+A.vars.itemMargin)*A.move)*A.currentSlide:(v)?(A.last-A.currentSlide+A.cloneOffset)*k:(A.currentSlide+A.cloneOffset)*k;l=(C)?H:n;d=(C)?n:H;s.addEventListener("touchmove",c,false);s.addEventListener("touchend",q,false)}}}function c(J){n=J.touches[0].pageX;H=J.touches[0].pageY;i=(C)?l-H:l-n;m=(C)?(Math.abs(i)<Math.abs(n-d)):(Math.abs(i)<Math.abs(H-d));var G=500;if(!m||Number(new Date())-j>G){J.preventDefault();if(!D&&A.transitions){if(!A.vars.animationLoop){i=i/((A.currentSlide===0&&i<0||A.currentSlide===A.last&&i>0)?(Math.abs(i)/k+2):1)}A.setProps(f+i,"setTouch")}}}function q(G){s.removeEventListener("touchmove",c,false);if(A.animatingTo===A.currentSlide&&!m&&!(i===null)){var K=(v)?-i:i,L=(K>0)?A.getTarget("next"):A.getTarget("prev");if(A.canAdvance(L)&&(Number(new Date())-j<550&&Math.abs(K)>50||Math.abs(K)>k/2)){A.flexAnimate(L,A.vars.pauseOnAction)}else{if(!D){A.flexAnimate(A.currentSlide,A.vars.pauseOnAction,true)}}}s.removeEventListener("touchend",q,false);l=null;d=null;i=null;f=null}}else{s.style.msTouchAction="none";s._gesture=new MSGesture();s._gesture.target=s;s.addEventListener("MSPointerDown",p,false);s._slider=A;s.addEventListener("MSGestureChange",o,false);s.addEventListener("MSGestureEnd",h,false);function p(G){G.stopPropagation();if(A.animating){G.preventDefault()}else{A.pause();s._gesture.addPointer(G.pointerId);g=0;k=(C)?A.h:A.w;j=Number(new Date());f=(r&&v&&A.animatingTo===A.last)?0:(r&&v)?A.limit-(((A.itemW+A.vars.itemMargin)*A.move)*A.animatingTo):(r&&A.currentSlide===A.last)?A.limit:(r)?((A.itemW+A.vars.itemMargin)*A.move)*A.currentSlide:(v)?(A.last-A.currentSlide+A.cloneOffset)*k:(A.currentSlide+A.cloneOffset)*k}}function o(G){G.stopPropagation();var L=G.target._slider;if(!L){return}var M=-G.translationX,N=-G.translationY;g=g+((C)?N:M);i=g;m=(C)?(Math.abs(g)<Math.abs(-M)):(Math.abs(g)<Math.abs(-N));if(G.detail===G.MSGESTURE_FLAG_INERTIA){setImmediate(function(){s._gesture.stop()});return}if(!m||Number(new Date())-j>500){G.preventDefault();if(!D&&L.transitions){if(!L.vars.animationLoop){i=g/((L.currentSlide===0&&g<0||L.currentSlide===L.last&&g>0)?(Math.abs(g)/k+2):1)}L.setProps(f+i,"setTouch")}}}function h(G){G.stopPropagation();var N=G.target._slider;if(!N){return}if(N.animatingTo===N.currentSlide&&!m&&!(i===null)){var L=(v)?-i:i,M=(L>0)?N.getTarget("next"):N.getTarget("prev");if(N.canAdvance(M)&&(Number(new Date())-j<550&&Math.abs(L)>50||Math.abs(L)>k/2)){N.flexAnimate(M,N.vars.pauseOnAction)}else{if(!D){N.flexAnimate(N.currentSlide,N.vars.pauseOnAction,true)}}}l=null;d=null;i=null;f=null;g=0}}},resize:function(){if(!A.animating&&A.is(":visible")){if(!r){A.doMath()}if(D){F.smoothHeight()}else{if(r){A.slides.width(A.computedW);A.update(A.pagingCount);A.setProps()}else{if(C){A.viewport.height(A.h);A.setProps(A.h,"setTotal")}else{if(A.vars.smoothHeight){F.smoothHeight()}A.newSlides.width(A.computedW);A.setProps(A.computedW,"setTotal")}}}}},smoothHeight:function(d){if(!C||D){var c=(D)?A:A.viewport;(d)?c.animate({height:A.slides.eq(A.animatingTo).height()},d):c.height(A.slides.eq(A.animatingTo).height())}},sync:function(e){var c=b(A.vars.sync).data("flexslider"),d=A.animatingTo;switch(e){case"animate":c.flexAnimate(d,A.vars.pauseOnAction,false,true);break;case"play":if(!c.playing&&!c.asNav){c.play()}break;case"pause":c.pause();break}},uniqueID:function(c){c.find("[id]").each(function(){var d=b(this);d.attr("id",d.attr("id")+"_clone")});return c},pauseInvisible:{visProp:null,init:function(){var c=["webkit","moz","ms","o"];if("hidden" in document){return"hidden"}for(var d=0;d<c.length;d++){if((c[d]+"Hidden") in document){F.pauseInvisible.visProp=c[d]+"Hidden"}}if(F.pauseInvisible.visProp){var e=F.pauseInvisible.visProp.replace(/[H|h]idden/,"")+"visibilitychange";document.addEventListener(e,function(){if(F.pauseInvisible.isHidden()){if(A.startTimeout){clearTimeout(A.startTimeout)}else{A.pause()}}else{if(A.started){A.play()}else{(A.vars.initDelay>0)?setTimeout(A.play,A.vars.initDelay):A.play()}}})}},isHidden:function(){return document[F.pauseInvisible.visProp]||false}},setToClearWatchedEvent:function(){clearTimeout(E);E=setTimeout(function(){z=""},3000)}};A.flexAnimate=function(i,h,e,c,l){if(!A.vars.animationLoop&&i!==A.currentSlide){A.direction=(i>A.currentSlide)?"next":"prev"}if(u&&A.pagingCount===1){A.direction=(A.currentItem<i)?"next":"prev"}if(!A.animating&&(A.canAdvance(i,l)||e)&&A.is(":visible")){if(u&&c){var f=b(A.vars.asNavFor).data("flexslider");A.atEnd=i===0||i===A.count-1;f.flexAnimate(i,true,false,true,l);A.direction=(A.currentItem<i)?"next":"prev";f.direction=A.direction;if(Math.ceil((i+1)/A.visible)-1!==A.currentSlide&&i!==0){A.currentItem=i;A.slides.removeClass(x+"active-slide").eq(i).addClass(x+"active-slide");i=Math.floor(i/A.visible)}else{A.currentItem=i;A.slides.removeClass(x+"active-slide").eq(i).addClass(x+"active-slide");return false}}A.animating=true;A.animatingTo=i;if(h){A.pause()}A.vars.before(A);if(A.syncExists&&!l){F.sync("animate")}if(A.vars.controlNav){F.controlNav.active()}if(!r){A.slides.removeClass(x+"active-slide").eq(i).addClass(x+"active-slide")}A.atEnd=i===0||i===A.last;if(A.vars.directionNav){F.directionNav.update()}if(i===A.last){A.vars.end(A);if(!A.vars.animationLoop){A.pause()}}if(!D){var j=(C)?A.slides.filter(":first").height():A.computedW,k,d,g;if(r){k=A.vars.itemMargin;g=((A.itemW+k)*A.move)*A.animatingTo;d=(g>A.limit&&A.visible!==1)?A.limit:g}else{if(A.currentSlide===0&&i===A.count-1&&A.vars.animationLoop&&A.direction!=="next"){d=(v)?(A.count+A.cloneOffset)*j:0}else{if(A.currentSlide===A.last&&i===0&&A.vars.animationLoop&&A.direction!=="prev"){d=(v)?0:(A.count+1)*j}else{d=(v)?((A.count-1)-i+A.cloneOffset)*j:(i+A.cloneOffset)*j}}}A.setProps(d,"",A.vars.animationSpeed);if(A.transitions){if(!A.vars.animationLoop||!A.atEnd){A.animating=false;A.currentSlide=A.animatingTo}A.container.unbind("webkitTransitionEnd transitionend");A.container.bind("webkitTransitionEnd transitionend",function(){clearTimeout(A.ensureAnimationEnd);A.wrapup(j)});clearTimeout(A.ensureAnimationEnd);A.ensureAnimationEnd=setTimeout(function(){A.wrapup(j)},A.vars.animationSpeed+100)}else{A.container.animate(A.args,A.vars.animationSpeed,A.vars.easing,function(){A.wrapup(j)})}}else{if(!w){A.slides.eq(A.currentSlide).css({zIndex:1}).animate({opacity:0},A.vars.animationSpeed,A.vars.easing);A.slides.eq(i).css({zIndex:2}).animate({opacity:1},A.vars.animationSpeed,A.vars.easing,A.wrapup)}else{A.slides.eq(A.currentSlide).css({opacity:0,zIndex:1});A.slides.eq(i).css({opacity:1,zIndex:2});A.wrapup(j)}}if(A.vars.smoothHeight){F.smoothHeight(A.vars.animationSpeed)}}};A.wrapup=function(c){if(!D&&!r){if(A.currentSlide===0&&A.animatingTo===A.last&&A.vars.animationLoop){A.setProps(c,"jumpEnd")}else{if(A.currentSlide===A.last&&A.animatingTo===0&&A.vars.animationLoop){A.setProps(c,"jumpStart")}}}A.animating=false;A.currentSlide=A.animatingTo;A.vars.after(A)};A.animateSlides=function(){if(!A.animating&&t){A.flexAnimate(A.getTarget("next"))}};A.pause=function(){clearInterval(A.animatedSlides);A.animatedSlides=null;A.playing=false;if(A.vars.pausePlay){F.pausePlay.update("play")}if(A.syncExists){F.sync("pause")}};A.play=function(){if(A.playing){clearInterval(A.animatedSlides)}A.animatedSlides=A.animatedSlides||setInterval(A.animateSlides,A.vars.slideshowSpeed);A.started=A.playing=true;if(A.vars.pausePlay){F.pausePlay.update("pause")}if(A.syncExists){F.sync("play")}};A.stop=function(){A.pause();A.stopped=true};A.canAdvance=function(c,e){var d=(u)?A.pagingCount-1:A.last;return(e)?true:(u&&A.currentItem===A.count-1&&c===0&&A.direction==="prev")?true:(u&&A.currentItem===0&&c===A.pagingCount-1&&A.direction!=="next")?false:(c===A.currentSlide&&!u)?false:(A.vars.animationLoop)?true:(A.atEnd&&A.currentSlide===0&&c===d&&A.direction!=="next")?false:(A.atEnd&&A.currentSlide===d&&c===0&&A.direction==="next")?false:true};A.getTarget=function(c){A.direction=c;if(c==="next"){return(A.currentSlide===A.last)?0:A.currentSlide+1}else{return(A.currentSlide===0)?A.last:A.currentSlide-1}};A.setProps=function(c,f,e){var d=(function(){var h=(c)?c:((A.itemW+A.vars.itemMargin)*A.move)*A.animatingTo,g=(function(){if(r){return(f==="setTouch")?c:(v&&A.animatingTo===A.last)?0:(v)?A.limit-(((A.itemW+A.vars.itemMargin)*A.move)*A.animatingTo):(A.animatingTo===A.last)?A.limit:h}else{switch(f){case"setTotal":return(v)?((A.count-1)-A.currentSlide+A.cloneOffset)*c:(A.currentSlide+A.cloneOffset)*c;case"setTouch":return(v)?c:c;case"jumpEnd":return(v)?c:A.count*c;case"jumpStart":return(v)?A.count*c:c;default:return c}}}());return(g*-1)+"px"}());if(A.transitions){d=(C)?"translate3d(0,"+d+",0)":"translate3d("+d+",0,0)";e=(e!==undefined)?(e/1000)+"s":"0s";A.container.css("-"+A.pfx+"-transition-duration",e);A.container.css("transition-duration",e)}A.args[A.prop]=d;if(A.transitions||e===undefined){A.container.css(A.args)}A.container.css("transform",d)};A.setup=function(d){if(!D){var c,e;if(d==="init"){A.viewport=b('<div class="'+x+'viewport"></div>').css({overflow:"hidden",position:"relative"}).appendTo(A).append(A.container);A.cloneCount=0;A.cloneOffset=0;if(v){e=b.makeArray(A.slides).reverse();A.slides=b(e);A.container.empty().append(A.slides)}}if(A.vars.animationLoop&&!r){A.cloneCount=2;A.cloneOffset=1;if(d!=="init"){A.container.find(".clone").remove()}F.uniqueID(A.slides.first().clone().addClass("clone").attr("aria-hidden","true")).appendTo(A.container);F.uniqueID(A.slides.last().clone().addClass("clone").attr("aria-hidden","true")).prependTo(A.container)}A.newSlides=b(A.vars.selector,A);c=(v)?A.count-1-A.currentSlide+A.cloneOffset:A.currentSlide+A.cloneOffset;if(C&&!r){A.container.height((A.count+A.cloneCount)*200+"%").css("position","absolute").width("100%");setTimeout(function(){A.newSlides.css({display:"block"});A.doMath();A.viewport.height(A.h);A.setProps(c*A.h,"init")},(d==="init")?100:0)}else{A.container.width((A.count+A.cloneCount)*200+"%");A.setProps(c*A.computedW,"init");setTimeout(function(){A.doMath();A.newSlides.css({width:A.computedW,"float":"left",display:"block"});if(A.vars.smoothHeight){F.smoothHeight()}},(d==="init")?100:0)}}else{A.slides.css({width:"100%","float":"left",marginRight:"-100%",position:"relative"});if(d==="init"){if(!w){A.slides.css({opacity:0,display:"block",zIndex:1}).eq(A.currentSlide).css({zIndex:2}).animate({opacity:1},A.vars.animationSpeed,A.vars.easing)}else{A.slides.css({opacity:0,display:"block",webkitTransition:"opacity "+A.vars.animationSpeed/1000+"s ease",zIndex:1}).eq(A.currentSlide).css({opacity:1,zIndex:2})}}if(A.vars.smoothHeight){F.smoothHeight()}}if(!r){A.slides.removeClass(x+"active-slide").eq(A.currentSlide).addClass(x+"active-slide")}A.vars.init(A)};A.doMath=function(){var f=A.slides.first(),c=A.vars.itemMargin,e=A.vars.minItems,d=A.vars.maxItems;A.w=(A.viewport===undefined)?A.width():A.viewport.width();A.h=f.height();A.boxPadding=f.outerWidth()-f.width();if(r){A.itemT=A.vars.itemWidth+c;A.minW=(e)?e*A.itemT:A.w;A.maxW=(d)?(d*A.itemT)-c:A.w;A.itemW=(A.minW>A.w)?(A.w-(c*(e-1)))/e:(A.maxW<A.w)?(A.w-(c*(d-1)))/d:(A.vars.itemWidth>A.w)?A.w:A.vars.itemWidth;A.visible=Math.floor(A.w/(A.itemW));A.move=(A.vars.move>0&&A.vars.move<A.visible)?A.vars.move:A.visible;A.pagingCount=Math.ceil(((A.count-A.visible)/A.move)+1);A.last=A.pagingCount-1;A.limit=(A.pagingCount===1)?0:(A.vars.itemWidth>A.w)?(A.itemW*(A.count-1))+(c*(A.count-1)):((A.itemW+c)*A.count)-A.w-c}else{A.itemW=A.w;A.pagingCount=A.count;A.last=A.count-1}A.computedW=A.itemW-A.boxPadding};A.update=function(c,d){A.doMath();if(!r){if(c<A.currentSlide){A.currentSlide+=1}else{if(c<=A.currentSlide&&c!==0){A.currentSlide-=1}}A.animatingTo=A.currentSlide}if(A.vars.controlNav&&!A.manualControls){if((d==="add"&&!r)||A.pagingCount>A.controlNav.length){F.controlNav.update("add")}else{if((d==="remove"&&!r)||A.pagingCount<A.controlNav.length){if(r&&A.currentSlide>A.last){A.currentSlide-=1;A.animatingTo-=1}F.controlNav.update("remove",A.last)}}}if(A.vars.directionNav){F.directionNav.update()}};A.addSlide=function(e,c){var d=b(e);A.count+=1;A.last=A.count-1;if(C&&v){(c!==undefined)?A.slides.eq(A.count-c).after(d):A.container.prepend(d)}else{(c!==undefined)?A.slides.eq(c).before(d):A.container.append(d)}A.update(c,"add");A.slides=b(A.vars.selector+":not(.clone)",A);A.setup();A.vars.added(A)};A.removeSlide=function(d){var c=(isNaN(d))?A.slides.index(b(d)):d;A.count-=1;A.last=A.count-1;if(isNaN(d)){b(d,A.slides).remove()}else{(C&&v)?A.slides.eq(A.last).remove():A.slides.eq(d).remove()}A.doMath();A.update(c,"remove");A.slides=b(A.vars.selector+":not(.clone)",A);A.setup();A.vars.removed(A)};F.init()};b(window).blur(function(a){focused=false}).focus(function(a){focused=true});b.flexslider.defaults={namespace:"flex-",selector:".slides > li",animation:"fade",easing:"swing",direction:"horizontal",reverse:false,animationLoop:true,smoothHeight:false,startAt:0,slideshow:true,slideshowSpeed:7000,animationSpeed:600,initDelay:0,randomize:false,thumbCaptions:false,pauseOnAction:true,pauseOnHover:false,pauseInvisible:true,useCSS:true,touch:true,video:false,controlNav:true,directionNav:true,prevText:"Previous",nextText:"Next",keyboard:true,multipleKeyboard:false,mousewheel:false,pausePlay:false,pauseText:"Pause",playText:"Play",controlsContainer:"",manualControls:"",sync:"",asNavFor:"",itemWidth:0,itemMargin:0,minItems:1,maxItems:0,move:0,allowOneSlide:true,start:function(){},before:function(){},after:function(){},end:function(){},added:function(){},removed:function(){},init:function(){}};b.fn.flexslider=function(a){if(a===undefined){a={}}if(typeof a==="object"){return this.each(function(){var c=b(this),h=(a.selector)?a.selector:".slides > li",g=c.find(h);if((g.length===1&&a.allowOneSlide===true)||g.length===0){g.fadeIn(400);if(a.start){a.start(c)}}else{if(c.data("flexslider")===undefined){new b.flexslider(this,a)}}})}else{var d=b(this).data("flexslider");switch(a){case"play":d.play();break;case"pause":d.pause();break;case"stop":d.stop();break;case"next":d.flexAnimate(d.getTarget("next"),true);break;case"prev":case"previous":d.flexAnimate(d.getTarget("prev"),true);break;default:if(typeof a==="number"){d.flexAnimate(a,true)}}}}})(jQuery);
/*!
 * Created by mario on 15/05/14.
 */
;$(window).load(function(){$(".flexslider-principal").flexslider({animation:"slide",slideshowSpeed:5000,startAt:0,slideshow:true});$(".flexslider-destaque").flexslider({animation:"slide",controlNav:"thumbnails",randomize:false,slideshow:false});$("#flexslider-detalhe-thumb").flexslider({animation:"slide",controlNav:false,animationLoop:false,slideshow:false,itemWidth:120,itemMargin:5,asNavFor:"#flexslider-detalhe"});$("#flexslider-detalhe").flexslider({animation:"slide",controlNav:false,animationLoop:false,slideshow:false,sync:"#flexslider-detalhe-thumb"})});