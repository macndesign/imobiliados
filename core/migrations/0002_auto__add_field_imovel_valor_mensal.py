...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Imovel.valor_mensal'
        db.add_column(u'core_imovel', 'valor_mensal',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=16, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Imovel.valor_mensal'
        db.delete_column(u'core_imovel', 'valor_mensal')
    ...
    models = {
        ...
        u'core.imovel': {
            ...
            'valor_mensal': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '16', 'decimal_places': '2', 'blank': 'True'})
        },
        u'core.parceiro': {
